    ...
    angular.module("ariaNg").config(["$translateProvider", "ariaNgConstants", function(e, t) {
        e.translations(t.defaultLanguage, {
            ...
            options: {
                ...
                "max-connection-per-server.description": "Max Connection Per Server is hardcoded to 16, if you want more than this, you need to build your own version of aria2",
    ...
    angular.module("ariaNg").controller("NewTaskController", ["$rootScope", "$scope", "$location", "$timeout", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(l, c, d, e, u, t, a, n, p, f, i) {
        ...
        o.url)
            try {
                ...
                if (o.referer) {
                    c.context.options["referer"] = atob(o.referer);
                }
                if (o.header) {
                    c.context.options["header"] = atob(o.header);
                }
            } catch (e) {
    ...
    angular.module("ariaNg").factory("aria2RpcService", ["$q", "aria2RpcConstants", "aria2RpcErrors", "aria2AllOptions", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(l, r, o, i, s, c, d, u, e, t) {
        ...
        P("onBtDownloadComplete", x),
        {
            ...
            addUriMulti: function(e) {
                ...
                return R(this.addUri, t, e.callback)
            },
            ...
            forceRemoveMulti: function(e) {
                ...
                return R(this.forceRemove, t, e.callback)
            },
            pause: function(e, t) {
            ...
            forcePauseMulti: function(e) {
                ...
                return R(this.forcePause, t, e.callback)
            },
            ...
            unpauseMulti: function(e) {
                ...
                return R(this.unpause, t, e.callback)
            },
            ...
            tellActive: function(e, t) {
                return C(O("tellActive", e, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellWaiting: function(e, t) {
                return C(O("tellWaiting", e, angular.isDefined(e.offset) ? e.offset : 0, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellStopped: function(e, t) {
                return C(O("tellStopped", e, angular.isDefined(e.offset) ? e.offset : -1, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            changePosition: function(e, t) {
                return C(O("changePosition", e, e.gid, e.pos, e.how), !!t)
            },
            changeUri: function(e, t) {
                return C(O("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris), !!t)
            },
            ...
            removeDownloadResultMulti: function(e) {
                ...
                return R(this.removeDownloadResult, t, e.callback)
            },
    ...
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "bittorrentPeeridService", "ariaNgConstants", "aria2Errors", "aria2RpcService", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(u, m, l, y, p, k, w, S, f) {
        var x = function(e) {
            ...
            var i = t.substring(n + 1)
              , s = i.indexOf("?")
              , r = i;
            if (0 < s && (r = i.substring(0, s)),
            a)
                try {
                    r = decodeURI(r)
                } catch (e) {
                    S.warn("[aria2TaskService.getFileName] failed to url decode file name, original file name: " + r, e)
                }
            return r
        }
          , T = function(e, t) {
