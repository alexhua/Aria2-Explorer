...
function() {
    "use strict";
    angular.module("ariaNg").run(["$rootScope", "$location", "$document", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", function(n, s, r, t, a, i, o, e) {
        var l = function(e, t) {
        ...
        n.swipeActions = {
            leftSwipe: function() {
                angular.element("body").hasClass("sidebar-open") ? c() : (!this.extentLeftSwipe || angular.isFunction(this.extentLeftSwipe) && !this.extentLeftSwipe()) && c()
            },
            rightSwipe: function() {
        ...
        e.onFirstSuccess(function(e) {
            a.notifyInPage("", "{{name}} is connected", {
                type: "success",
                contentParams: {
                    name: e.rpcName
                }
        ...
        n.$on("$routeChangeStart", function(e, t, a) {
            ...
            angular.element("section.sidebar > ul > li[data-href-match]").each(function(e, t) {
                ...
                l(a, n) && angular.element(t).addClass("active")
            }),
            angular.element("section.sidebar > ul > li.treeview > ul.treeview-menu > li[data-href-match]").each(function(e, t) {
                var a = angular.element(t).attr("data-href-match");
                l(a, n) && angular.element(t).addClass("active").parent().parent().addClass("active")
            }),
            r.unbind("keypress")
        }),
        function() {
            ...
            !o.isBrowserSupportStorage())
                ...
                a.notifyInPage("", "You cannot use AriaNg because this browser does not support data storage.", {
                    type: "error",
                    delay: !1
                }),
                new Error("You cannot use AriaNg because this browser does not support data storage.")
        }(),
...
function() {
    "use strict";
    angular.module("ariaNg").controller("CommandController", ["$rootScope", "$window", "$location", "$routeParams", "ariaNgDefaultOptions", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(s, r, o, e, l, c, d, u, p, g, f) {
        ...
        (0 === (t = n).indexOf("/new") ? function(e, t) {
            ...
            if (t) {
                for (var i in t)
                    t.hasOwnProperty(i) && f.isOptionKeyValid(i) && (a[i] = t[i]);
                "true" === t.pause && (n = !0)
            }
            return s.loadPromise = g.newUriTask({
                urls: [e],
                options: a
            }, n, function(e) {
                if (!e.success)
...
function() {
    ...
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$window", "$location", "$document", "$interval", "clipboard", "ariaNgBuildConfiguration", "aria2RpcErrors", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2TaskService", "aria2SettingService", function(i, s, r, t, o, e, a, n, l, c, d, u, p, g, f, m, h, v) {
        ...
        ,
        s.isSingleUrlTaskSelected = function() {
            var e = i.taskContext.getSelectedTasks();
            return 1 === e.length && !!e[0].singleUrl
        }
        ,
        s.isSingleBittorrentHasInfoHashTaskSelected = function() {
            var e = i.taskContext.getSelectedTasks();
            return 1 === e.length && (!!e[0].bittorrent && !!e[0].infoHash)
        }
        ,
        ...
        s.removeTasks = function() {
            ...
            !t || t.length < 1 || p.confirm("Confirm Remove", "Are you sure you want to remove the selected task?", "warning", function() {
        ...
        ,
        s.copySelectedOneTaskDownloadLink = function() {
            var e = i.taskContext.getSelectedTasks();
            1 === e.length && n.copyText(e[0].singleUrl)
        }
        ,
        s.copySelectedOneTaskMagnetLink = function() {
            var e = i.taskContext.getSelectedTasks();
            1 === e.length && n.copyText("magnet:?xt=urn:btih:" + e[0].infoHash)
        }
        ,
        ...
        s.switchRpcSetting = function(e) {
            e.isDefault || (g.setDefaultRpcSetting(e),
            t.location.reload())
        }
        ,
        0 < g.getTitleRefreshInterval() && (b = a(function() {
            k()
        }, g.getTitleRefreshInterval())),
        0 < g.getGlobalStatRefreshInterval() && (y = a(function() {
            w(!0)
...
function() {
    "use strict";
    angular.module("ariaNg").controller("NewTaskController", ["$rootScope", "$scope", "$location", "$timeout", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(l, c, d, e, u, t, a, n, p, g, i) {
        var s, r = ["links", "options"], o = d.search(), f = function(e) {
        ...
        c.startDownload = function(a) {
            ...
            f(r.options),
            g.newTorrentTask(r, i, s)) : "metalink" === c.context.taskType && (l.loadPromise = (e = a,
            t = o,
            n = {
                content: c.context.uploadFile.base64Content,
                options: angular.copy(c.context.options)
...
function() {
    ...
    angular.module("ariaNg").controller("DownloadListController", ["$rootScope", "$scope", "$window", "$location", "$route", "$interval", "dragulaService", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "aria2TaskService", function(r, e, t, a, n, o, i, l, c, s, d) {
        var u = a.path().substring(1)
          ...
          , m = function(e) {
            if (!g)
                return d.getTaskList(u, f, function(e) {
                    if (!g)
                        if (e.success) {
                            ...
                            if (t)
                                ...
                                f = !c.extendArray(a, r.taskContext.list, "gid")
                            }
...
function() {
    "use strict";
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "clipboard", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService", function(i, g, e, t, n, a, f, m, s, r, o, l) {
        var c = ["overview", "blocks", "filelist", "btpeers"]
          , d = null
          , u = !1
          , p = null
          , h = function(e) {
            ...
            g.task && g.task.status === e.status || (g.context.availableOptions = (t = e.status,
            a = !!e.bittorrent,
            ...
            i.taskContext.list = [g.task],
            i.taskContext.selected = {},
            i.taskContext.selected[g.task.gid] = !0,
            r.recordStat(e.gid, e))
        }
          , v = function(e) {
            e && (m.extendArray(e, g.context.btPeers, "peerId") || (g.context.btPeers = e),
            g.context.healthPercent = o.estimateHealthPercentFromPeers(g.task, g.context.btPeers))
        }
          , b = function(e) {
          ...
          , y = function(a) {
            if (!u) {
                ...
                return g.task ? o.getTaskStatusAndBtPeers(e.gid, function(e) {
                    if (!e.success)
                        return n(e.data.message);
                    h(e.task),
                    v(e.peers)
                }, a, b(g.task), !0, !0) : o.getTaskStatus(e.gid, function(e) {
                    if (!e.success)
                        return n(e.data.message);
                    var t = e.data;
                    h(t),
          ...
          , k = function(e) {
            if (g.task && g.task.files) {
                for (var t = g.task.gid, a = [], n = 0; n < g.task.files.length; n++) {
        ...
        i.swipeActions.extentLeftSwipe = function() {
            var e = c.indexOf(g.context.currentTab);
            return e < c.length - 1 && (g.changeTab(c[e + 1]),
            !0)
        }
        ,
        i.swipeActions.extentRightSwipe = function() {
            var e = c.indexOf(g.context.currentTab);
            return 0 < e && (g.changeTab(c[e - 1]),
            !0)
        }
        ,
        ...
        g.getFileListOrderType = function() {
            return g.task && g.task.multiDir ? null : s.getFileListDisplayOrder()
        }
        ,
        g.showChooseFilesToolbar = function() {
            g.context.showChooseFilesToolbar ? g.cancelChooseFiles() : (u = !0,
            g.context.showChooseFilesToolbar = !0)
        }
        ,
        ...
        g.chooseSpecifiedFiles = function(e) {
            if (g.task && g.task.files && f[e]) {
                for (var t = g.task.files, a = f[e].extensions, n = [], i = !0, s = 0; s < t.length; s++) {
                    if (!(o = t[s]).isDir) {
        ...
        g.saveChoosedFiles = function() {
            g.context.showChooseFilesToolbar && (i.loadPromise = k(!1),
            g.context.showChooseFilesToolbar = !1)
        }
        ,
        g.cancelChooseFiles = function() {
            g.context.showChooseFilesToolbar && (y(!(u = !1)),
            g.context.showChooseFilesToolbar = !1)
        }
        ,
        ...
        g.setSelectedFile = function(e) {
            e && x(),
            g.context.showChooseFilesToolbar || k(!0)
        }
        ,
        g.collapseDir = function(e, t, a) {
            var n = e.nodePath;
            if (angular.isUndefined(t) && (t = !g.context.collapsedDirs[n]),
            t || a)
        ...
        g.setOption = function(e, t, a) {
            return o.setTaskOption(g.task.gid, e, t, function(e) {
        ...
        0 < s.getDownloadTaskRefreshInterval() && (d = t(function() {
            !g.task || "complete" !== g.task.status && "error" !== g.task.status && "removed" !== g.task.status ? y(!0) : t.cancel(d)
        }, s.getDownloadTaskRefreshInterval())),
...
function() {
    ...
    angular.module("ariaNg").controller("AriaNgSettingsController", ["$rootScope", "$scope", "$routeParams", "$window", "$interval", "$timeout", "$filter", "clipboard", "ariaNgBuildConfiguration", "ariaNgLanguages", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2SettingService", function(t, n, e, a, i, s, r, o, l, c, d, u, p, g, f, m, h, v, b) {
        var y = e.extendType
          ...
          , x = function() {
            if (!k) {
                ...
                ,
                k = p.notifyInPage("", "Configuration has been modified, please reload the page for the changes to take effect.", {
                    delay: !1,
                    type: "info",
        ...
        ,
        t.swipeActions.extentLeftSwipe = function() {
            var e = -1;
        ...
        ,
        t.swipeActions.extentRightSwipe = function() {
            var e = -1;
            return n.isCurrentGlobalTab() || (e = parseInt(n.getCurrentRpcTabIndex())),
        ...
        n.importSettings = function(e) {
            ...
            try {
                ...
                return g.error("[AriaNgSettingsController.importSettings] parse settings json error", e),
                void p.showError("Invalid settings data format!")
            }
            if (!angular.isObject(t) || angular.isArray(t))
                return g.error("[AriaNgSettingsController.importSettings] settings json is not object"),
                void p.showError("Invalid settings data format!");
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngSetting", ["$timeout", "$q", "ariaNgConstants", "ariaNgLocalizationService", "aria2SettingService", function(u, p, g, f, m) {
        return {
            restrict: "E",
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLanguageLoader", ["$http", "$q", "ariaNgConstants", "ariaNgLanguages", "ariaNgAssetsCacheService", "ariaNgNotificationService", "ariaNgLogService", "ariaNgStorageService", function(r, o, l, c, d, u, p, g) {
        var f = function(e) {
            for (var t = 0; t < e.length; t++)
        ...
        return function(t) {
            var a = o.defer();
            if (!c[t.key])
                return a.reject(t.key),
                a.promise;
            var n = l.languageStorageKeyPrefix + "." + t.key
              , e = g.get(n);
            if (e && a.resolve(e),
            d.getLanguageAsset(t.key)) {
                var i = h(d.getLanguageAsset(t.key));
                return g.set(n, i),
                a.resolve(i),
                a.promise
            }
            var s = l.languagePath + "/" + t.key + l.languageFileExtension;
            return r({
                url: s,
                method: "GET"
            }).then(function(e) {
                ...
                return p.warn("[ariaNgLanguageLoader] cannot get language resource"),
                u.notifyInPage("", "AriaNg cannot get language resources, and will display in default language.", {
                    type: "error",
                    delay: !1
                }),
                a.reject(t.key)
    ...
    angular.module("ariaNg").factory("ariaNgSettingService", ["$window", "$location", "$filter", "ariaNgConstants", "ariaNgDefaultOptions", "ariaNgLanguages", "ariaNgCommonService", "ariaNgLogService", "ariaNgStorageService", function(a, t, e, i, r, s, o, n, l) {
        var c = {
          ...
          , b = function() {
            ...
            m(e) || h())),
            !t) {
                if ((t = angular.extend({}, r)).language = h(),
                t.rpcHost || w(t),
                ...
                v(t),
                function() {
                    if (d && !(p || !angular.isArray(u) || u.length < 1)) {
          ...
          , w = function(e) {
            ...
            f() && (e.protocol = i.defaultSecureProtocol)
        }
          , S = function(e) {
            return {
                rpcAlias: e.rpcAlias,
        ...
        return {
            ...
            exportAllOptions: function() {
                return angular.extend({}, r, b())
            },
            getAllSessionOptions: function() {
                return angular.copy(g)
            },
            ...
            setDefaultRpcSetting: function(e, t) {
                ...
                for (var i = null, s = 0; s < a.extendRpcServers.length; s++)
                    if (a.extendRpcServers[s].rpcId === e.rpcId) {
                        i = S(a.extendRpcServers[s]),
                        a.extendRpcServers.splice(s, 1);
                        break
                    }
                return t.forceSet && (i = S(e)).secret && (i.secret = o.base64Encode(i.secret)),
            ...
            getFileListDisplayOrder: function() {
                var e = y("fileListDisplayOrder");
                return e || (e = "default:asc"),
                e
            },
            setFileListDisplayOrder: function(e) {
                k("fileListDisplayOrder", e)
            },
            getPeerListDisplayOrder: function() {
                var e = y("peerListDisplayOrder");
                return e || (e = "default:asc"),
                e
            },
            setPeerListDisplayOrder: function(e) {
                k("peerListDisplayOrder", e)
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgTitleService", ["$filter", "ariaNgConstants", "ariaNgLocalizationService", "ariaNgSettingService", function(d, f, m, h) {
        var u = function(e) {
            if (!e)
                return {};
        ...
        return {
            getFinalTitle: function(e) {
                var t, a, n, i, s, r, o, l, c, d, u, p, g = h.getTitle();
    ...
    angular.module("ariaNg").factory("aria2RpcService", ["$q", "aria2RpcConstants", "aria2RpcErrors", "aria2AllOptions", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(l, r, o, i, s, c, d, u, e, t) {
        var p = u.isCurrentRpcUseWebSocket() ? t : e
          ...
          , R = function() {
            ...
            if (f && !t && a.push(r.rpcTokenPrefix + f),
            1 < arguments.length) {
                var i = arguments[1];
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "bittorrentPeeridService", "ariaNgConstants", "aria2Errors", "aria2RpcService", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(u, m, l, y, p, k, w, S, g) {
        var x = function(e) {
            if (!e)
                            ...
                            p.addUri({
                                ...
                                callback: function(e) {
                                    if (!e.success)
                                        ...
                                        l.reject(e),
                                        void r(e);
                                    g.getRemoveOldTaskAfterRetrying() && p.removeDownloadResult({
                                        gid: s,
                                        silent: !0,
                                        callback: function(e) {
