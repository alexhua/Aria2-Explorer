...
function() {
    "use strict";
    angular.module("ariaNg", ["ngRoute", "ngSanitize", "ngTouch", "ngMessages", "ngCookies", "ngAnimate", "pascalprecht.translate", "angularMoment", "ngWebSocket", "ab-base64", "LocalStorageModule", "notification", "ui-notification", "angularBittorrentPeerid", "cgBusy", "angularPromiseButtons", "oitozero.ngSweetAlert", "angular-clipboard", "inputDropdown", angularDragula(angular)])
}(),
function() {
    "use strict";
...
function() {
    ...
    angular.module("ariaNg").constant("ariaNgConstants", {
        ...
        removeOldTaskAfterRestarting: !1,
...
function() {
    ...
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$window", "$location", "$document", "$interval", "clipboard", "aria2RpcErrors", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2TaskService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d, u, p, g, f, m, h) {
        var v = null
          , b = null
          , y = function() {
            s[0].title = f.getFinalTitleByGlobalStat(t.globalStat)
        }
          , k = function(e, a) {
            return h.getGlobalStat(function(e) {
                if (!e.success && e.data.message === l.Unauthorized.message)
                    return void r.cancel(b);
                e.success && (t.globalStat = e.data,
                g.recordGlobalStat(e.data)),
                a && a(e)
            }, e)
        };
        p.getBrowserNotification() && d.requestBrowserPermission(),
        t.globalStatusContext = {
            isEnabled: p.getGlobalStatRefreshInterval() > 0,
            data: g.getGlobalStatsData()
        },
        t.enableDebugMode = function() {
            return p.isEnableDebugMode()
        }
        ,
        t.quickSettingContext = null,
        t.rpcSettings = p.getAllRpcSettings(),
        ...
        t.changeTasksState = function(t) {
            ...
            if (n && !(n.length < 1)) {
                ...
                e.loadPromise = s(n, function(e) {
                    e.hasError && n.length > 1 && u.showError("Failed to change some tasks state."),
                    e.hasSuccess && (k(!0),
        ...
        t.restart = function(t) {
            u.confirm("Confirm Restart", "Are you sure you want to restart this task? AriaNg will create a same task after clicking OK.", "info", function() {
                e.loadPromise = m.restartTask(t.gid, function(e) {
                    if (!e.success)
                        return void u.showError("Failed to restart this task.");
                    k(!0),
        ...
        t.removeTasks = function() {
            var t = e.taskContext.getSelectedTasks();
            !t || t.length < 1 || u.confirm("Confirm Remove", "Are you sure you want to remove the selected task?", "warning", function() {
                e.loadPromise = m.removeTasks(t, function(e) {
                    e.hasError && t.length > 1 && u.showError("Failed to remove some task(s)."),
                    e.hasSuccess && (k(!0),
        ...
        t.clearStoppedTasks = function() {
            u.confirm("Confirm Clear", "Are you sure you want to clear stopped tasks?", "warning", function() {
                e.loadPromise = m.clearStoppedTasks(function(e) {
                    e.success && (k(!0),
        ...
        t.changeDisplayOrder = function(e, t) {
            var a = c.parseOrderType(p.getDisplayOrder())
              , n = c.parseOrderType(e);
            t && n.type === a.type && (n.reverse = !a.reverse),
            p.setDisplayOrder(n.getValue())
        }
        ,
        t.isSetDisplayOrder = function(e) {
            var t = c.parseOrderType(p.getDisplayOrder())
              , a = c.parseOrderType(e);
            return t.equals(a)
        }
        ,
        ...
        t.switchRpcSetting = function(e) {
            e.isDefault || (p.setDefaultRpcSetting(e),
            n.location.reload())
        }
        ,
        p.getTitleRefreshInterval() > 0 && (v = r(function() {
            y()
        }, p.getTitleRefreshInterval())),
        p.getGlobalStatRefreshInterval() > 0 && (b = r(function() {
            k(!0)
        }, p.getGlobalStatRefreshInterval())),
    ...
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "clipboard", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d, u) {
        ...
        t.chooseSpecifiedFiles = function(e) {
            if (t.task && t.task.files && r[e]) {
                for (var a = t.task.files, n = r[e], i = [], s = !0, l = 0; l < a.length; l++) {
                    var c = a[l];
                    if (!c.isDir) {
...
function() {
    ...
    angular.module("ariaNg").controller("AriaNgSettingsController", ["$rootScope", "$scope", "$routeParams", "$window", "$interval", "$timeout", "$filter", "clipboard", "ariaNgLanguages", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d, u, p, g, f, m, h, v) {
        var b = a.extendType
          , y = null
          , k = function() {
            return h.getFinalTitleByGlobalStat(m.getCurrentGlobalStat())
        }
          , w = function() {
            if (!y) {
                var t = e.$new();
                ...
                ,
                y = u.notifyInPage("", "Configuration has been modified, please reload the page for the changes to take effect.", {
                    delay: !1,
                    type: "info",
        ...
        t.context = {
            ...
            languages: l,
            titlePreview: k(),
            availableTime: c.getTimeOptions([1e3, 2e3, 3e3, 5e3, 1e4, 3e4, 6e4], !0),
            trueFalseOptions: [{
                name: "True",
                value: !0
            }, {
            ...
            showRpcSecret: !1,
            isInsecureProtocolDisabled: f.isInsecureProtocolDisabled(),
            settings: f.getAllOptions(),
            sessionSettings: f.getAllSessionOptions(),
            rpcSettings: f.getAllRpcSettings(),
            isSupportBlob: g.isSupportBlob(),
            importSettings: null,
            exportSettings: null,
            exportSettingsCopied: !1
        },
        t.context.showDebugMode = t.context.sessionSettings.debugMode || "debug" === b,
        ...
        t.isSupportNotification = function() {
            return d.isSupportBrowserNotification() && f.isCurrentRpcUseWebSocket(t.context.settings.protocol)
        }
        ,
        t.setLanguage = function(e) {
            f.setLanguage(e) && u.applyLanguage(e),
        ...
        t.setEnableBrowserNotification = function(e) {
            f.setBrowserNotification(e),
            e && !d.hasBrowserPermission() && d.requestBrowserPermission(function(e) {
                d.isPermissionGranted(e) || (t.context.settings.browserNotification = !1,
                u.showError("You have disabled notification in your browser. You should change your browser's settings before you enable this function."))
            })
        }
        ,
        t.setTitleRefreshInterval = function(e) {
            w(),
            f.setTitleRefreshInterval(e)
        }
        ,
        t.setGlobalStatRefreshInterval = function(e) {
            w(),
            f.setGlobalStatRefreshInterval(e)
        }
        ,
        t.setDownloadTaskRefreshInterval = function(e) {
            w(),
            f.setDownloadTaskRefreshInterval(e)
        }
        ,
        t.setRPCListDisplayOrder = function(e) {
            w(),
            f.setRPCListDisplayOrder(e)
        }
        ,
        t.setAfterCreatingNewTask = function(e) {
            f.setAfterCreatingNewTask(e)
        }
        ,
        t.setRemoveOldTaskAfterRestarting = function(e) {
            f.setRemoveOldTaskAfterRestarting(e)
        }
        ,
        ...
        t.importSettings = function(e) {
            ...
            try {
                ...
                return p.error("[AriaNgSettingsController.importSettings] parse settings json error", e),
                void u.showError("Invalid settings data format!")
            }
            if (!angular.isObject(t) || angular.isArray(t))
                return p.error("[AriaNgSettingsController.importSettings] settings json is not object"),
                void u.showError("Invalid settings data format!");
            t && u.confirm("Confirm Import", "Are you sure you want to import all settings?", "warning", function() {
                f.importAllOptions(t),
                n.location.reload()
            })
        }
        ,
        t.showExportSettingsModal = function() {
            t.context.exportSettings = r("json")(f.exportAllOptions()),
        ...
        t.updateRpcSetting = function(e, t) {
            w(),
            f.updateRpcSetting(e, t)
        }
        ,
        t.removeRpcSetting = function(e) {
            var a = e.rpcAlias ? e.rpcAlias : e.rpcHost + ":" + e.rpcPort;
            u.confirm("Confirm Remove", 'Are you sure you want to remove rpc setting "{{rpcName}}"?', "warning", function() {
                w();
                var a = t.context.rpcSettings.indexOf(e);
                f.removeRpcSetting(e),
                t.context.rpcSettings.splice(a, 1),
                t.isCurrentRpcTab(a) && a >= t.context.rpcSettings.length && t.changeRpcTab(t.context.rpcSettings.length - 1)
            }, !1, {
                textParams: {
                    rpcName: a
                }
        ...
        t.resetSettings = function() {
            u.confirm("Confirm Reset", "Are you sure you want to reset all settings?", "warning", function() {
                f.resetSettings(),
                n.location.reload()
            })
        }
        ...
        t.clearHistory = function() {
            u.confirm("Confirm Clear", "Are you sure you want to clear all settings history?", "warning", function() {
                v.clearSettingsHistorys(),
                n.location.reload()
            })
        }
        ,
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLanguageLoader", ["$http", "$q", "ariaNgConstants", "ariaNgLanguages", "ariaNgNotificationService", "ariaNgLogService", "ariaNgStorageService", function(e, t, a, n, i, s, r) {
        var o = function(e) {
        ...
        return function(o) {
            var l = t.defer();
            if (!n[o.key])
                return l.reject(o.key),
                l.promise;
            var d = a.languageStorageKeyPrefix + "." + o.key
              , u = r.get(d);
            u && l.resolve(u);
            var p = a.languagePath + "/" + o.key + a.languageFileExtension;
            return e({
                url: p,
                method: "GET"
            }).then(function(e) {
                ...
                return s.warn("[ariaNgLanguageLoader] cannot get language resource"),
                i.notifyInPage("", "AriaNg cannot get language resources, and will display in default language.", {
                    type: "error",
                    delay: !1
                }),
                l.reject(o.key)
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgNotificationService", ["$notification", "Notification", "ariaNgSettingService", function(e, t, a) {
        var n = e.isSupported
          , i = function(e) {
            return "granted" === e
        };
        return {
            ...
            hasBrowserPermission: function() {
                return !!n && i(e.getPermission())
            },
            requestBrowserPermission: function(t) {
                n && e.requestPermission().then(function(e) {
                    i(e) || a.setBrowserNotification(!1),
                    t && t(e)
                })
            },
            notifyViaBrowser: function(t, i) {
                n && a.getBrowserNotification() && e(t, {
                    body: i
                })
            },
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgLocalizationService", ["$translate", "amMoment", "ariaNgCommonService", "ariaNgNotificationService", function(e, t, a, n) {
        return {
            ...
            notifyViaBrowser: function(e, t) {
                return e && (e = this.getLocalizedText(e)),
                t && (t = this.getLocalizedText(t)),
                n.notifyViaBrowser(e, t)
            },
        ...
        return {
            ...
            getAllRpcSettings: function() {
                ...
                return "recentlyUsed" === s || "rpcAlias" === s && e.sort(function(e, t) {
                    return e.rpcAlias < t.rpcAlias ? -1 : e.rpcAlias > t.rpcAlias ? 1 : 0
                }),
                e
            },
            ...
            getRemoveOldTaskAfterRestarting: function() {
                return x("removeOldTaskAfterRestarting")
            },
            setRemoveOldTaskAfterRestarting: function(e) {
                T("removeOldTaskAfterRestarting", e)
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2RpcService", ["$q", "aria2RpcConstants", "aria2RpcErrors", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(e, t, a, n, i, s, r, o, l) {
        var c = r.isCurrentRpcUseWebSocket() ? l : o
          , d = !1
          , u = r.getCurrentRpcSecret()
          , p = []
          , g = []
          , f = []
          , m = []
          ...
          , O = function(e) {
            return !(!e || !e.message) && (s.error("[aria2RpcService.processError] " + e.message, e),
            a[e.message] && a[e.message].tipTextKey ? (i.showError(a[e.message].tipTextKey),
            !0) : (i.showError(e.message),
            !0))
        }
          , R = function() {
            var e = arguments[0]
            ...
            if (u && !a && n.push(t.rpcTokenPrefix + u),
            arguments.length > 1) {
                var s = arguments[1];
                i.successCallback = function(e, t) {
                    ...
                    !d) {
                        d = !0;
                        var a = {
                            rpcName: r.getCurrentRpcDisplayName()
                        };
                        P(p, a)
                    }
                }
        ...
        return function() {
            ...
            C("onDownloadPause", h),
            C("onDownloadStop", v),
            C("onDownloadComplete", b),
            C("onDownloadError", y),
            C("onBtDownloadComplete", k)
        }(),
        {
            ...
            addUriMulti: function(e) {
                ...
                return D(this.addUri, t, e.callback)
            },
            addTorrent: function(e, t) {
                var a = e.task.content
                  , n = angular.copy(e.task.options);
                return e.pauseOnAdded && (n.pause = "true"),
                T(R("addTorrent", e, a, [], n), !!t)
            },
            addMetalink: function(e, t) {
                var a = e.task.content
                  , n = angular.copy(e.task.options);
                return e.pauseOnAdded && (n.pause = "true"),
                T(R("addMetalink", e, a, [], n), !!t)
            },
            remove: function(e, t) {
                return T(R("remove", e, e.gid), !!t)
            },
            forceRemove: function(e, t) {
                return T(R("forceRemove", e, e.gid), !!t)
            },
            forceRemoveMulti: function(e) {
                ...
                return D(this.forceRemove, t, e.callback)
            },
            pause: function(e, t) {
                return T(R("pause", e, e.gid), !!t)
            },
            pauseAll: function(e, t) {
                return T(R("pauseAll", e), !!t)
            },
            forcePause: function(e, t) {
                return T(R("forcePause", e, e.gid), !!t)
            },
            forcePauseMulti: function(e) {
                ...
                return D(this.forcePause, t, e.callback)
            },
            forcePauseAll: function(e, t) {
                return T(R("forcePauseAll", e), !!t)
            },
            unpause: function(e, t) {
                return T(R("unpause", e, e.gid), !!t)
            },
            unpauseMulti: function(e) {
                ...
                return D(this.unpause, t, e.callback)
            },
            unpauseAll: function(e, t) {
                return T(R("unpauseAll", e), !!t)
            },
            tellStatus: function(e, t) {
                return T(R("tellStatus", e, e.gid), !!t)
            },
            getUris: function(e, t) {
                return T(R("getUris", e, e.gid), !!t)
            },
            getFiles: function(e, t) {
                return T(R("getFiles", e, e.gid), !!t)
            },
            getPeers: function(e, t) {
                return T(R("getPeers", e, e.gid), !!t)
            },
            getServers: function(e, t) {
                return T(R("getServers", e, e.gid), !!t)
            },
            tellActive: function(e, t) {
                return T(R("tellActive", e, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellWaiting: function(e, t) {
                return T(R("tellWaiting", e, angular.isDefined(e.offset) ? e.offset : 0, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellStopped: function(e, t) {
                return T(R("tellStopped", e, angular.isDefined(e.offset) ? e.offset : -1, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            changePosition: function(e, t) {
                return T(R("changePosition", e, e.gid, e.pos, e.how), !!t)
            },
            changeUri: function(e, t) {
                return T(R("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris), !!t)
            },
            getOption: function(e, t) {
                return T(R("getOption", e, e.gid), !!t)
            },
            changeOption: function(e, t) {
                return T(R("changeOption", e, e.gid, e.options), !!t)
            },
            getGlobalOption: function(e, t) {
                return T(R("getGlobalOption", e), !!t)
            },
            changeGlobalOption: function(e, t) {
                return T(R("changeGlobalOption", e, e.options), !!t)
            },
            getGlobalStat: function(e, t) {
                return T(R("getGlobalStat", e), !!t)
            },
            purgeDownloadResult: function(e, t) {
                return T(R("purgeDownloadResult", e), !!t)
            },
            removeDownloadResult: function(e, t) {
                return T(R("removeDownloadResult", e, e.gid), !!t)
            },
            removeDownloadResultMulti: function(e) {
                ...
                return D(this.removeDownloadResult, t, e.callback)
            },
            getVersion: function(e, t) {
                return T(R("getVersion", e), !!t)
            },
            getSessionInfo: function(e, t) {
                return T(R("getSessionInfo", e), !!t)
            },
            shutdown: function(e, t) {
                return T(R("shutdown", e), !!t)
            },
            forceShutdown: function(e, t) {
                return T(R("forceShutdown", e), !!t)
            },
            saveSession: function(e, t) {
                return T(R("saveSession", e), !!t)
            },
            multicall: function(e) {
                return T(R("system.multicall", e, e.methods))
            },
            listMethods: function(e) {
                return T(R("system.listMethods", e))
            },
            ...
            restartTask: function(t, a, n) {
                ...
                return i.multicall({
                    ...
                    callback: function(e) {
                        ...
                        if (!e.success)
                            return o.warn("[aria2TaskService.restartTask] response is not success", e),
                            s.reject(e),
                            void a(e);
                        if (e.data.length > 0 && (c = e.data[0][0]),
                        e.data.length > 1 && (d = e.data[1][0]),
                        !c || !d || !c.files || 1 !== c.files.length || c.bittorrent)
                            return c || o.warn("[aria2TaskService.restartTask] task is null"),
                            d || o.warn("[aria2TaskService.restartTask] options is null"),
                            c.files || o.warn("[aria2TaskService.restartTask] task file is null"),
                            1 !== c.files.length && o.warn("[aria2TaskService.restartTask] task file length is not equal 1"),
                            c.bittorrent && o.warn("[aria2TaskService.restartTask] task is bittorrent"),
                            s.reject(t),
                            void a({
                                success: !1
                            });
                        ...
                        i.addUri({
                            ...
                            callback: function(e) {
                                if (!e.success)
                                    return o.warn("[aria2TaskService.restartTask] addUri response is not success", e),
                                    s.reject(e),
                                    void a(e);
                                l.getRemoveOldTaskAfterRestarting() && i.removeDownloadResult({
                                    gid: t,
                                    silent: !0,
                                    callback: function(e) {
                                        e.success || o.warn("[aria2TaskService.restartTask] removeDownloadResult response is not success", e)
                                    }
                                }),
                                s.resolve(e),
                                a(e)
