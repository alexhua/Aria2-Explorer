...
function() {
    "use strict";
    angular.module("ariaNg", ["ngRoute", "ngSanitize", "ngTouch", "ngMessages", "ngCookies", "ngAnimate", "pascalprecht.translate", "angularMoment", "ngWebSocket", "ab-base64", "LocalStorageModule", "notification", "ui-notification", "angularBittorrentPeerid", "cgBusy", "angularPromiseButtons", "oitozero.ngSweetAlert", "angular-clipboard", angularDragula(angular)])
}(),
function() {
...
function() {
    "use strict";
    angular.module("ariaNg").run(["$rootScope", "$location", "$document", "SweetAlert", "ariaNgNotificationService", "ariaNgSettingService", "aria2TaskService", function(e, t, a, n, i, s, r) {
        var o = function(e, t) {
          ...
          , l = function(e) {
            ...
            angular.element("section.sidebar > ul > li[data-href-match]").each(function(t, a) {
                ...
                o(n, e) && angular.element(a).addClass("active")
            }),
            angular.element("section.sidebar > ul > li.treeview > ul.treeview-menu > li[data-href-match]").each(function(t, a) {
                var n = angular.element(a).attr("data-href-match");
                o(n, e) && angular.element(a).addClass("active").parent().parent().addClass("active")
            })
        }
          , c = function() {
        ...
        r.onFirstSuccess(function() {
            i.notifyInPage("", "Connection Succeeded", {
                type: "success"
            })
        }),
        r.onConnectSuccess(function() {
            e.taskContext.rpcStatus = "Connected"
        }),
        r.onConnectError(function() {
            e.taskContext.rpcStatus = "Not Connected"
        }),
        r.onTaskCompleted(function(e) {
            i.notifyTaskComplete(e.task)
        }),
        r.onBtTaskCompleted(function(e) {
            i.notifyBtTaskComplete(e.task)
        }),
        r.onTaskErrorOccur(function(e) {
...
function() {
    ...
    angular.module("ariaNg").config(["$qProvider", "$translateProvider", "localStorageServiceProvider", "NotificationProvider", "ariaNgConstants", "ariaNgLanguages", function(e, t, a, n, i, s) {
        ...
        t.useLoader("ariaNgLanguageLoader").useLoaderCache(!0).registerAvailableLanguageKeys(r, o).determinePreferredLanguage().fallbackLanguage(i.defaultLanguage).useSanitizeValueStrategy("escapeParameters"),
        n.setOptions({
...
function() {
    "use strict";
    angular.module("ariaNg").controller("CommandController", ["$rootScope", "$window", "$location", "$routeParams", "base64", "ariaNgDefaultOptions", "ariaNgCommonService", "ariaNgSettingService", "aria2SettingService", "aria2TaskService", "ariaNgLogService", function(e, t, a, n, i, s, r, o, l, c, d) {
        var u = a.path()
          , p = function(t, n) {
            try {
                t = i.urldecode(t)
            ...
            if (n)
                for (var o in n)
                    n.hasOwnProperty(o) && l.isOptionKeyValid(o) && (s[o] = n[o]);
            ...
            d.info("[CommandController] new download: " + t),
            !0
        }
          , f = function(e, n, l, c, u) {
            if (l = l || s.rpcPort,
            c = c || s.rpcInterface,
            u = u || s.secret,
            d.info("[CommandController] set rpc: " + e + "://" + n + ":" + l + "/" + c + ", secret: " + u),
            ...
            return o.isRpcSettingEqualsDefault(p) ? a.path("/downloading") : (o.setDefaultRpcSetting(p, {
                keepCurrent: !1,
                forceSet: !0
            }),
            a.path("/downloading"),
          ...
          , g = angular.extend({}, n, a.search());
        (function(e, t) {
            return 0 === e.indexOf("/new") ? p(t.url, t) : 0 === e.indexOf("/settings/rpc/set") ? f(t.protocol, t.host, t.port, t.interface, t.secret) : (r.showError("Parameter is invalid!"),
            !1)
        }
        )(u, g) || a.path("/downloading")
    }
    ])
}(),
function() {
    ...
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$window", "$location", "$document", "$interval", "clipboard", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "ariaNgTitleService", "ariaNgMonitorService", "ariaNgNotificationService", "aria2TaskService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d, u, p, f, g, m) {
        var h = null
          , v = null
          , b = function() {
            s[0].title = u.getFinalTitleByGlobalStat(t.globalStat)
        }
          , y = function(e, a) {
            return m.getGlobalStat(function(e) {
                if (!e.success && e.data.message === l.Unauthorized.message)
                    return void r.cancel(v);
                e.success && (t.globalStat = e.data,
                p.recordGlobalStat(e.data)),
                a && a(e)
            }, e)
        };
        d.getBrowserNotification() && f.requestBrowserPermission(),
        t.globalStatusContext = {
            isEnabled: d.getGlobalStatRefreshInterval() > 0,
            data: p.getGlobalStatsData()
        },
        t.quickSettingContext = null,
        t.rpcSettings = d.getAllRpcSettings(),
        ...
        t.changeTasksState = function(t) {
            ...
            if (n && !(n.length < 1)) {
                ...
                e.loadPromise = s(n, function(e) {
                    e.hasError && n.length > 1 && c.showError("Failed to change some tasks state."),
                    e.hasSuccess && (y(!0),
        ...
        t.restart = function(t) {
            c.confirm("Confirm Restart", "Are you sure you want to restart this task? AriaNg will create a same task after clicking OK.", "info", function() {
                e.loadPromise = g.restartTask(t.gid, function(e) {
                    if (!e.success)
                        return void c.showError("Failed to restart this task.");
                    y(!0),
        ...
        t.removeTasks = function() {
            var t = e.taskContext.getSelectedTasks();
            !t || t.length < 1 || c.confirm("Confirm Remove", "Are you sure you want to remove the selected task?", "warning", function() {
                e.loadPromise = g.removeTasks(t, function(e) {
                    e.hasError && t.length > 1 && c.showError("Failed to remove some task(s)."),
                    e.hasSuccess && (y(!0),
        ...
        t.clearStoppedTasks = function() {
            c.confirm("Confirm Clear", "Are you sure you want to clear stopped tasks?", "warning", function() {
                e.loadPromise = g.clearStoppedTasks(function(e) {
                    e.success && (y(!0),
        ...
        t.changeDisplayOrder = function(e, t) {
            var a = c.parseOrderType(d.getDisplayOrder())
              , n = c.parseOrderType(e);
            t && n.type === a.type && (n.reverse = !a.reverse),
            d.setDisplayOrder(n.getValue())
        }
        ,
        t.isSetDisplayOrder = function(e) {
            var t = c.parseOrderType(d.getDisplayOrder())
        ...
        t.switchRpcSetting = function(e) {
            e.isDefault || (d.setDefaultRpcSetting(e),
            n.location.reload())
        }
        ,
        d.getTitleRefreshInterval() > 0 && (h = r(function() {
            b()
        }, d.getTitleRefreshInterval())),
        d.getGlobalStatRefreshInterval() > 0 && (v = r(function() {
            y(!0)
        }, d.getGlobalStatRefreshInterval())),
...
function() {
    "use strict";
    angular.module("ariaNg").controller("NewTaskController", ["$rootScope", "$scope", "$location", "$timeout", "base64", "ariaNgCommonService", "ariaNgLogService", "ariaNgSettingService", "ariaNgFileService", "aria2SettingService", "aria2TaskService", function(e, t, a, n, i, s, r, o, l, c, d) {
        var u = ["links", "options"]
          , p = a.search()
          , f = function(e, a) {
            for (var n = s.parseUrlsFromOriginInput(t.context.urls), i = angular.copy(t.context.options), r = [], o = 0; o < n.length; o++)
                "" !== n[o] && "" !== n[o].trim() && r.push({
                    urls: [n[o].trim()],
                    options: i
                });
            return d.newUriTasks(r, e, a)
        }
          , g = function(e, a) {
            var n = {
          ...
          , m = function(e, a) {
            ...
            return d.newMetalinkTask(n, e, a)
        };
        if (t.context = {
            currentTab: "links",
            taskType: "urls",
            ...
            availableOptions: function() {
                ...
                return c.getSpecifiedOptions(e, {
                    disableRequired: !0
                })
            }(),
            globalOptions: null,
        ...
        p.url)
            try {
                t.context.urls = i.urldecode(p.url);
        ...
        t.loadDefaultOption = function() {
            t.context.globalOptions || (e.loadPromise = c.getGlobalOption(function(e) {
                e.success && (t.context.globalOptions = e.data)
            }))
        }
        ,
        t.openTorrent = function() {
            l.openFileContent(".torrent", function(e) {
        ...
        t.openMetalink = function() {
            l.openFileContent(".meta4,.metalink", function(e) {
                t.context.uploadFile = e,
        ...
        t.startDownload = function(n) {
            var i = function(e) {
                if (e.hasSuccess || e.success) {
                    ...
                    "task-detail" === o.getAfterCreatingNewTask() && t && t.data ? a.path("/task/detail/" + t.data) : n ? a.path("/waiting") : a.path("/downloading")
                }
            };
            "urls" === t.context.taskType ? e.loadPromise = f(n, i) : "torrent" === t.context.taskType ? e.loadPromise = g(n, i) : "metalink" === t.context.taskType && (e.loadPromise = m(n, i))
        }
        ,
        ...
        t.getValidUrlsCount = function() {
            var e = s.parseUrlsFromOriginInput(t.context.urls);
            return e ? e.length : 0
        }
        ,
            ...
            if (!f)
                return d.getTaskList(u, g, function(t) {
                    if (!f) {
                        ...
                        g = !1) : g = !l.extendArray(n, e.taskContext.list, "gid"),
...
function() {
    ...
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "clipboard", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d, u) {
          ...
          , k = function(e) {
            if (!g) {
                ...
                return t.task ? d.getTaskStatusAndBtPeers(a.gid, function(e) {
                    ...
                    v(e.task),
                    b(e.peers)
                }, e, y(t.task), !0) : d.getTaskStatus(a.gid, function(t) {
                    if (!t.success)
        ...
        t.changeFileListDisplayOrder = function(e, t) {
            var a = o.parseOrderType(l.getFileListDisplayOrder())
              , n = o.parseOrderType(e);
            t && n.type === a.type && (n.reverse = !a.reverse),
            l.setFileListDisplayOrder(n.getValue())
        }
        ,
        ...
        t.getFileListOrderType = function() {
            return l.getFileListDisplayOrder()
        }
        ,
        ...
        t.chooseSpecifiedFiles = function(e) {
            if (t.task && t.task.files && r[e]) {
                for (var a = r[e], n = [], i = !0, s = 0; s < t.task.files.length; s++) {
                    var l = o.getFileExtension(t.task.files[s].fileName);
                    l && (l = l.toLowerCase()),
                    a.indexOf(l) >= 0 && (n.push(s),
                    t.task.files[s].selected || (i = !1))
                }
        ...
        t.cancelChooseFiles = function() {
            t.context.showChooseFilesToolbar && (g = !1,
            k(!0),
            t.context.showChooseFilesToolbar = !1)
        }
        ,
...
function() {
    "use strict";
    angular.module("ariaNg").controller("AriaNgSettingsController", ["$rootScope", "$scope", "$routeParams", "$window", "$interval", "$timeout", "ariaNgLanguages", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgNotificationService", "ariaNgTitleService", function(e, t, a, n, i, s, r, o, l, c, d, u) {
        var p = a.extendType
          , f = null
          , g = function() {
        ...
        t.context = {
            ...
            languages: r,
            titlePreview: g(),
            availableTime: o.getTimeOptions([1e3, 2e3, 3e3, 5e3, 1e4, 3e4, 6e4], !0),
            trueFalseOptions: [{
                name: "True",
                value: !0
            }, {
            ...
            showRpcSecret: !1,
            isInsecureProtocolDisabled: l.isInsecureProtocolDisabled(),
        ...
        t.setRemoveOldTaskAfterRestarting = function(e) {
            l.setRemoveOldTaskAfterRestarting(e)
        }
        ,
        ...
        t.setEnableBrowserNotification = function(e) {
            ...
            e && !d.hasBrowserPermission() && d.requestBrowserPermission(function(e) {
                ...
                o.showError("You have disabled notification in your browser. You should change your browser's settings before you enable this function."))
            })
        }
        ,
        ...
        t.removeRpcSetting = function(e) {
            ...
            o.confirm("Confirm Remove", 'Are you sure you want to remove rpc setting "{{rpcName}}"?', "warning", function() {
                m();
        ...
        t.setDefaultRpcSetting = function(e) {
            e.isDefault || (l.setDefaultRpcSetting(e),
            n.location.reload())
        }
        ,
        t.resetSettings = function() {
            o.confirm("Confirm Reset", "Are you sure you want to reset all settings?", "warning", function() {
                l.resetSettings(),
                n.location.reload()
            })
        }
    ...
    angular.module("ariaNg").controller("Aria2StatusController", ["$rootScope", "$scope", "ariaNgCommonService", "ariaNgSettingService", "aria2SettingService", function(e, t, a, n, i) {
        ...
        e.loadPromise = function() {
            return i.getAria2Status(function(e) {
                ...
                t.context.serverStatus = e.data) : t.context.status = "Not Connected"
            })
        }()
    }
    ])
        ...
        return {
            ...
            link: function(n, i, s, r) {
                ...
                n.changeValue = function(t, a) {
                    if (o && e.cancel(o),
                    n.optionValue = t,
                    n.optionStatus.setReady(),
                    n.option && n.option.key && !n.option.readonly) {
                        ...
                        if ("" !== t && ("integer" === n.option.type || "float" === n.option.type) && (angular.isDefined(n.option.min) || angular.isDefined(n.option.max))) {
                            var i = t;
                            if ("integer" === n.option.type ? i = parseInt(t) : "float" === n.option.type && (i = parseFloat(t)),
                            angular.isDefined(n.option.min) && i < n.option.min)
                        ...
                        n.onChangeValue && (a ? (n.optionStatus.setPending(),
                        o = e(function() {
                            r()
                        }, l.lazySaveTimeout)) : r())
                    }
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgCommonService", ["$location", "$timeout", "base64", "SweetAlert", "$translate", "ariaNgConstants", function(e, t, a, n, i, s) {
        return {
            ...
            confirm: function(e, t, a, s, r, o) {
                var l = {
                    title: i.instant(e),
                    text: i.instant(t, angular.isObject(o) ? o.textParams : null),
                    type: a,
                    showCancelButton: !0,
                    showLoaderOnConfirm: !!r,
                    closeOnConfirm: !r,
                    confirmButtonText: i.instant("OK"),
    ...
    angular.module("ariaNg").factory("ariaNgMonitorService", ["$filter", "$translate", "moment", "ariaNgConstants", function(e, t, a, n) {
        var i = {}
          ...
          , o = function(n) {
            for (var i = {
                ...
                tooltip: {
                    ...
                    formatter: function(n) {
                        if ("" === n[0].name)
                            return "<div>" + t.instant("No Data") + "</div>";
                        var i = a(n[0].name, "X").format("HH:mm:ss")
                          , s = e("readableVolume")(n[0].value) + "/s";
                        return '<div><i class="fa fa-clock-o"></i> ' + i + '</div><div><i class="icon-download fa fa-arrow-down"></i> ' + e("readableVolume")(n[1].value) + '/s</div><div><i class="icon-upload fa fa-arrow-up"></i> ' + s + "</div>"
                    }
                },
                xAxis: {
                    data: [],
            ...
            }, o = i.xAxis.data, l = i.series[0].data, c = i.series[1].data, d = 0; d < r(n); d++)
                o.push(""),
                l.push(""),
                c.push("");
            return s[n] = i,
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgSettingService", ["$window", "$location", "$filter", "$translate", "base64", "amMoment", "localStorageService", "ariaNgConstants", "ariaNgDefaultOptions", "ariaNgLanguages", "ariaNgCommonService", function(e, t, a, n, i, s, r, o, l, c, d) {
        var u = []
          , p = {
            debugMode: !1
        }
          ...
          , b = function() {
            var e = t.host();
            return e || o.defaultHost
        }
          , y = function(e) {
            return r.set(o.optionStorageKey, e)
        }
          , k = function() {
            var e = r.get(o.optionStorageKey);
            if (e && !c[e.language] && (e.language = v(e.language)),
            !e) {
                if (e = angular.extend({}, l),
                e.language = h(),
                e.rpcHost || T(e),
          ...
          , S = function(e) {
            var t = k();
            return angular.isUndefined(t[e]) && angular.isDefined(l[e]) && (t[e] = l[e],
            y(t)),
            t[e]
        }
          , x = function(e, t) {
          ...
          , T = function(e) {
            e.rpcHost = b(),
            g() && (e.protocol = o.defaultSecureProtocol)
        }
          , C = function(e) {
            return {
                rpcAlias: e.rpcAlias,
        ...
        return {
            getAllOptions: function() {
                var e = angular.extend({}, l, k());
                if (e.secret && (e.secret = i.decode(e.secret)),
                angular.isArray(e.extendRpcServers))
                    for (var t = 0; t < e.extendRpcServers.length; t++) {
                        var a = e.extendRpcServers[t];
            ...
            setLanguage: function(e) {
                this.applyLanguage(e) && x("language", e)
            },
            ...
            getRemoveOldTaskAfterRestarting: function() {
                return S("removeOldTaskAfterRestarting")
            },
            setRemoveOldTaskAfterRestarting: function(e) {
                x("removeOldTaskAfterRestarting", e)
            },
            ...
            updateRpcSetting: function(e, t) {
                ...
                if (angular.isUndefined(a[t]))
                    return e;
                var n = a[t];
                if ("rpcPort" === t ? n = Math.max(parseInt(n), 0) : "secret" === t && n && (n = i.encode(n)),
                e.isDefault)
                    return x(t, n),
                    e;
                var s = k();
                if (!angular.isArray(s.extendRpcServers))
                    return e;
                for (var r = 0; r < s.extendRpcServers.length; r++)
                    if (s.extendRpcServers[r].rpcId === e.rpcId) {
                        s.extendRpcServers[r][t] = n;
                        break
                    }
                return y(s),
                e
            ...
            setDefaultRpcSetting: function(e, t) {
                ...
                for (var s = null, r = 0; r < a.extendRpcServers.length; r++)
                    if (a.extendRpcServers[r].rpcId === e.rpcId) {
                        s = C(a.extendRpcServers[r]),
                        a.extendRpcServers.splice(r, 1);
                        break
                    }
                return t.forceSet && (s = C(e),
                s.secret && (s.secret = i.encode(s.secret))),
                s && (t.keepCurrent && a.extendRpcServers.splice(0, 0, n),
                a = angular.extend(a, s)),
                y(a),
                e
            },
          ...
          , l = function(e) {
            ...
            if (t) {
                ...
                if (a) {
                    ...
                    e.result && i.successCallback && (n.debug("[aria2WebSocketRpcService.request] response success", e),
                    i.successCallback(i.id, e.result)),
                    e.error && i.errorCallback && (n.debug("[aria2WebSocketRpcService.request] response error", e),
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2RpcService", ["$q", "aria2RpcConstants", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "ariaNgLogService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(e, t, a, n, i, s, r, o) {
        var l = i.isCurrentRpcUseWebSocket() ? o : r
          , c = !1
          ...
          , O = function(e) {
            ...
            a[e.message] && a[e.message].tipTextKey ? (n.showError(a[e.message].tipTextKey),
            !0) : (n.showError(e.message),
            !0))
        }
          , D = function() {
            var e = arguments[0]
            ...
            if (d && !a && n.push(t.rpcTokenPrefix + d),
            arguments.length > 1) {
                var s = arguments[1];
        ...
        }(),
        {
            ...
            addTorrent: function(e, t) {
                var a = e.task.content
                  , n = angular.copy(e.task.options);
                return e.pauseOnAdded && (n.pause = "true"),
                x(D("addTorrent", e, a, [], n), !!t)
            },
            addMetalink: function(e, t) {
                var a = e.task.content
                  , n = angular.copy(e.task.options);
                return e.pauseOnAdded && (n.pause = "true"),
                x(D("addMetalink", e, a, [], n), !!t)
            },
            remove: function(e, t) {
                return x(D("remove", e, e.gid), !!t)
            },
            forceRemove: function(e, t) {
                return x(D("forceRemove", e, e.gid), !!t)
            },
            ...
            pause: function(e, t) {
                return x(D("pause", e, e.gid), !!t)
            },
            pauseAll: function(e, t) {
                return x(D("pauseAll", e), !!t)
            },
            forcePause: function(e, t) {
                return x(D("forcePause", e, e.gid), !!t)
            },
            ...
            forcePauseAll: function(e, t) {
                return x(D("forcePauseAll", e), !!t)
            },
            unpause: function(e, t) {
                return x(D("unpause", e, e.gid), !!t)
            },
            ...
            unpauseAll: function(e, t) {
                return x(D("unpauseAll", e), !!t)
            },
            tellStatus: function(e, t) {
                return x(D("tellStatus", e, e.gid), !!t)
            },
            getUris: function(e, t) {
                return x(D("getUris", e, e.gid), !!t)
            },
            getFiles: function(e, t) {
                return x(D("getFiles", e, e.gid), !!t)
            },
            getPeers: function(e, t) {
                return x(D("getPeers", e, e.gid), !!t)
            },
            getServers: function(e, t) {
                return x(D("getServers", e, e.gid), !!t)
            },
            tellActive: function(e, t) {
                return x(D("tellActive", e, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellWaiting: function(e, t) {
                return x(D("tellWaiting", e, angular.isDefined(e.offset) ? e.offset : 0, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellStopped: function(e, t) {
                return x(D("tellStopped", e, angular.isDefined(e.offset) ? e.offset : -1, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            changePosition: function(e, t) {
                return x(D("changePosition", e, e.gid, e.pos, e.how), !!t)
            },
            changeUri: function(e, t) {
                return x(D("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris), !!t)
            },
            getOption: function(e, t) {
                return x(D("getOption", e, e.gid), !!t)
            },
            changeOption: function(e, t) {
                return x(D("changeOption", e, e.gid, e.options), !!t)
            },
            getGlobalOption: function(e, t) {
                return x(D("getGlobalOption", e), !!t)
            },
            changeGlobalOption: function(e, t) {
                return x(D("changeGlobalOption", e, e.options), !!t)
            },
            getGlobalStat: function(e, t) {
                return x(D("getGlobalStat", e), !!t)
            },
            purgeDownloadResult: function(e, t) {
                return x(D("purgeDownloadResult", e), !!t)
            },
            removeDownloadResult: function(e, t) {
                return x(D("removeDownloadResult", e, e.gid), !!t)
            },
            ...
            getVersion: function(e, t) {
                return x(D("getVersion", e), !!t)
            },
            getSessionInfo: function(e, t) {
                return x(D("getSessionInfo", e), !!t)
            },
            shutdown: function(e, t) {
                return x(D("shutdown", e), !!t)
            },
            forceShutdown: function(e, t) {
                return x(D("forceShutdown", e), !!t)
            },
            saveSession: function(e, t) {
                return x(D("saveSession", e), !!t)
            },
            multicall: function(e) {
                return x(D("system.multicall", e, e.methods))
            },
            listMethods: function(e) {
                return x(D("system.listMethods", e))
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "$translate", "bittorrentPeeridService", "aria2Errors", "aria2RpcService", "ariaNgCommonService", "ariaNgSettingService", "ariaNgLogService", function(e, t, a, n, i, s, r, o) {
        var l = function(e) {
            if (!e)
          ...
          , d = function(e) {
            ...
            !a && e.files && e.files.length > 0 && (a = l(e.files[0])),
            a || (a = t.instant("Unknown"),
            n = !1),
            {
                name: a,
                success: n
          ...
          , g = function(e) {
            if (!e)
                ...
                e;
            var t = p(e.bitfield, e.numPieces);
            ...
            e.remainTime = c(e.remainLength, e.downloadSpeed),
            e.seeder = !0 === e.seeder || "true" === e.seeder;
            var a = d(e);
            if (e.taskName = a.name,
            e.hasTaskName = a.success,
            e.errorDescription = u(e),
            e.files) {
                for (var n = 0, i = 0; i < e.files.length; i++) {
                    var r = e.files[i];
                    r.index = parseInt(r.index),
                    r.fileName = l(r),
                    r.length = parseInt(r.length),
                    r.selected = !0 === r.selected || "true" === r.selected,
                    r.completedLength = parseInt(r.completedLength),
                    r.completePercent = r.length > 0 ? r.completedLength / r.length * 100 : 0,
                    n += r.selected ? 1 : 0
                }
                e.selectedFileCount = n
            }
            if (e.files && 1 === e.files.length && e.files[0].uris && e.files[0].uris[0]) {
                for (var f = !0, g = e.files[0].uris[0].uri, i = 0; i < e.files[0].uris.length; i++) {
                    if (e.files[0].uris[i].uri !== g) {
                        f = !1;
                        break
                    }
                }
          ...
          , m = function(e, t, n) {
            if (!e)
                ...
                e;
            for (var i = p(t.bitfield, t.numPieces), r = s.countArray(i, !0), l = t.completePercent, c = 0; c < e.length; c++) {
                var d = e[c]
                  , u = d.uploadSpeed
                  , f = d.downloadSpeed
                  , g = p(d.bitfield, t.numPieces)
                  , m = s.countArray(g, !0);
                if (d.name = d.ip + ":" + d.port,
                d.completePercent = m / t.numPieces * 100,
                d.downloadSpeed = u,
                d.uploadSpeed = f,
                d.seeder = !0 === d.seeder || "true" === d.seeder,
                m === r && d.completePercent !== l && (d.completePercent = l),
                d.peerId) {
                    var h = s.decodePercentEncodedString(d.peerId)
                      , b = h ? a.parseClient(h) : null;
        ...
        return {
            ...
            restartTask: function(t, a, n) {
                ...
                return i.multicall({
                    ...
                    callback: function(e) {
                        ...
                        if (!e.success)
                            return o.warn("[aria2TaskService.restartTask] response is not success"),
                            s.reject(e),
                            void a(e);
                        ...
                        for (var l = c.files[0], u = [], p = 0; p < l.uris.length; p++) {
                            var f = l.uris[p];
                            u.push(f.uri)
                        }
                        i.addUri({
                            ...
                            callback: function(e) {
                                if (!e.success)
                                    return o.warn("[aria2TaskService.restartTask] addUri response is not success"),
                                    s.reject(e),
                                    void a(e);
                                r.getRemoveOldTaskAfterRestarting() && i.removeDownloadResult({
                                    gid: t,
                                    silent: !0,
                                    callback: function(e) {
                                        e.success || o.warn("[aria2TaskService.restartTask] removeDownloadResult response is not success")
                                    }
                                }),
                                s.resolve(e),
                                a(e)
            ...
            onTaskCompleted: function(e) {
                ...
                i.onDownloadComplete({
                    callback: h(this.getTaskStatus, e, "completed")
                })
            },
            onBtTaskCompleted: function(e) {
                ...
                i.onBtDownloadComplete({
                    callback: h(this.getTaskStatus, e, "btcompleted")
                })
            },
            onTaskErrorOccur: function(e) {
                ...
                i.onDownloadError({
                    callback: h(this.getTaskStatus, e, "error")
                })
            },
            ...
            estimateHealthPercentFromPeers: function(e, t) {
                if (!e || e.numPieces < 1 || t.length < 1)
                    return o.warn("[aria2TaskService.estimateHealthPercentFromPeers] tasks is null or numPieces < 1 or peers < 1"),
                    e.completePercent;
                for (var a = [], n = 0, i = e.completePercent, s = 0; s < e.numPieces; s++)
                    a.push(0);
                for (var s = 0; s < t.length; s++) {
                    for (var r = t[s], l = p(r.bitfield, e.numPieces), c = 0, d = 0; d < l.length; d++) {
                        var u = l[d] ? 1 : 0;
                        a[d] += u,
                        c += u
                    }
        ...
        return {
            ...
            getNewTaskOptionKeys: function() {
                for (var e = n.taskOptions, t = [], a = 0; a < e.length; a++) {
                    ...
                    i.canShow && i.canShow.indexOf("new") < 0 || (i.canUpdate && i.canUpdate.indexOf("new") < 0 && (s.readonly = !0),
                    t.push(s))
                }
                return t
            },
            getSpecifiedOptions: function(t, a) {
                ...
                for (var i = 0; i < t.length; i++) {
                    ...
                    if (c) {
                        ...
                        r && (c.readonly = !0),
                        a && a.disableRequired && (c.required = !1),
                        c.options) {
