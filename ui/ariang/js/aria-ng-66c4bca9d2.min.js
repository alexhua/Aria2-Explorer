...
!function() {
    "use strict";
    var e, t, a;
    if (e = navigator.appName,
    t = navigator.appVersion.split(";"),
    a = t && 1 < t.length ? t[1].replace(/[ ]/g, "") : "",
    "Microsoft Internet Explorer" === e && ("MSIE6.0" === a || "MSIE7.0" === a || "MSIE8.0" === a || "MSIE9.0" === a)) {
        var n = document.createElement("div");
        n.className = "alert alert-danger",
        n.innerHTML = "Sorry, AriaNg cannot support this browser, please upgrade your browser!",
...
function() {
    ...
    angular.module('ariaNg').config(['$compileProvider', function($compileProvider) {
        $compileProvider.aHrefSanitizationWhitelist(/^\s*(https?|ftp|chrome-extension|file):/);
    }
    ]);
}(),
function() {
...
function() {
    "use strict";
    angular.module("ariaNg").run(["$window", "$rootScope", "$location", "$document", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", function(e, n, s, r, t, a, i, o, l) {
        var c = function(e, t) {
        ...
        n.taskContext = {
            ...
            hasRetryableTask: function() {
                for (var e = 0; e < this.list.length; e++) {
                    var t = this.list[e];
                    if (n.filterTask(t) && n.isTaskRetryable(t))
                        return !0
                }
                return !1
            },
            hasCompletedTask: function() {
                for (var e = 0; e < this.list.length; e++) {
                    var t = this.list[e];
                    if (n.filterTask(t) && "complete" === t.status)
                        return !0
                }
                return !1
            },
            selectAll: function() {
                if (this.list && this.selected && !(this.list.length < 1) && this.enableSelectAll)
                    for (var e = this.isAllSelected(), t = 0; t < this.list.length; t++) {
                        var a = this.list[t];
            ...
            selectAllFailed: function() {
                if (this.list && this.selected && !(this.list.length < 1) && this.enableSelectAll) {
                    for (var e = !0, t = 0; t < this.list.length; t++) {
                        var a = this.list[t];
                        n.filterTask(a) && (n.isTaskRetryable(a) && (this.selected[a.gid] || (e = !1)))
                    }
                    for (t = 0; t < this.list.length; t++) {
                        a = this.list[t];
                        n.filterTask(a) && (n.isTaskRetryable(a) ? this.selected[a.gid] = !e : this.selected[a.gid] = !1)
                    }
                }
            },
            selectAllCompleted: function() {
                if (this.list && this.selected && !(this.list.length < 1) && this.enableSelectAll) {
                    for (var e = !0, t = 0; t < this.list.length; t++) {
                        var a = this.list[t];
                        n.filterTask(a) && ("complete" === a.status && (this.selected[a.gid] || (e = !1)))
                    }
                    for (t = 0; t < this.list.length; t++) {
                        a = this.list[t];
                        n.filterTask(a) && ("complete" === a.status ? this.selected[a.gid] = !e : this.selected[a.gid] = !1)
                    }
                }
            }
        },
        n.filterTask = function(e) {
            return !(!e || !angular.isString(e.taskName)) && (!n.searchContext || !n.searchContext.text || 0 <= e.taskName.toLowerCase().indexOf(n.searchContext.text.toLowerCase()))
        }
        ,
        n.isTaskRetryable = function(e) {
            return e && "error" === e.status && e.errorDescription && !e.bittorrent
        }
        ,
        n.swipeActions = {
            leftSwipe: function() {
                angular.element("body").hasClass("sidebar-open") ? d() : (!this.extentLeftSwipe || angular.isFunction(this.extentLeftSwipe) && !this.extentLeftSwipe()) && d()
            },
            rightSwipe: function() {
                (!this.extentRightSwipe || angular.isFunction(this.extentRightSwipe) && !this.extentRightSwipe()) && angular.element("body").removeClass("sidebar-collapse").addClass("sidebar-open")
            }
        },
        ...
        ,
        o.onApplicationCacheUpdated(function() {
            a.notifyInPage("", "Application cache has been updated, please reload the page for the changes to take effect.", {
                delay: !1,
                type: "info",
                templateUrl: "views/notification-reloadable.html"
            })
        }),
        o.onFirstAccess(function() {
            a.notifyInPage("", "Tap to configure and get started with AriaNg.", {
                delay: !1,
                onClose: function() {
        ...
        l.onFirstSuccess(function(e) {
            a.notifyInPage("", "is connected", {
                type: "success",
                contentPrefix: e.rpcName + " "
            })
        }),
        l.onConnectionSuccess(function() {
            "Connected" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Connected")
        }),
        l.onConnectionFailed(function() {
            "Disconnected" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Disconnected")
        }),
        l.onTaskCompleted(function(e) {
            a.notifyTaskComplete(e.task)
        }),
        l.onBtTaskCompleted(function(e) {
            a.notifyBtTaskComplete(e.task)
        }),
        l.onTaskErrorOccur(function(e) {
            a.notifyTaskError(e.task)
        }),
        n.$on("$locationChangeStart", function(e) {
            t.closeAllDialogs(),
            n.loadPromise = null,
            delete n.swipeActions.extentLeftSwipe,
            delete n.swipeActions.extentRightSwipe,
            angular.isArray(n.taskContext.list) && 0 < n.taskContext.list.length && (n.taskContext.list.length = 0),
            angular.isObject(n.taskContext.selected) && (n.taskContext.selected = {}),
        ...
        n.$on("$routeChangeStart", function(e, t, a) {
            ...
            angular.element("section.sidebar > ul > li[data-href-match]").each(function(e, t) {
                var a = angular.element(t).attr("data-href-match");
                c(a, n) && angular.element(t).addClass("active")
            }),
            angular.element("section.sidebar > ul > li.treeview > ul.treeview-menu > li[data-href-match]").each(function(e, t) {
                var a = angular.element(t).attr("data-href-match");
                c(a, n) && angular.element(t).addClass("active").parent().parent().addClass("active")
            }),
            r.unbind("keypress")
        }),
        function() {
            var e = o.getBrowserFeatures();
            if (e.localStroage || i.warn("[root.initCheck] LocalStorage is not supported!"),
            e.cookies || i.warn("[root.initCheck] Cookies is not supported!"),
            !o.isBrowserSupportStorage())
                throw angular.element("body").prepend('<div class="disable-overlay"></div>'),
                angular.element(".main-sidebar").addClass("blur"),
                angular.element(".navbar").addClass("blur"),
                angular.element(".content-body").addClass("blur"),
                a.notifyInPage("", "You cannot use AriaNg because this browser does not meet the minimum requirements for data storage.", {
                    type: "error",
                    delay: !1
                }),
                new Error("You cannot use AriaNg because this browser does not meet the minimum requirements for data storage.")
        }(),
...
function() {
    "use strict";
    angular.module("ariaNg").config(["$qProvider", "$translateProvider", "localStorageServiceProvider", "NotificationProvider", "ariaNgConstants", "ariaNgLanguages", function(e, t, a, n, i, s) {
        e.errorOnUnhandledRejections(!1),
        a.setPrefix(i.appPrefix).setStorageType("localStorage").setStorageCookie(365, "/");
        var r = []
          , o = {};
        for (var l in s)
            if (s.hasOwnProperty(l)) {
                var c = s[l].aliases;
                if (r.push(l),
                angular.isArray(c) && !(c.length < 1))
                    for (var d = 0; d < c.length; d++) {
                        o[c[d]] = l
                    }
            }
        t.useLoader("ariaNgLanguageLoader").useLoaderCache(!0).registerAvailableLanguageKeys(r, o).fallbackLanguage(i.defaultLanguage).useSanitizeValueStrategy("escapeParameters"),
        n.setOptions({
            delay: i.notificationInPageTimeout
        })
    }
    ])
}(),
function() {
    ...
    angular.module("ariaNg").constant("ariaNgFileTypes", {
        video: {
            name: "Videos",
            extensions: [".3g2", ".3gp", ".3gp2", ".3gpp", ".asf", ".asx", ".avi", ".dat", ".divx", ".flv", ".m1v", ".m2ts", ".m2v", ".m4v", ".mkv", ".mov", ".mp4", ".mpe", ".mpeg", ".mpg", ".mts", ".ogv", ".qt", ".ram", ".rm", ".rmvb", ".ts", ".vob", ".wmv"]
        },
        audio: {
            name: "Audios",
        ...
        picture: {
            name: "Pictures",
            extensions: [".abr", ".bmp", ".emf", ".gif", ".j2c", ".j2k", ".jfif", ".jif", ".jp2", ".jpc", ".jpe", ".jpeg", ".jpf", ".jpg", ".jpk", ".jpx", ".pcx", ".pct", ".pic", ".pict", ".png", ".pns", ".psd", ".psdx", ".raw", ".svg", ".svgz", ".tga", ".tif", ".tiff", ".wbm", ".wbmp", ".webp", ".wmf", ".xif"]
        },
        document: {
            name: "Documents",
            extensions: [".csv", ".doc", ".docm", ".docx", ".dot", ".dotm", ".dotx", ".key", ".mpp", ".numbers", ".odp", ".ods", ".odt", ".pages", ".pdf", ".pot", ".potm", ".potx", ".pps", ".ppsm", ".ppsx", ".ppt", ".pptm", ".pptx", ".rtf", ".txt", ".vsd", ".vsdx", ".wk1", ".wk2", ".wk3", ".wk4", ".wks", ".wpd", ".wps", ".xla", ".xlam", ".xll", ".xlm", ".xls", ".xlsb", ".xlsm", ".xlsx", ".xlt", ".xltx", ".xlw", ".xps"]
        },
        application: {
            name: "Applications",
        ...
        archive: {
            name: "Archives",
            extensions: [".001", ".7z", ".ace", ".arj", ".bz2", ".cab", ".cbr", ".cbz", ".gz", ".img", ".iso", ".lzh", ".qcow2", ".r", ".rar", ".sef", ".tar", ".taz", ".tbz", ".tbz2", ".uue", ".vdi", ".vhd", ".vmdk", ".wim", ".xar", ".xz", ".z", ".zip"]
        }
    })
}(),
function() {
    "use strict";
    angular.module("ariaNg").run(["moment", "ariaNgLocalizationService", "ariaNgSettingService", function(e, t, a) {
        var n = a.getLanguage();
...
function() {
    "use strict";
    angular.module("ariaNg").controller("CommandController", ["$rootScope", "$window", "$location", "$routeParams", "ariaNgDefaultOptions", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(s, r, o, e, l, c, d, u, p, f, g) {
        var t, a, n = o.path(), i = angular.extend({}, e, o.search());
        a = i,
        (0 === (t = n).indexOf("/new") ? function(e, t) {
            try {
                e = c.base64UrlDecode(e)
            } catch (e) {
                return d.showError("URL is not base64 encoded!"),
                !1
            }
            var a = {}
              , n = !1;
            if (t) {
                for (var i in t)
                    t.hasOwnProperty(i) && g.isOptionKeyValid(i) && (a[i] = t[i]);
                "true" === t.pause && (n = !0)
            }
            return s.loadPromise = f.newUriTask({
                urls: [e],
                options: a
            }, n, function(e) {
                if (!e.success)
                    return !1;
                n ? o.path("/waiting") : o.path("/downloading")
            }),
            u.info("[CommandController] new download: " + e),
            !0
        }(a.url, a) : 0 === t.indexOf("/settings/rpc/set") ? function(e, t, a, n, i) {
            if (a = a || l.rpcPort,
            n = n || l.rpcInterface,
            i = i || l.secret,
            u.info("[CommandController] set rpc: " + e + "://" + t + ":" + a + "/" + n + ", secret: " + i),
            !e || "http" !== e && "https" !== e && "ws" !== e && "wss" !== e)
                return d.showError("Protocol is invalid!"),
                !1;
            if (!t)
                return d.showError("RPC host cannot be empty!"),
                !1;
            if (i)
                try {
                    i = c.base64UrlDecode(i)
                } catch (e) {
                    return d.showError("RPC secret is not base64 encoded!"),
                    !1
                }
            var s = {
                rpcAlias: "",
            ...
            return p.isRpcSettingEqualsDefault(s) ? o.path("/downloading") : (p.setDefaultRpcSetting(s, {
                keepCurrent: !1,
                forceSet: !0
            }),
            o.path("/downloading"),
            r.location.reload()),
            !0
        }(a.protocol, a.host, a.port, a.interface, a.secret) : (d.showError("Parameter is invalid!"),
        0)) || o.path("/downloading")
    }
    ])
}(),
function() {
    "use strict";
    angular.module("ariaNg").controller("AriaNgDebugController", ["$rootScope", "$scope", "$location", "$timeout", "ariaNgConstants", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(e, t, a, n, i, s, r, o) {
        t.logMaxCount = i.cachedDebugLogsLimit,
        t.currentLog = null,
        t.enableDebugMode = function() {
            return o.isEnableDebugMode()
        }
        ,
        t.reloadLogs = function() {
            t.logs = r.getDebugLogs().slice()
        }
        ,
        ...
        e.loadPromise = n(function() {
            o.isEnableDebugMode() ? t.reloadLogs() : s.showError("Access Denied!", function() {
                o.isEnableDebugMode() || a.path("/settings/ariang")
            })
        }, 100)
    }
    ])
...
function() {
    ...
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$window", "$location", "$document", "$interval", "clipboard", "ariaNgBuildConfiguration", "aria2RpcErrors", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2TaskService", "aria2SettingService", function(i, s, r, t, o, e, a, n, l, c, d, u, p, f, g, m, h, v) {
        var b = null
          ...
          , w = function(e, t) {
            return v.getGlobalStat(function(e) {
                e.success || e.data.message !== c.Unauthorized.message ? (e.success && (s.globalStat = e.data,
                g.recordGlobalStat(e.data)),
                t && t(e)) : a.cancel(y)
            }, e)
        }
          , S = function() {
            if (!s.rpcSettings || s.rpcSettings.length < 1)
                return null;
        ...
        f.getBrowserNotification() && u.requestBrowserPermission(),
        s.ariaNgVersion = l.buildVersion,
        s.globalStatusContext = {
            isEnabled: 0 < f.getGlobalStatRefreshInterval(),
            data: g.getGlobalStatsData()
        },
        s.enableDebugMode = function() {
            return f.isEnableDebugMode()
        }
        ,
        s.quickSettingContext = null,
        s.rpcSettings = f.getAllRpcSettings(),
        s.isCurrentRpcUseWebSocket = f.isCurrentRpcUseWebSocket(),
        ...
        s.isSelectedTasksAllHaveInfoHash = function() {
            ...
            if (e.length < 1)
                return !1;
            for (var t = 0; t < e.length; t++)
                if (!e[t].bittorrent || !e[t].infoHash)
                    return !1;
            return !0
        }
        ,
        ...
        s.changeTasksState = function(t) {
            ...
            if (a && !(a.length < 1)) {
                ...
                i.loadPromise = e(a, function(e) {
                    e.hasError && 1 < a.length && p.showError("Failed to change some tasks state."),
                    e.hasSuccess && (w(!0),
                    e.hasError || "start" !== t ? e.hasError || "pause" !== t || ("/downloading" === o.path() ? o.path("/waiting") : r.reload()) : "/waiting" === o.path() ? o.path("/downloading") : r.reload())
                }, 1 < a.length)
            }
        }
        ,
        s.retryTask = function(e) {
            p.confirm("Confirm Retry", "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.", "info", function() {
                i.loadPromise = h.retryTask(e.gid, function(e) {
                    if (e.success) {
                        w(!0);
                        var t = f.getAfterRetryingTask();
                        e.success && e.data && ("task-list-downloading" === t ? "/downloading" !== o.path() ? o.path("/downloading") : r.reload() : "task-detail" === t ? o.path("/task/detail/" + e.data) : r.reload())
                    } else
                        p.showError("Failed to retry this task.")
                }, !1)
            })
        }
        ,
        ...
        s.retryTasks = function() {
            ...
            if (e && !(e.length < 1)) {
                if (1 === e.length)
                    return s.retryTask(e[0]);
                for (var t = [], a = 0, n = 0; n < e.length; n++)
                    i.isTaskRetryable(e[n]) ? t.push(e[n]) : a++;
                p.confirm("Confirm Retry", "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.", "info", function() {
                    i.loadPromise = h.retryTasks(t, function(t) {
                        w(!0),
                        p.showInfo("Operation Result", "{{successCount}} tasks have been retried and {{failedCount}} tasks are failed.", function() {
                            var e = f.getAfterRetryingTask();
                            t.hasSuccess && ("task-list-downloading" === e && "/downloading" !== o.path() ? o.path("/downloading") : r.reload())
                        }, {
                            textParams: {
        ...
        s.removeTasks = function() {
            ...
            if (t && !(t.length < 1)) {
                var e = function() {
                    i.loadPromise = h.removeTasks(t, function(e) {
                        e.hasError && 1 < t.length && p.showError("Failed to remove some task(s)."),
                        e.hasSuccess && (w(!0),
                        e.hasError || ("/stopped" !== o.path() ? o.path("/stopped") : r.reload()))
                    }, 1 < t.length)
                };
                f.getConfirmTaskRemoval() ? p.confirm("Confirm Remove", "Are you sure you want to remove the selected task?", "warning", e) : e()
            }
        }
        ,
        s.clearStoppedTasks = function() {
            p.confirm("Confirm Clear", "Are you sure you want to clear stopped tasks?", "warning", function() {
                i.loadPromise = h.clearStoppedTasks(function(e) {
                    e.success && (w(!0),
                    "/stopped" !== o.path() ? o.path("/stopped") : r.reload())
                })
            })
        }
        ,
        ...
        s.copySelectedTasksDownloadLink = function() {
            for (var e = i.taskContext.getSelectedTasks(), t = "", a = 0; a < e.length; a++)
                0 < a && (t += "\n"),
                t += e[a].singleUrl;
        ...
        s.switchRpcSetting = function(e) {
            e.isDefault || (f.setDefaultRpcSetting(e),
            t.location.reload())
        }
        ,
        0 < f.getTitleRefreshInterval() && (b = a(function() {
            k()
        }, f.getTitleRefreshInterval())),
        0 < f.getGlobalStatRefreshInterval() && (y = a(function() {
            w(!0)
        }, f.getGlobalStatRefreshInterval())),
...
function() {
    "use strict";
    angular.module("ariaNg").controller("NewTaskController", ["$rootScope", "$scope", "$location", "$timeout", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(l, c, d, e, u, t, a, n, p, f, i) {
        var s, r = ["links", "options"], o = d.search(), g = function(e) {
        ...
        if (c.context = {
            ...
            urls: "",
            uploadFile: null,
            availableOptions: (s = i.getNewTaskOptionKeys(),
            i.getSpecifiedOptions(s, {
                disableRequired: !0
            })),
            globalOptions: null,
            options: {},
        ...
        o.url)
            try {
                c.context.urls = u.base64UrlDecode(o.url)
                if (c.context.urls != null && c.context.urls.startsWith('http')) {
                    c.context.optionFilter['http'] = true;
                }
                if (o.referer) {
                    c.context.options["referer"] = o.referer;
                }
                if (o.header) {
                    c.context.options["header"] = o.header;
                }
            } catch (e) {
                a.error("[NewTaskController] base64 decode error, url=" + o.url, e)
            }
        c.changeTab = function(e) {
            "options" === e && c.loadDefaultOption(),
            c.context.currentTab = e
        }
        ,
        l.swipeActions.extentLeftSwipe = function() {
            var e = r.indexOf(c.context.currentTab);
            return e < r.length - 1 && (c.changeTab(r[e + 1]),
            !0)
        }
        ,
        l.swipeActions.extentRightSwipe = function() {
            var e = r.indexOf(c.context.currentTab);
            return 0 < e && (c.changeTab(r[e - 1]),
            !0)
        }
        ,
        c.loadDefaultOption = function() {
            c.context.globalOptions || (l.loadPromise = i.getGlobalOption(function(e) {
        ...
        c.startDownload = function(a) {
            var e, t, n, i, s, r, o = function(e) {
                if (e.hasSuccess || e.success) {
                    var t = null;
                    e.results && 0 < e.results.length ? t = e.results[0] : e && (t = e),
                    "task-detail" === p.getAfterCreatingNewTask() && t && t.data ? d.path("/task/detail/" + t.data) : a ? d.path("/waiting") : d.path("/downloading")
                }
            };
            "urls" === c.context.taskType ? l.loadPromise = function(e, t) {
                for (var a = u.parseUrlsFromOriginInput(c.context.urls), n = angular.copy(c.context.options), i = [], s = 0; s < a.length; s++)
                    "" !== a[s] && "" !== a[s].trim() && i.push({
                        urls: [a[s].trim()],
                        options: n
                    });
                return g(n),
                f.newUriTasks(i, e, t)
            }(a, o) : "torrent" === c.context.taskType ? l.loadPromise = (i = a,
            s = o,
            r = {
            ...
            g(r.options),
            f.newTorrentTask(r, i, s)) : "metalink" === c.context.taskType && (l.loadPromise = (e = a,
            t = o,
            n = {
                content: c.context.uploadFile.base64Content,
                options: angular.copy(c.context.options)
        ...
        c.urlTextboxKeyDown = function(e) {
            13 === e.keyCode && e.ctrlKey && c.newTaskForm.$valid && c.startDownload()
        }
        ,
...
function() {
    "use strict";
    angular.module("ariaNg").controller("DownloadListController", ["$rootScope", "$scope", "$window", "$location", "$route", "$interval", "dragulaService", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "aria2TaskService", function(r, e, t, a, n, o, i, l, c, s, d) {
        var u = a.path().substring(1)
          ...
          , m = function(e) {
            if (!f)
                return d.getTaskList(u, g, function(e) {
                    if (!f)
                        if (e.success) {
                            var t = e.context.requestWholeInfo
                              , a = e.data;
                            if (t)
                                r.taskContext.list = a,
                                g = !1;
                            else {
                                if (r.taskContext.list && 0 < r.taskContext.list.length)
                                    for (var n = 0; n < r.taskContext.list.length; n++) {
                                        delete (s = r.taskContext.list[n]).verifiedLength,
                                        delete s.verifyIntegrityPending
                                    }
                                g = !c.extendArray(a, r.taskContext.list, "gid")
                            }
                            if (r.taskContext.list && 0 < r.taskContext.list.length && (d.processDownloadTasks(r.taskContext.list),
                            !t)) {
                                var i = !1;
                                for (n = 0; n < r.taskContext.list.length; n++) {
                                    var s;
                                    if ((s = r.taskContext.list[n]).hasTaskName || s.files || s.bittorrent) {
                                        i = !0;
                                        break
                                    }
                                }
                                if (!i)
                                    return g = !0,
                                    void (r.taskContext.list.length = 0)
                            }
                            r.taskContext.enableSelectAll = r.taskContext.list && 0 < r.taskContext.list.length
                        } else
                            e.data.message === l.Unauthorized.message && o.cancel(p)
                }, e)
        };
        ...
        ,
        0 < s.getDownloadTaskRefreshInterval() && (p = o(function() {
            m(!0)
...
function() {
    "use strict";
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "clipboard", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService", function(i, f, e, t, n, a, g, m, s, r, o, l) {
        var c = ["overview", "pieces", "filelist", "btpeers"]
          , d = null
          , u = !1
          , p = null
          , h = function(e) {
            var t, a, n;
            e && ("active" === e.status && e.bittorrent || 0 <= c.indexOf("btpeers") && c.splice(c.indexOf("btpeers"), 1),
            f.task && f.task.status === e.status || (f.context.availableOptions = (t = e.status,
            a = !!e.bittorrent,
            n = l.getAvailableTaskOptionKeys(t, a),
            l.getSpecifiedOptions(n, {
                disableRequired: !0
            }))),
            f.task && (delete f.task.verifiedLength,
            delete f.task.verifyIntegrityPending),
            f.task = m.copyObjectTo(e, f.task),
            i.taskContext.list = [f.task],
            i.taskContext.selected = {},
            i.taskContext.selected[f.task.gid] = !0,
            r.recordStat(e.gid, e))
        }
          , v = function(e) {
            e && (m.extendArray(e, f.context.btPeers, "peerId") || (f.context.btPeers = e),
            f.context.healthPercent = o.estimateHealthPercentFromPeers(f.task, f.context.btPeers))
        }
          , b = function(e) {
          ...
          , y = function(a) {
            if (!u) {
                ...
                return f.task ? o.getTaskStatusAndBtPeers(e.gid, function(e) {
                    if (!e.success)
                        return n(e.data.message);
                    h(e.task),
                    v(e.peers)
                }, a, b(f.task), !0, !0) : o.getTaskStatus(e.gid, function(e) {
                    if (!e.success)
                        return n(e.data.message);
                    var t = e.data;
                    h(t),
                    b(t) && o.getBtTaskPeers(t, function(e) {
                        e.success && v(e.data)
                    }, a, !0)
                }, a, !0)
            }
          ...
          , k = function(e) {
            if (f.task && f.task.files) {
                for (var t = f.task.gid, a = [], n = 0; n < f.task.files.length; n++) {
                    var i = f.task.files[n];
                    i && i.selected && !i.isDir && a.push(i.index)
                }
                return u = !0,
                o.selectTaskFile(t, a, function(e) {
                    u = !1,
                    e.success && y(!1)
                }, e)
            }
          ...
          , S = function(e) {
            if (e) {
                ...
                e.partialSelected = 0 < t && t < e.subDirs.length + e.files.length || 0 < a
            }
        }
          , x = function() {
            if (f.task && f.task.multiDir)
                for (var e = 0; e < f.task.files.length; e++) {
                    var t = f.task.files[e];
                    t.isDir && S(t)
                }
        };
        f.context = {
            currentTab: "overview",
            isEnableSpeedChart: 0 < s.getDownloadTaskRefreshInterval(),
            ...
            healthPercent: 0,
            collapseTrackers: !0,
            statusData: r.getEmptyStatsData(e.gid),
            availableOptions: [],
            options: []
        },
        f.changeTab = function(e) {
            "settings" === e && f.loadTaskOption(f.task),
            f.context.currentTab = e
        }
        ,
        i.swipeActions.extentLeftSwipe = function() {
            var e = c.indexOf(f.context.currentTab);
            return e < c.length - 1 && (f.changeTab(c[e + 1]),
            !0)
        }
        ,
        i.swipeActions.extentRightSwipe = function() {
            var e = c.indexOf(f.context.currentTab);
            return 0 < e && (f.changeTab(c[e - 1]),
            !0)
        }
        ,
        f.changeFileListDisplayOrder = function(e, t) {
            if (!f.task || !f.task.multiDir) {
                var a = m.parseOrderType(s.getFileListDisplayOrder())
                  , n = m.parseOrderType(e);
                t && n.type === a.type && (n.reverse = !a.reverse),
                s.setFileListDisplayOrder(n.getValue())
            }
        }
        ,
        f.isSetFileListDisplayOrder = function(e) {
            var t = m.parseOrderType(s.getFileListDisplayOrder())
              , a = m.parseOrderType(e);
            return t.equals(a)
        }
        ,
        f.getFileListOrderType = function() {
            return f.task && f.task.multiDir ? null : s.getFileListDisplayOrder()
        }
        ,
        f.showChooseFilesToolbar = function() {
            f.context.showChooseFilesToolbar ? f.cancelChooseFiles() : (u = !0,
            f.context.showChooseFilesToolbar = !0)
        }
        ,
        f.isAnyFileSelected = function() {
            if (!f.task || !f.task.files)
                return !1;
            for (var e = 0; e < f.task.files.length; e++) {
                var t = f.task.files[e];
        ...
        ,
        f.selectFiles = function(e) {
            if (f.task && f.task.files) {
                "auto" === e && (e = f.isAllFileSelected() ? "none" : "all");
                for (var t = 0; t < f.task.files.length; t++) {
                    var a = f.task.files[t];
                    a.isDir || ("all" === e ? a.selected = !0 : "none" === e ? a.selected = !1 : "reverse" === e && (a.selected = !a.selected))
                }
                x()
            }
        }
        ,
        f.chooseSpecifiedFiles = function(e) {
            if (f.task && f.task.files && g[e]) {
                for (var t = f.task.files, a = g[e].extensions, n = [], i = !0, s = 0; s < t.length; s++) {
                    if (!(o = t[s]).isDir) {
                        var r = m.getFileExtension(o.fileName);
                        r && (r = r.toLowerCase()),
                        0 <= a.indexOf(r) && (n.push(s),
                        o.selected || (i = !1))
                    }
                }
                for (s = 0; s < n.length; s++) {
                    var o;
                    (o = t[n[s]]) && !o.isDir && (o.selected = !i)
                }
                x()
            }
        }
        ,
        f.saveChoosedFiles = function() {
            f.context.showChooseFilesToolbar && (i.loadPromise = k(!1),
            f.context.showChooseFilesToolbar = !1)
        }
        ,
        f.cancelChooseFiles = function() {
            f.context.showChooseFilesToolbar && (y(!(u = !1)),
            f.context.showChooseFilesToolbar = !1)
        }
        ,
        f.showCustomChooseFileModal = function() {
            if (f.task && f.task.files) {
                for (var e = f.task.files, t = {}, a = 0; a < e.length; a++) {
                    var n = e[a];
                    if (!n.isDir) {
                        if ((u = m.getFileExtension(n.fileName)) && (u = u.toLowerCase()),
                        !(p = t[u])) {
                            var i = u;
                        ...
                        n.selected ? (p.selected = !0,
                        p.selectedCount++) : p.unSelectedCount++
                    }
                }
                var s = {};
                for (var r in g)
                ...
                for (var u in t) {
                    ...
                    if (t.hasOwnProperty(u))
                        (p = t[u]).classified || d.push(p)
                }
                0 < d.length && (s.other = {
                    name: "Other",
                    extensions: d
                }),
                f.context.fileExtensions = s,
                angular.element("#custom-choose-file-modal").modal()
            }
        }
        ,
        f.setSelectedExtension = function(e, t) {
            if (f.task && f.task.files) {
                for (var a = f.task.files, n = 0; n < a.length; n++) {
                    var i = a[n];
                    if (!i.isDir) {
        ...
        $("#custom-choose-file-modal").on("hide.bs.modal", function(e) {
            f.context.fileExtensions = null
        }),
        f.setSelectedFile = function(e) {
            e && x(),
            f.context.showChooseFilesToolbar || k(!0)
        }
        ,
        f.collapseDir = function(e, t, a) {
            var n = e.nodePath;
            if (angular.isUndefined(t) && (t = !f.context.collapsedDirs[n]),
            t || a)
                for (var i = 0; i < e.subDirs.length; i++)
                    f.collapseDir(e.subDirs[i], t);
            n && (f.context.collapsedDirs[n] = t)
        }
        ,
        f.collapseAllDirs = function(e) {
            if (f.task && f.task.files)
                for (var t = 0; t < f.task.files.length; t++) {
                    var a = f.task.files[t];
                    a.isDir && f.collapseDir(a, e, !0)
                }
        }
        ,
        f.setSelectedNode = function(e) {
            w(e, e.selected),
            x(),
            f.context.showChooseFilesToolbar || f.setSelectedFile(!1)
        }
        ,
        f.changePeerListDisplayOrder = function(e, t) {
            var a = m.parseOrderType(s.getPeerListDisplayOrder())
              , n = m.parseOrderType(e);
            t && n.type === a.type && (n.reverse = !a.reverse),
            s.setPeerListDisplayOrder(n.getValue())
        }
        ,
        f.isSetPeerListDisplayOrder = function(e) {
            var t = m.parseOrderType(s.getPeerListDisplayOrder())
              , a = m.parseOrderType(e);
            return t.equals(a)
        }
        ,
        f.getPeerListOrderType = function() {
            return s.getPeerListDisplayOrder()
        }
        ,
        f.loadTaskOption = function(e) {
            i.loadPromise = o.getTaskOptions(e.gid, function(e) {
                e.success && (f.context.options = e.data)
            })
        }
        ,
        f.setOption = function(e, t, a) {
            return o.setTaskOption(f.task.gid, e, t, function(e) {
                e.success && "OK" === e.data ? a.setSuccess() : a.setFailed(e.data.message)
            }, !0)
        }
        ,
        f.copySelectedRowText = function() {
            if (p) {
                var e = p.find(".setting-key > span").text().trim()
                  , a = "";
                if (p.find(".setting-value > span").each(function(e, t) {
                    0 < e && (a += "\n"),
                    a += angular.element(t).text().trim()
                }),
                s.getIncludePrefixWhenCopyingFromTaskDetails()) {
                    var t = e + ": " + a;
                    n.copyText(t)
                } else
                    n.copyText(a)
        ...
        ,
        0 < s.getDownloadTaskRefreshInterval() && (d = t(function() {
            !f.task || "complete" !== f.task.status && "error" !== f.task.status && "removed" !== f.task.status ? y(!0) : t.cancel(d)
        }, s.getDownloadTaskRefreshInterval())),
        f.$on("$destroy", function() {
            d && t.cancel(d)
        }),
        f.onOverviewMouseDown = function() {
...
function() {
    ...
    angular.module("ariaNg").controller("AriaNgSettingsController", ["$rootScope", "$scope", "$routeParams", "$window", "$interval", "$timeout", "$filter", "clipboard", "ariaNgBuildConfiguration", "ariaNgLanguages", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2SettingService", function(e, n, t, a, i, s, r, o, l, c, d, u, p, f, g, m, h, v, b) {
        var y = t.extendType
          ...
          , S = function() {
            if (!n.context || !n.context.rpcSettings || n.context.rpcSettings.length < 1)
                return null;
          ...
          , x = function() {
            k || (k = p.notifyInPage("", "Configuration has been modified, please reload the page for the changes to take effect.", {
                delay: !1,
                type: "info",
                templateUrl: "views/notification-reloadable.html",
                onClose: function() {
        ...
        n.context = {
            ...
            languages: c,
            titlePreview: w(),
            availableTime: d.getTimeOptions([1e3, 2e3, 3e3, 5e3, 1e4, 3e4, 6e4], !0),
            trueFalseOptions: [{
                name: "Enabled",
                value: !0
            }, {
            ...
            isSupportBlob: g.isSupportBlob(),
            importSettings: null,
            exportSettings: null,
            exportSettingsCopied: !1
        },
        n.context.titlePreview = w(),
        n.context.showDebugMode = n.context.sessionSettings.debugMode || "debug" === y,
        ...
        n.getCurrentRpcTabIndex = function() {
            return n.isCurrentGlobalTab() ? -1 : parseInt(n.context.currentTab.substring(3))
        }
        ,
        ...
        e.swipeActions.extentLeftSwipe = function() {
            var e = -1;
            return n.isCurrentGlobalTab() || (e = parseInt(n.getCurrentRpcTabIndex())),
            e < n.context.rpcSettings.length - 1 && (n.changeRpcTab(e + 1),
            !0)
        }
        ,
        e.swipeActions.extentRightSwipe = function() {
            var e = -1;
            return n.isCurrentGlobalTab() || (e = parseInt(n.getCurrentRpcTabIndex())),
            0 < e ? (n.changeRpcTab(e - 1),
            !0) : 0 === e && (n.changeGlobalTab(),
            !0)
        }
        ,
        n.isSupportNotification = function() {
            return u.isSupportBrowserNotification() && m.isCurrentRpcUseWebSocket(n.context.settings.protocol)
        }
        ,
        n.setLanguage = function(e) {
            m.setLanguage(e) && p.applyLanguage(e),
            n.updateTitlePreview()
        }
        ,
        ...
        n.setEnableBrowserNotification = function(e) {
            ...
            e && !u.hasBrowserPermission() && u.requestBrowserPermission(function(e) {
                e.granted || (n.context.settings.browserNotification = !1,
                p.showError("You have disabled notification in your browser. You should change your browser's settings before you enable this function."))
            })
        }
        ,
        n.setTitleRefreshInterval = function(e) {
            x(),
            m.setTitleRefreshInterval(e)
        }
        ,
        n.setGlobalStatRefreshInterval = function(e) {
            x(),
            m.setGlobalStatRefreshInterval(e)
        }
        ,
        n.setDownloadTaskRefreshInterval = function(e) {
            x(),
            m.setDownloadTaskRefreshInterval(e)
        }
        ,
        n.setRPCListDisplayOrder = function(e) {
            x(),
            m.setRPCListDisplayOrder(e)
        }
        ,
        ...
        n.importSettings = function(e) {
            ...
            try {
                ...
                return f.error("[AriaNgSettingsController.importSettings] parse settings json error", e),
                void p.showError("Invalid settings data format!")
            }
            if (!angular.isObject(t) || angular.isArray(t))
                return f.error("[AriaNgSettingsController.importSettings] settings json is not object"),
                void p.showError("Invalid settings data format!");
            t && p.confirm("Confirm Import", "Are you sure you want to import all settings?", "warning", function() {
                m.importAllOptions(t),
                a.location.reload()
            })
        }
        ,
        n.showExportSettingsModal = function() {
            n.context.exportSettings = r("json")(m.exportAllOptions()),
        ...
        n.copyExportSettings = function() {
            o.copyText(n.context.exportSettings, {
        ...
        n.updateRpcSetting = function(e, t) {
            x(),
            m.updateRpcSetting(e, t)
        }
        ,
        n.removeRpcSetting = function(a) {
            var e = a.rpcAlias ? a.rpcAlias : a.rpcHost + ":" + a.rpcPort;
            p.confirm("Confirm Remove", 'Are you sure you want to remove rpc setting "{{rpcName}}"?', "warning", function() {
                x();
                var e = n.getCurrentRpcTabIndex()
                  , t = n.context.rpcSettings.indexOf(a);
                m.removeRpcSetting(a),
                n.context.rpcSettings.splice(t, 1),
                e >= n.context.rpcSettings.length ? n.changeRpcTab(n.context.rpcSettings.length - 1) : e <= 0 || e <= t || n.changeRpcTab(e - 1)
            }, !1, {
                textParams: {
                    rpcName: e
                }
        ...
        n.setDefaultRpcSetting = function(e) {
            e.isDefault || (m.setDefaultRpcSetting(e),
            a.location.reload())
        }
        ,
        n.resetSettings = function() {
            p.confirm("Confirm Reset", "Are you sure you want to reset all settings?", "warning", function() {
                m.resetSettings(),
                a.location.reload()
            })
        }
        ...
        n.clearHistory = function() {
            p.confirm("Confirm Clear", "Are you sure you want to clear all settings history?", "warning", function() {
                b.clearSettingsHistorys(),
                a.location.reload()
            })
        }
        ,
...
function() {
    "use strict";
    angular.module("ariaNg").controller("Aria2SettingsController", ["$rootScope", "$scope", "$location", "ariaNgConstants", "ariaNgLocalizationService", "aria2SettingService", function(e, t, a, n, i, s) {
        var r = a.path().substring(a.path().lastIndexOf("/") + 1);
        t.context = {
            availableOptions: function(e) {
                var t = s.getAvailableGlobalOptionsKeys(e);
                if (t)
                    return s.getSpecifiedOptions(t);
...
function() {
    "use strict";
    angular.module("ariaNg").controller("Aria2StatusController", ["$rootScope", "$scope", "ariaNgLocalizationService", "ariaNgSettingService", "aria2SettingService", function(e, t, a, n, i) {
        t.context = {
        ...
        e.loadPromise = i.getAria2Status(function(e) {
            e.success ? (t.context.status = "Connected",
            t.context.serverStatus = e.data) : t.context.status = "Disconnected"
        })
    }
    ])
}(),
function() {
    "use strict";
    angular.module("ariaNg").directive("ngAutoFocus", ["$timeout", function(a) {
        return {
            restrict: "A",
            link: function(e, t) {
                a(function() {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngPieceBar", ["aria2TaskService", function(u) {
        return {
            restrict: "E",
            ...
            link: function(c, d) {
                var e = function() {
                    ...
                    for (var n = 0, i = e.width, s = e.height, r = 0; r < t.length; r++) {
                        var o = t[r]
                          , l = o.count / c.pieceCount * i;
                        o.isCompleted && a.fillRect(n, 0, l, s),
                        n += l
                    }
                };
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngPieceMap", ["aria2TaskService", function(o) {
        return {
            restrict: "E",
            ...
            link: function(n, i) {
                var s = []
                  , r = []
                  , a = function() {
                    r = o.getPieceStatus(n.bitField, n.pieceCount),
                    s.length = 0,
                    i.empty();
                    for (var e = Math.max(1, r.length), t = 0; t < e; t++) {
                        var a = angular.element('<div class="piece' + (r[t] ? " piece-completed" : "") + '"></div>');
                        s.push(a),
                        i.append(a)
                    }
                };
                n.$watch("bitField", function() {
                    !function() {
                        var e = o.getPieceStatus(n.bitField, n.pieceCount);
                        if (r && e && r.length === e.length && e.length === s.length) {
                            for (var t = 0; t < s.length; t++)
                                r[t] !== e[t] && (e[t] ? s[t].addClass("piece-completed") : s[t].removeClass("piece-completed"));
                            r = e
                        } else
                            a()
                    }()
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngChart", ["$window", "chartTheme", function(l, c) {
        return {
            restrict: "E",
            template: "<div></div>",
            scope: {
            ...
            link: function(e, t, a) {
                ...
                var i = t.find("div")
                  , s = t.parent().height()
                  , r = parseInt(a.height) || s || 200;
                i.css("height", r + "px");
                var o = echarts.init(i[0], c.get(n.ngTheme));
    ...
    ]).directive("ngPopChart", ["$window", "chartTheme", function(e, r) {
        return {
            restrict: "A",
            scope: {
                options: "=ngData"
            ...
            link: function(e, t, n) {
                ...
                angular.extend(i, n);
                var s = null
                  , a = '<div class="loading"><i class="fa fa-spinner fa-spin fa-2x"></i></div>';
                t.popover({
                    container: i.ngContainer,
                    content: '<div class="chart-pop-wrapper"><div class="chart-pop ' + i.ngPopoverClass + '">' + a + "</div></div>",
                    html: !0,
                    ...
                    var e = angular.element(".chart-pop")
                      , t = e.parent().height();
                    e.empty();
                    var a = parseInt(n.height) || t || 200;
                    e.css("height", a + "px"),
                    s = echarts.init(e[0], r.get(i.ngTheme))
        ...
        return {
            ...
            link: function(e, t) {
                e.$watch("indeterminate", function() {
                    t[0].indeterminate = "true" === e.indeterminate || !0 === e.indeterminate
                })
            }
        }
    })
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngSetting", ["$timeout", "$q", "ariaNgConstants", "ariaNgLocalizationService", "aria2SettingService", function(u, p, f, g, m) {
        return {
            restrict: "E",
            ...
            link: function(s, i, e, t) {
                var r = null
                  , o = {
                    lazySaveTimeout: f.lazySaveTimeout,
                    errorTooltipDelay: f.errorTooltipDelay
                };
                angular.extend(o, e);
                var a, n = function() {
                    s.option && s.option.showHistory && (s.history = m.getSettingHistory(s.option.key))
                }, l = function() {
                    ...
                    t && u(function() {
                        ...
                        "failed" !== e && "error" !== e || angular.element(i).tooltip({
                            title: g.getLocalizedText(t, n),
                            trigger: "focus",
                            placement: "auto top",
                            container: i,
                            template: '<div class="tooltip' + (a ? " tooltip-" + a : "") + '" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>'
                        }).tooltip("show")
                    }, o.errorTooltipDelay)
                }, d = function(e) {
                    return "Bytes" === s.option.suffix ? function(e) {
                ...
                s.optionStatus = (a = "ready",
                {
                    ...
                    getStatusFeedbackStyle: function() {
                        return "success" === a ? "has-success" : "failed" === a ? "has-warning" : "error" === a ? "has-error" : ""
                    },
                    getStatusIcon: function() {
                        return "pending" === a ? "fa-hourglass-start" : "saving" === a ? "fa-spin fa-pulse fa-spinner" : "success" === a ? "fa-check" : "failed" === a ? "fa-exclamation" : "error" === a ? "fa-times" : ""
                    },
                ...
                s.getTotalCount = function() {
                    return s.optionValue || angular.isString(s.optionValue) ? s.optionValue.split(s.option.split).length : 0
                }
                ,
                s.changeValue = function(e, t) {
                    ...
                    s.option && s.option.key && !s.option.readonly)
                        ...
                        else if ("" === e || "integer" !== s.option.type || /^-?\d+$/.test(e))
                            if ("" === e || "float" !== s.option.type || /^-?(\d*\.)?\d+$/.test(e)) {
                                if ("" !== e && ("integer" === s.option.type || "float" === s.option.type) && (angular.isDefined(s.option.min) || angular.isDefined(s.option.max))) {
                                    var a = e;
                                    if ("integer" === s.option.type ? a = parseInt(e) : "float" === s.option.type && (a = parseFloat(e)),
                                    angular.isDefined(s.option.min) && a < s.option.min)
                                        return void s.optionStatus.setError("Input number is below min value!", {
                                            value: s.option.min
                                        });
                                    if (angular.isDefined(s.option.max) && a > s.option.max)
                                        return void s.optionStatus.setError("Input number is above max value!", {
                                            value: s.option.max
                                        })
                                }
                                if ("" === e || !angular.isDefined(s.option.pattern) || new RegExp(s.option.pattern).test(e)) {
                                    var n = {
                                        key: s.option.key,
                                        value: e,
                                      ...
                                      , i = function() {
                                        s.optionStatus.setSaving(),
                                        s.onChangeValue(n)
                                    };
                                    s.onChangeValue && (t ? (s.optionStatus.setPending(),
                                    r = u(function() {
                                        i()
                                    }, o.lazySaveTimeout)) : i())
                                } else
                                    s.optionStatus.setError("Input value is invalid!")
                            } else
                                s.optionStatus.setError("Input number is invalid!");
                        else
                            s.optionStatus.setError("Input number is invalid!")
                }
                ,
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngSettingDialog", ["ariaNgLocalizationService", "aria2SettingService", function(i, s) {
        return {
            restrict: "E",
            ...
            link: function(n, e, t) {
                ...
                n.$watch("setting", function(e) {
                    var t, a;
                    e && (t = e.type,
                    (a = s.getAria2QuickSettingsAvailableOptions(t)) ? n.context.availableOptions = s.getSpecifiedOptions(a) : i.showError("Type is illegal!"),
        ...
        return {
            ...
            link: function(e, t, a) {
                ...
                e.$watch("title", function() {
                    i && angular.element(t).attr("title", e.title).tooltip("fixTitle")
                }),
                e.$watch("ngTooltipIf", function(e) {
                    angular.isUndefined(e) || i !== (e = !0 === e || "true" === e) && (e ? s() : angular.element(t).tooltip("destroy"),
                    i = e)
                })
            }
        }
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngValidUrls", ["ariaNgCommonService", function(i) {
        return {
            restrict: "A",
            require: "?ngModel",
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngBlobDownload", ["ariaNgFileService", function(n) {
        return {
            restrict: "A",
            scope: {
...
function() {
    "use strict";
    angular.module("ariaNg").filter("dateDuration", ["moment", function(i) {
...
function() {
    "use strict";
    angular.module("ariaNg").filter("fileOrderBy", ["$filter", "ariaNgCommonService", function(n, i) {
        return function(e, t) {
            if (!angular.isArray(e) || !t)
                return e;
            var a = i.parseOrderType(t);
            return null === a ? e : "index" === a.type ? n("orderBy")(e, ["index"], a.reverse) : "name" === a.type ? n("orderBy")(e, ["fileName"], a.reverse) : "size" === a.type ? n("orderBy")(e, ["length"], a.reverse) : "percent" === a.type ? n("orderBy")(e, ["completePercent"], a.reverse) : "selected" === a.type ? n("orderBy")(e, ["selected"], a.reverse) : e
        }
    }
    ])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("longDate", ["ariaNgCommonService", "ariaNgLocalizationService", function(a, n) {
        return function(e) {
...
function() {
    "use strict";
    angular.module("ariaNg").filter("peerOrderBy", ["$filter", "ariaNgCommonService", function(n, i) {
        return function(e, t) {
            if (!angular.isArray(e))
                return e;
            var a = i.parseOrderType(t);
            return null === a ? e : "address" === a.type ? n("orderBy")(e, ["ip", "port"], a.reverse) : "client" === a.type ? n("orderBy")(e, ["client.name", "client.version"], a.reverse) : "percent" === a.type ? n("orderBy")(e, ["completePercent"], a.reverse) : "dspeed" === a.type ? n("orderBy")(e, ["downloadSpeed"], a.reverse) : "uspeed" === a.type ? n("orderBy")(e, ["uploadSpeed"], a.reverse) : e
        }
    }
    ])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("percent", ["$filter", function(i) {
        return function(e, t) {
            var a = Math.pow(10, t)
              , n = parseInt(e * a) / a;
            return i("number")(n, t)
...
function() {
    "use strict";
    angular.module("ariaNg").filter("taskOrderBy", ["$filter", "ariaNgCommonService", function(n, i) {
        return function(e, t) {
            if (!angular.isArray(e))
                return e;
            var a = i.parseOrderType(t);
            return null === a ? e : "name" === a.type ? n("orderBy")(e, ["taskName"], a.reverse) : "size" === a.type ? n("orderBy")(e, ["totalLength"], a.reverse) : "percent" === a.type ? n("orderBy")(e, ["completePercent"], a.reverse) : "remain" === a.type ? n("orderBy")(e, ["idle", "remainTime", "remainLength"], a.reverse) : "dspeed" === a.type ? n("orderBy")(e, ["downloadSpeed"], a.reverse) : "uspeed" === a.type ? n("orderBy")(e, ["uploadSpeed"], a.reverse) : e
        }
    }
    ])
}(),
function() {
    ...
    angular.module("ariaNg").filter("taskStatus", function() {
        return function(e, t) {
            return e ? "active" === e.status ? e.verifyIntegrityPending ? "Pending Verification" : e.verifiedLength ? e.verifiedPercent ? "format.task.verifying-percent" : "Verifying" : !0 === e.seeder || "true" === e.seeder ? "Seeding" : "Downloading" : "waiting" === e.status ? "Waiting" : "paused" === e.status ? "Paused" : t || "complete" !== e.status ? t || "error" !== e.status ? t || "removed" !== e.status ? "" : "Removed" : e.errorCode ? "format.task.error-occurred" : "Error Occurred" : "Completed" : ""
        }
    })
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("readableVolume", ["$filter", function(o) {
        var l = ["B", "KB", "MB", "GB"];
        return function(e, t) {
            var a, n = l[0], i = 2, s = !1;
            ...
            for (var r = 1; r < l.length && 1024 <= e; r++)
                e /= 1024,
                n = l[r];
            return s && (i = (a = e) < 1 ? 2 : a < 10 ? 1 : 0),
            (e = o("number")(e, i)) + " " + n
        }
    }
    ])
        ...
        this.setLanguageAsset = function(e, t) {
            !function(e, t) {
                for (var a = e.split("."), n = s, i = 0; i < a.length - 1; i++)
                    angular.isUndefined(n[a[i]]) && (n[a[i]] = {}),
                    n = n[a[i]];
                n[a[a.length - 1]] = t
            }(a + e, t)
        }
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLanguageLoader", ["$http", "$q", "ariaNgConstants", "ariaNgLanguages", "ariaNgAssetsCacheService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgStorageService", function(r, o, l, c, d, u, p, f, g) {
        var m = function(e) {
            for (var t = 0; t < e.length; t++)
            ...
            for (var a = e.split("\n"), n = t, i = 0; i < a.length; i++) {
                ...
                if (s)
                    ...
                    /^\[.+\]$/.test(s))
                        ...
                        var r = m(s);
                        r && r.key && (n[r.key] = r.value)
                    }
            }
            return t
        }
          , b = function(e, t) {
            if (!angular.isObject(e) || !angular.isObject(t))
                return !1;
            for (var a in t)
        ...
        return function(t) {
            var n = o.defer();
            if (!c[t.key])
                return n.reject(t.key),
                n.promise;
            var i = l.languageStorageKeyPrefix + "." + t.key
              , s = g.get(i);
            if (s && n.resolve(s),
            d.getLanguageAsset(t.key)) {
            ...
            return r({
                ...
                return s && (a = !b(s, t)),
                g.set(i, t),
                a ? (f.info("[ariaNgLanguageLoader] load language resource successfully, and resource is updated"),
                p.notifyInPage("", "Language resource has been updated, please reload the page for the changes to take effect.", {
                    delay: !1,
                    type: "info",
                    templateUrl: "views/notification-reloadable.html"
                })) : f.info("[ariaNgLanguageLoader] load language resource successfully, but resource is not updated"),
                n.resolve(t)
            }).catch(function(e) {
                return f.warn("[ariaNgLanguageLoader] cannot get language resource"),
                s || u.notifyInPage("", "AriaNg cannot get language resources, and will display in default language.", {
                    type: "error",
                    delay: !1
                }),
                n.reject(t.key)
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgCommonService", ["$location", "$timeout", "base64", "moment", "SweetAlert", "ariaNgConstants", function(e, s, t, a, o, n) {
        return {
            ...
            generateUniqueId: function() {
                var e = n.appPrefix + "_" + Math.round((new Date).getTime() / 1e3) + "_" + Math.random();
            ...
            parseUrlsFromOriginInput: function(e) {
                ...
                for (var t = e.split("\n"), a = [], n = 0; n < t.length; n++) {
                    var i = t[n];
                    i.match(/^(http|https|ftp|sftp):\/\/.+$/) ? a.push(i) : i.match(/^magnet:\?.+$/) && a.push(i)
                }
                return a
            },
            ...
            getTimeOptions: function(e, t) {
                ...
                for (var n = 0; n < e.length; n++) {
                    var i = e[n]
                      , s = ""
                      , r = i;
                    s = i < 1e3 ? 1 === (r = i) ? "format.time.millisecond" : "format.time.milliseconds" : i < 6e4 ? 1 === (r = i / 1e3) ? "format.time.second" : "format.time.seconds" : i < 144e4 ? 1 === (r = i / 1e3 / 60) ? "format.time.minute" : "format.time.minutes" : 1 === (r = i / 1e3 / 60 / 24) ? "format.time.hour" : "format.time.hours",
                    a.push({
                        name: s,
                        value: r,
                        optionValue: i
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgNotificationService", ["$window", "Notification", "ariaNgSettingService", function(s, n, r) {
        var o = !!s.Notification
          , l = function(e) {
            return "granted" === e
        }
          , c = function() {
        ...
        return {
            ...
            requestBrowserPermission: function(t) {
                var a;
                o && (a = function(e) {
                    e.granted || r.setBrowserNotification(!1),
                    t && t(e)
                }
                ,
                s.Notification && s.Notification.requestPermission(function(e) {
                    a && a({
                        granted: l(e),
                        permission: e
                    })
            ...
            notifyViaBrowser: function(e, t, a) {
                ...
                a || (a = {}),
                a.message = t,
                o && r.getBrowserNotification() && (n = e,
                i = a,
                s.Notification && l(c()) && (i = angular.extend({
                    type: "basic",
                    iconUrl: "tileicon.png",
                    title:n
                }, i),
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLocalizationService", ["$translate", "amMoment", "ariaNgCommonService", "ariaNgNotificationService", function(a, t, r, n) {
        return {
            ...
            confirm: function(e, t, a, n, i, s) {
                ...
                r.confirm(e, t, a, n, i, s)
            },
            notifyViaBrowser: function(e, t, a) {
                return e && (e = this.getLocalizedText(e)),
            ...
            notifyInPage: function(e, t, a) {
                ...
                t && (t = this.getLocalizedText(t, a.contentParams),
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLogService", ["$log", "ariaNgConstants", function(a, r) {
        var o = !1
          , l = []
          , n = function(e, t, a) {
            var n, i, s;
            o && (l.length >= r.cachedDebugLogsLimit && l.shift(),
            l.push((n = e,
            i = t,
            s = a,
            {
        ...
        return {
            ...
            debug: function(e, t) {
                o && (t ? a.debug("[AriaNg Debug]" + e, t) : a.debug("[AriaNg Debug]" + e),
                n(e, "DEBUG", t))
            },
            info: function(e, t) {
            ...
            error: function(e, t) {
                t ? a.error("[AriaNg Error]" + e, t) : a.error("[AriaNg Error]" + e),
                n(e, "ERROR", t)
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgStorageService", ["$window", "localStorageService", function(e, i) {
        return {
    ...
    angular.module("ariaNg").factory("ariaNgFileService", ["$window", function(e) {
        ...
        return {
            ...
            openFileContent: function(e, t, a, s) {
                ...
                s && s.change || (s = angular.element('<input type="file" style="display: none"/>')),
                s.data("options", e),
                e.fileFilter && s.attr("accept", e.fileFilter),
                s.val(""),
                "true" !== s.attr("data-ariang-file-initialized") && s.change(function() {
                    if (this.files && !(this.files.length < 1)) {
                        ...
                        if (function(e, t) {
                            ...
                            switch (i.onload = function() {
                                ...
                                case "binary":
                                default:
                                    e.base64Content = this.result.replace(/.*?base64,/, "")
                                }
                                t.successCallback && (t.scope ? t.scope.$apply(function() {
                                    t.successCallback(e)
                                }) : t.successCallback(e))
                            }
                            ,
                            i.onerror = function() {
                                t.errorCallback && (t.scope ? t.scope.$apply(function() {
                            ...
                            t.errorCallback && (t.scope ? t.scope.$apply(function() {
                                t.errorCallback("The selected file type is invalid!")
                            }) : t.errorCallback("The selected file type is invalid!"))
                    }
                }).attr("data-ariang-file-initialized", "true"),
                s.trigger("click")) : a && a("Your browser does not support loading file!")
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgSettingService", ["$window", "$location", "$filter", "ariaNgConstants", "ariaNgDefaultOptions", "ariaNgLanguages", "ariaNgCommonService", "ariaNgLogService", "ariaNgStorageService", function(a, t, e, i, r, s, o, n, l) {
        var c = {
            localStroage: l.isLocalStorageSupported(),
            cookies: l.isCookiesSupported()
        }
          , d = c.localStroage || c.cookies
          , u = !!a.applicationCache
          , p = []
          , f = []
          , g = !1
          , m = {
        ...
        u && a.applicationCache.addEventListener("updateready", function(e) {
        ...
        var h = function() {
          ...
          , b = function() {
            var e = a.navigator.browserLanguage ? a.navigator.browserLanguage : a.navigator.language;
            if (!e)
                return r.language;
            if (e = e.replace(/\-/g, "_"),
            !s[e]) {
            ...
            return s[e] ? e : r.language
        }
          , y = function(e) {
            return l.set(i.optionStorageKey, e)
        }
          , k = function() {
            var e, t = l.get(i.optionStorageKey);
            if (t && !s[t.language] && (t.language = (e = t.language,
            v(e) || b())),
            !t) {
                if ((t = angular.extend({}, r)).language = b(),
                t.rpcHost || x(t),
                ...
                y(t),
                function() {
                    if (d && !(g || !angular.isArray(f) || f.length < 1)) {
          ...
          , w = function(e) {
            var t = k();
            return angular.isUndefined(t[e]) && angular.isDefined(r[e]) && (t[e] = r[e],
            y(t)),
            t[e]
        }
          , S = function(e, t) {
          ...
          , x = function(e) {
            e.rpcHost = i.defaultHost,
            h() && (e.protocol = i.defaultSecureProtocol)
        }
          , T = function(e) {
            return {
                rpcAlias: e.rpcAlias,
          ...
          , C = function() {
            var e = T(r);
            return e.rpcId = o.generateUniqueId(),
            x(e),
            e
        };
        return {
            ...
            getAllOptions: function() {
                var e = angular.extend({}, r, k());
                if (e.secret && (e.secret = o.base64Decode(e.secret)),
                angular.isArray(e.extendRpcServers))
                    for (var t = 0; t < e.extendRpcServers.length; t++) {
                        var a = e.extendRpcServers[t];
                        a.secret && (a.secret = o.base64Decode(a.secret))
                    }
                return e
            },
            ...
            getCurrentRpcUrl: function() {
                var e = k();
                return e.protocol + "://" + e.rpcHost + ":" + e.rpcPort + "/" + e.rpcInterface
            },
            ...
            updateRpcSetting: function(e, t) {
                ...
                if (angular.isUndefined(a[t]))
                    return e;
                var n = a[t];
                if ("rpcPort" === t ? n = Math.max(parseInt(n), 0) : "secret" === t && n && (n = o.base64Encode(n)),
                e.isDefault)
                    return S(t, n),
                    e;
                var i = k();
                if (!angular.isArray(i.extendRpcServers))
                    return e;
            ...
            setDefaultRpcSetting: function(e, t) {
                ...
                for (var i = null, s = 0; s < a.extendRpcServers.length; s++)
                    if (a.extendRpcServers[s].rpcId === e.rpcId) {
                        i = T(a.extendRpcServers[s]),
                        a.extendRpcServers.splice(s, 1);
                        break
                    }
                return t.forceSet && (i = T(e)).secret && (i.secret = o.base64Encode(i.secret)),
                i && (t.keepCurrent && a.extendRpcServers.splice(0, 0, n),
            ...
            getFileListDisplayOrder: function() {
                var e = w("fileListDisplayOrder");
                return e || (e = "default:asc"),
                e
            },
            setFileListDisplayOrder: function(e) {
                S("fileListDisplayOrder", e)
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgMonitorService", ["$filter", "ariaNgConstants", "ariaNgCommonService", "ariaNgLocalizationService", function(r, t, l, o) {
        var a = {}
          , c = {}
          , n = "global"
          , d = function(e) {
            return e === n ? t.globalStatStorageCapacity : t.taskStatStorageCapacity
        }
          , u = function(e) {
            for (var t = {
                legend: {
                ...
                tooltip: {
                    ...
                    formatter: function(e) {
                        if ("" === e[0].name)
                            return "<div>" + o.getLocalizedText("No Data") + "</div>";
                        var t = l.getLongTimeFromUnixTime(e[0].name)
                          , a = r("readableVolume")(e[0].value) + "/s";
                        return '<div><i class="fa fa-clock-o"></i> ' + t + '</div><div><i class="icon-download fa fa-arrow-down"></i> ' + (r("readableVolume")(e[1].value) + "/s") + '</div><div><i class="icon-upload fa fa-arrow-up"></i> ' + a + "</div>"
                    }
                },
                xAxis: {
                    data: [],
                ...
                yAxis: {
                    ...
                    axisLabel: {
                        formatter: function(e) {
                            return r("readableVolume")(e, "auto")
                        }
                    }
                },
                series: [{
            ...
            }, a = t.xAxis.data, n = t.series[0].data, i = t.series[1].data, s = 0; s < d(e); s++)
                a.push(""),
                n.push(""),
                i.push("");
            return c[e] = t
        ...
        return {
            recordStat: function(e, t) {
                ...
                r = i.series[0].data,
                o = i.series[1].data,
                s.length >= d(a) && (s.shift(),
                r.shift(),
                o.shift()),
                s.push(n.time),
                r.push(n.uploadSpeed),
                o.push(n.downloadSpeed)
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgTitleService", ["$filter", "ariaNgConstants", "ariaNgLocalizationService", "ariaNgSettingService", function(d, g, m, h) {
        var u = function(e) {
            if (!e)
                return {};
            for (var t = e.substring(2, e.length - 1).split(":"), a = {
                oldValue: e
            }, n = 1; n < t.length; n++) {
                var i = t[n].split("=");
                1 === i.length ? a[i[0]] = !0 : 2 === i.length && (a[i[0]] = i[1])
            }
            return a
        }
          , v = function(e, t, a) {
            var n, i, s, r = new RegExp("\\$\\{" + t + "(:[a-zA-Z0-9]+(=[a-zA-Z0-9]+)?)*\\}","g"), o = e.match(r);
            if (o && 0 < o.length)
        ...
        return {
            getFinalTitle: function(e) {
                var t, a, n, i, s, r, o, l, c, d, u, p, f = h.getTitle();
            ...
            getFinalTitleByGlobalStat: function(e) {
                var t = {
                    currentRPCAlias: e && e.currentRpcProfile ? e.currentRpcProfile.rpcAlias || e.currentRpcProfile.rpcHost + ":" + e.currentRpcProfile.rpcPort : "",
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2HttpRpcService", ["$http", "ariaNgCommonService", "ariaNgSettingService", "ariaNgLogService", function(t, s, e, n) {
        var i = e.getCurrentRpcUrl()
          , r = e.getCurrentRpcHttpMethod();
        return {
            request: function(a) {
                if (a) {
                    var e = {
                    ...
                    return "POST" === e.method ? e.data = a.requestBody : "GET" === e.method && (e.url = function(e, t) {
                        if (!e || e.length < 1)
                            return e;
                        var a = "";
                        for (var n in t)
                            if (t.hasOwnProperty(n)) {
                                var i = t[n];
                                null === i || angular.isUndefined(i) || (0 < a.length && (a += "&"),
                                (angular.isObject(i) || angular.isArray(i)) && (i = angular.toJson(i),
                                i = s.base64Encode(i),
                                i = encodeURIComponent(i)),
                                a += n + "=" + i)
                            }
                        return a.length < 1 ? e : (a = e.indexOf("?") < 0 ? "?" + a : "&" + a,
                        e + a)
                    }(e.url, a.requestBody)),
                    n.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "request start", e),
                    t(e).then(function(e) {
                        var t = e.data;
                        n.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "response success", e),
                        t && (a.connectionSuccessCallback && a.connectionSuccessCallback({
                            rpcUrl: i,
                            method: r
                        }),
                        ...
                        var t = e.data;
                        n.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "response error", e),
                        t || (t = {
                            id: "-1",
                            error: {
                                innerError: !0
                        ...
                        a.connectionFailedCallback && a.connectionFailedCallback({
                            rpcUrl: i,
                            method: r
                        })),
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2WebSocketRpcService", ["$q", "$websocket", "ariaNgConstants", "ariaNgSettingService", "ariaNgLogService", function(s, e, a, t, r) {
                            ...
                            t && (t.id ? function(e) {
                                ...
                                if (t) {
                                    ...
                                    if (a) {
                                        ...
                                        e.result && n.connectionSuccessCallback && n.connectionSuccessCallback({
                                            rpcUrl: i
                                        }),
                                        e.result && n.successCallback && (r.debug("[aria2WebSocketRpcService.request] " + (n && n.requestBody && n.requestBody.method ? n.requestBody.method + " " : "") + "response success", e),
                                        n.successCallback(n.id, e.result)),
                                        e.error && n.errorCallback && (r.debug("[aria2WebSocketRpcService.request] " + (n && n.requestBody && n.requestBody.method ? n.requestBody.method + " " : "") + "response error", e),
                                        n.errorCallback(n.id, e.error)),
                                        delete o[t]
                                    }
                                }
                            }(t) : t.method && function(e) {
                                var t = e.method;
                                if (t) {
                                    var a = l[t];
                                    if (angular.isArray(a) && !(a.length < 1))
                                        for (var n = 0; n < a.length; n++)
                                            (0,
                                            a[n])(angular.isArray(e.params) && 0 < e.params.length ? e.params[0] : null)
                                }
                            }(t))
                        }
                    }),
                    n.onOpen(function(e) {
                        r.debug("[aria2WebSocketRpcService.onOpen] websocket is opened", e),
                        t && t.connectionSuccessCallback && t.connectionSuccessCallback({
                            rpcUrl: i
                        })
                    }),
                    n.onClose(function(e) {
                        r.warn("[aria2WebSocketRpcService.onClose] websocket is closed", e),
                        t && t.connectionFailedCallback && t.connectionFailedCallback({
                            rpcUrl: i
                        })
                    })
                } catch (e) {
        ...
        return {
            request: function(e) {
                if (e) {
                    ...
                    r.debug("[aria2WebSocketRpcService.request] " + (e && e.requestBody && e.requestBody.method ? e.requestBody.method + " " : "") + "request start", e);
                    var i = s.defer();
                    return o[a] = {
                        context: e,
                        deferred: i
                    },
                    t.instance ? t.instance.send(n) : (i.reject({
                        success: !1,
                        context: e
                    }),
                    r.debug("[aria2WebSocketRpcService.request] client error", t),
                    e.errorCallback(e.id, {
                        message: t.error
                    })),
                    i.promise
                }
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2RpcService", ["$q", "aria2RpcConstants", "aria2RpcErrors", "aria2AllOptions", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(l, r, o, i, s, c, d, u, e, t) {
        var p = u.isCurrentRpcUseWebSocket() ? t : e
          , f = !1
          , g = u.getCurrentRpcSecret()
          , m = []
          , h = []
          , v = []
          , b = []
          ...
          , O = function(e, t, a) {
            for (var n = [], i = !1, s = !1, r = [], o = 0; o < t.length; o++)
                t[o].callback = function(e) {
                    r.push(e),
                    i = i || e.success,
                    s = s || !e.success
                }
          ...
          , R = function() {
            var e = arguments[0]
              , t = 0 === e.indexOf(r.rpcSystemServiceName + ".")
              , a = []
              , n = {
                methodName: t ? e : T(e),
            ...
            if (g && !t && a.push(r.rpcTokenPrefix + g),
            1 < arguments.length) {
                var i = arguments[1];
                n.successCallback = function(e, t) {
                    ...
                    !f) {
                        f = !0;
                        var a = {
                            rpcName: u.getCurrentRpcDisplayName()
                        };
                        D(m, a)
                    }
                }
                ...
                n.errorCallback = function(e, t) {
                    var a, n = !1;
                    i.silent || (n = !(!(a = t) || !a.message || (d.error("[aria2RpcService.processError] " + a.message, a),
                    o[a.message] && o[a.message].tipTextKey ? c.showError(o[a.message].tipTextKey) : c.showError(a.message),
                    0))),
            ...
            if (2 < arguments.length)
                for (var s = 2; s < arguments.length; s++)
                    null !== arguments[s] && angular.isDefined(arguments[s]) && a.push(arguments[s]);
            return 0 < a.length && (n.params = a),
            n
        }
          , A = function(e, t) {
            ...
            return t && t.pauseOnAdded && (a.pause = "true"),
            a
        }
          , N = function(e, t) {
            return !(!e[t] || !angular.isString(e[t])) && !(!i[t] || "array" !== i[t].submitFormat)
        }
          , I = function(e, t) {
        ...
        P("onBtDownloadComplete", x),
        {
            getBasicTaskParams: function() {
                return ["gid", "totalLength", "completedLength", "uploadSpeed", "downloadSpeed", "connections", "numSeeders", "seeder", "status", "errorCode", "verifiedLength", "verifyIntegrityPending"]
            },
            ...
            addUri: function(e, t) {
                var a = e.task.urls
                  , n = A(e.task.options, e);
                return C(R("addUri", e, a, n), !!t)
            },
            addUriMulti: function(e) {
                ...
                return O(this.addUri, t, e.callback)
            },
            addTorrent: function(e, t) {
                var a = e.task.content
                  , n = A(e.task.options, e);
                return C(R("addTorrent", e, a, [], n), !!t)
            },
            addMetalink: function(e, t) {
                var a = e.task.content
                  , n = A(e.task.options, e);
                return C(R("addMetalink", e, a, n), !!t)
            },
            remove: function(e, t) {
                return C(R("remove", e, e.gid), !!t)
            },
            forceRemove: function(e, t) {
                return C(R("forceRemove", e, e.gid), !!t)
            },
            forceRemoveMulti: function(e) {
                ...
                return O(this.forceRemove, t, e.callback)
            },
            pause: function(e, t) {
                return C(R("pause", e, e.gid), !!t)
            },
            pauseAll: function(e, t) {
                return C(R("pauseAll", e), !!t)
            },
            forcePause: function(e, t) {
                return C(R("forcePause", e, e.gid), !!t)
            },
            forcePauseMulti: function(e) {
                ...
                return O(this.forcePause, t, e.callback)
            },
            forcePauseAll: function(e, t) {
                return C(R("forcePauseAll", e), !!t)
            },
            unpause: function(e, t) {
                return C(R("unpause", e, e.gid), !!t)
            },
            unpauseMulti: function(e) {
                ...
                return O(this.unpause, t, e.callback)
            },
            unpauseAll: function(e, t) {
                return C(R("unpauseAll", e), !!t)
            },
            tellStatus: function(e, t) {
                return C(R("tellStatus", e, e.gid), !!t)
            },
            getUris: function(e, t) {
                return C(R("getUris", e, e.gid), !!t)
            },
            getFiles: function(e, t) {
                return C(R("getFiles", e, e.gid), !!t)
            },
            getPeers: function(e, t) {
                return C(R("getPeers", e, e.gid), !!t)
            },
            getServers: function(e, t) {
                return C(R("getServers", e, e.gid), !!t)
            },
            tellActive: function(e, t) {
                return C(R("tellActive", e, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellWaiting: function(e, t) {
                return C(R("tellWaiting", e, angular.isDefined(e.offset) ? e.offset : 0, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellStopped: function(e, t) {
                return C(R("tellStopped", e, angular.isDefined(e.offset) ? e.offset : -1, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            changePosition: function(e, t) {
                return C(R("changePosition", e, e.gid, e.pos, e.how), !!t)
            },
            changeUri: function(e, t) {
                return C(R("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris), !!t)
            },
            getOption: function(e, t) {
                return C(R("getOption", e, e.gid), !!t)
            },
            changeOption: function(e, t) {
                var a = A(e.options, e);
                return C(R("changeOption", e, e.gid, a), !!t)
            },
            getGlobalOption: function(e, t) {
                return C(R("getGlobalOption", e), !!t)
            },
            changeGlobalOption: function(e, t) {
                var a = A(e.options, e);
                return C(R("changeGlobalOption", e, a), !!t)
            },
            getGlobalStat: function(e, t) {
                return C(R("getGlobalStat", e), !!t)
            },
            purgeDownloadResult: function(e, t) {
                return C(R("purgeDownloadResult", e), !!t)
            },
            removeDownloadResult: function(e, t) {
                return C(R("removeDownloadResult", e, e.gid), !!t)
            },
            removeDownloadResultMulti: function(e) {
                ...
                return O(this.removeDownloadResult, t, e.callback)
            },
            getVersion: function(e, t) {
                return C(R("getVersion", e), !!t)
            },
            getSessionInfo: function(e, t) {
                return C(R("getSessionInfo", e), !!t)
            },
            shutdown: function(e, t) {
                return C(R("shutdown", e), !!t)
            },
            forceShutdown: function(e, t) {
                return C(R("forceShutdown", e), !!t)
            },
            saveSession: function(e, t) {
                return C(R("saveSession", e), !!t)
            },
            multicall: function(e) {
                return C(R("system.multicall", e, e.methods))
            },
            listMethods: function(e) {
                return C(R("system.listMethods", e))
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "bittorrentPeeridService", "ariaNgConstants", "aria2Errors", "aria2RpcService", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(u, m, l, y, p, k, w, S, f) {
        var x = function(e) {
            if (!e)
                return S.warn("[aria2TaskService.getFileName] file is null"),
                "";
            var t = e.path;
            !t && e.uris && 0 < e.uris.length && (t = e.uris[0].uri);
            var a = t.lastIndexOf("/");
            if (a <= 0 || a === t.length)
                return t;
            var n = t.substring(a + 1)
              , i = n.indexOf("?");
          ...
          , T = function(e, t) {
            ...
            var i = function() {
                1 < n.length && n.charAt(0) === l.defaultPathSeparator && (n = n.substr(1))
            };
            if (a && 0 === n.indexOf(a) && (n = n.substr(a.length)),
            i(),
            e.bittorrent && "multi" === e.bittorrent.mode && e.bittorrent.info && e.bittorrent.info.name) {
                var s = e.bittorrent.info.name;
                0 === n.indexOf(s) && (n = n.substr(s.length))
            }
            return i(),
            t.fileName && n.lastIndexOf(t.fileName) + t.fileName.length === n.length && (n = n.substr(0, n.length - t.fileName.length)),
            1 < n.length && n.charAt(n.length - 1) === l.defaultPathSeparator && (n = n.substr(0, n.length - 1)),
            n
        }
          , c = function(e, t, a) {
            var n = a[e];
            ...
            if (e.length) {
                var r = ""
                  , o = e.lastIndexOf(l.defaultPathSeparator);
                0 < o && (r = e.substring(0, o),
                s = e.substring(o + 1)),
                i = c(r, t, a)
            }
            return n = {
          ...
          , P = function(e, t, a) {
            if (e) {
                var n = 0
                  ...
                  , s = 0;
                if (e.subDirs && e.subDirs.length)
                    for (var r = 0; r < e.subDirs.length; r++) {
                        var o = e.subDirs[r];
                        a.push(o),
                        P(o, t, a),
                        n += o.length,
                        i += o.selected ? 1 : 0,
                        s += o.partialSelected ? 1 : 0
                    }
                if (e.files && e.files.length)
                    for (r = 0; r < e.files.length; r++) {
                        var l = e.files[r];
                        a.push(l),
                        n += l.length,
                        i += l.selected ? 1 : 0
                ...
                e.partialSelected = 0 < i && i < e.subDirs.length + e.files.length || 0 < s
            }
        }
          , D = function(e, t) {
            for (var a = [], n = 0; n < t; n++)
            ...
            for (n = 0; n < e.length; n++)
                for (var s = parseInt(e[n], 16), r = 1; r <= 4; r++) {
                    var o = 1 << 4 - r
                      , l = (s & o) === o;
                    if (a[i++] = l,
                    t <= i)
          ...
          , o = function(e, t) {
            if (!e)
                return S.warn("[aria2TaskService.processDownloadTask] task is null"),
                e;
            t = t && e.bittorrent && "multi" === e.bittorrent.mode;
            var a, n, i = D(e.bitfield, e.numPieces);
            e.totalLength = parseInt(e.totalLength),
            e.completedLength = parseInt(e.completedLength),
            e.completePercent = 0 < e.totalLength ? e.completedLength / e.totalLength * 100 : 0,
            ...
            e.shareRatio = 0 < e.completedLength ? e.uploadLength / e.completedLength : 0,
            ...
            e.remainTime = (a = e.remainLength,
            0 === (n = e.downloadSpeed) ? 0 : a / n),
            e.seeder = !0 === e.seeder || "true" === e.seeder,
            e.verifiedLength && e.totalLength ? e.verifiedPercent = parseInt(e.verifiedLength / e.totalLength * 100) : e.verifiedPercent = void 0;
            var s, r, o, l, c = (o = !(r = ""),
            (s = e).bittorrent && s.bittorrent.info && (r = s.bittorrent.info.name),
            !r && s.files && 0 < s.files.length && (r = x(s.files[0])),
            r || (r = w.getLocalizedText("Unknown"),
            o = !1),
            {
                name: r,
                success: o
            });
            if (e.taskName = c.name,
            e.hasTaskName = c.success,
            e.errorDescription = (l = e).errorCode && y[l.errorCode] && y[l.errorCode].descriptionKey ? y[l.errorCode].hide ? "" : y[l.errorCode].descriptionKey : "",
            e.files) {
                for (var d = 0, u = [], p = {}, f = 0; f < e.files.length; f++) {
                    var g = e.files[f];
                    if (g.index = parseInt(g.index),
                    g.fileName = x(g),
                    g.length = parseInt(g.length),
                    g.selected = !0 === g.selected || "true" === g.selected,
                    g.completedLength = parseInt(g.completedLength),
                    g.completePercent = 0 < g.length ? g.completedLength / g.length * 100 : 0,
                    t) {
                        g.relativePath = T(e, g);
                        var m = C(g, u, p);
                        g.level = m.level + 1
                    }
                    d += g.selected ? 1 : 0
            ...
            if (e.files && 1 === e.files.length && e.files[0].uris && e.files[0].uris[0]) {
                var v = !0
                  , b = e.files[0].uris[0].uri;
                for (f = 0; f < e.files[0].uris.length; f++) {
                    if (e.files[0].uris[f].uri !== b) {
                        v = !1;
                        break
                    }
                }
            ...
            return S.debug("[aria2TaskService.processDownloadTask] process success", e),
            e
        }
          , d = function(e, t, a) {
            if (!e)
                return S.warn("[aria2TaskService.processBtPeers] peers is null"),
                e;
            for (var n = D(t.bitfield, t.numPieces), i = k.countArray(n, !0), s = t.completePercent, r = 0; r < e.length; r++) {
                var o = e[r]
                  , l = parseInt(o.uploadSpeed)
                  , c = parseInt(o.downloadSpeed)
                  , d = D(o.bitfield, t.numPieces)
                  , u = k.countArray(d, !0);
                if (o.name = o.ip + ":" + o.port,
                o.completePercent = u / t.numPieces * 100,
                o.downloadSpeed = l,
                o.uploadSpeed = c,
                o.seeder = !0 === o.seeder || "true" === o.seeder,
                u === i && o.completePercent !== s && (o.completePercent = s),
                o.peerId) {
                    var p = k.decodePercentEncodedString(o.peerId)
                      , f = p ? m.parseClient(p) : null;
                    if (f && "unknown" !== f.client) {
                        var g = {
                            name: f.client ? f.client.trim() : "",
                            version: f.version ? f.version.trim() : ""
                        };
                        g.info = g.name + (g.version ? " " + g.version : ""),
                        o.client = g
                    }
                }
            }
          ...
          , t = function(a, n, i) {
            return function(e) {
                ...
                e && e.gid ? a(e.gid, function(e) {
                    t.task = e.success ? e.data : null,
                    n(t)
                }, !0) : n(t)
            }
        }
        ...
        return {
            getTaskList: function(e, t, a, n) {
                ...
                return i({
                    ...
                    silent: !!n,
                    callback: function(e) {
                        a ? a(e) : S.warn("[aria2TaskService.getTaskList] callback is null")
                    }
                })
            },
            getTaskStatus: function(e, t, a, n) {
                return p.tellStatus({
                    ...
                    silent: !!a,
                    callback: function(e) {
                        t ? (e.success && o(e.data, n),
                        t(e)) : S.warn("[aria2TaskService.getTaskStatus] callback is null")
                    }
                })
            },
            ...
            getBtTaskPeers: function(t, a, e, n) {
                return p.getPeers({
                    ...
                    silent: !!e,
                    callback: function(e) {
                        a ? (e.success && d(e.data, t, n),
                        a(e)) : S.warn("[aria2TaskService.getBtTaskPeers] callback is null")
                    }
                })
            },
            getTaskStatusAndBtPeers: function(e, t, a, n, i, s) {
                ...
                p.multicall({
                    ...
                    callback: function(e) {
                        t ? (e.task = {},
                        e.success && 0 < e.data.length && (e.task = e.data[0][0],
                        o(e.task, s)),
                        e.success && e.task.bittorrent && 1 < e.data.length && (e.peers = e.data[1][0],
                        d(e.peers, e.task, i)),
                        t(e)) : S.warn("[aria2TaskService.getTaskStatusAndBtPeers] callback is null")
                    }
                })
            },
            ...
            pauseTasks: function(e, t, a) {
                return p.forcePauseMulti({
                    gids: e,
                    silent: !!a,
                    callback: t
                })
            },
            retryTask: function(s, r, o) {
                var l = u.defer()
                  , e = [p.tellStatus({
                    gid: s
                }, !0), p.getOption({
                ...
                return p.multicall({
                    ...
                    callback: function(e) {
                        if (r) {
                            if (!e.success)
                                return S.warn("[aria2TaskService.retryTask] response is not success", e),
                                l.reject(e),
                                void r(e);
                            if (0 < e.data.length && (c = e.data[0][0]),
                            1 < e.data.length && (d = e.data[1][0]),
                            !c || !d || !c.files || 1 !== c.files.length || c.bittorrent)
                                return c || S.warn("[aria2TaskService.retryTask] task is null"),
                                d || S.warn("[aria2TaskService.retryTask] options is null"),
                                c.files || S.warn("[aria2TaskService.retryTask] task file is null"),
                                1 !== c.files.length && S.warn("[aria2TaskService.retryTask] task file length is not equal 1"),
                                c.bittorrent && S.warn("[aria2TaskService.retryTask] task is bittorrent"),
                                l.reject(s),
                                void r({
                                    success: !1
                                });
                            for (var t = c.files[0], a = [], n = 0; n < t.uris.length; n++) {
                                var i = t.uris[n];
                                a.push(i.uri)
                            }
                            p.addUri({
                                ...
                                callback: function(e) {
                                    if (!e.success)
                                        return S.warn("[aria2TaskService.retryTask] addUri response is not success", e),
                                        l.reject(e),
                                        void r(e);
                                    f.getRemoveOldTaskAfterRetrying() && p.removeDownloadResult({
                                        gid: s,
                                        silent: !0,
                                        callback: function(e) {
                                            e.success || S.warn("[aria2TaskService.retryTask] removeDownloadResult response is not success", e)
                                        }
                                    }),
                                    l.resolve(e),
                                    r(e)
            ...
            retryTasks: function(i, s, e) {
                if (s) {
                    for (var t = this.retryTask, r = u.defer(), a = null, o = 0, l = 0, n = function(a, n) {
                        return S.debug("[aria2TaskService.retryTasks] task#" + n + ", gid=" + a.gid + " start retrying", a),
                        t(a.gid, function(e) {
                            if (S.debug("[aria2TaskService.retryTasks] task#" + n + ", gid=" + a.gid + ", result=" + e.success, a),
                            e.success ? o++ : l++,
                            o + l === i.length) {
                                var t = {
                                    successCount: o,
            ...
            removeTasks: function(e, t, a) {
                for (var n = [], i = [], s = 0; s < e.length; s++)
                    "complete" === e[s].status || "error" === e[s].status || "removed" === e[s].status ? i.push(e[s].gid) : n.push(e[s].gid);
                var r = []
                  , o = !1
                  , l = !1
                  , c = [];
                return 0 < n.length && r.push(p.forceRemoveMulti({
                    gids: n,
                    silent: !!a,
                    callback: function(e) {
                ...
                0 < i.length && r.push(p.removeDownloadResultMulti({
                    gids: i,
                    silent: !!a,
                    callback: function(e) {
                        k.pushArrayTo(c, e.results),
            ...
            clearStoppedTasks: function(e, t) {
                return p.purgeDownloadResult({
                    silent: !!t,
                    callback: e
                })
            },
            onConnectionSuccess: function(e) {
                e ? p.onConnectionSuccess({
                    callback: e
                }) : S.warn("[aria2TaskService.onConnectionSuccess] callback is null")
            },
            onConnectionFailed: function(e) {
                e ? p.onConnectionFailed({
                    callback: e
                }) : S.warn("[aria2TaskService.onConnectionFailed] callback is null")
            },
            onFirstSuccess: function(e) {
                e ? p.onFirstSuccess({
                    callback: e
            ...
            onOperationSuccess: function(e) {
                e ? p.onOperationSuccess({
                    callback: e
                }) : S.warn("[aria2TaskService.onOperationSuccess] callback is null")
            },
            onOperationError: function(e) {
                e ? p.onOperationError({
                    callback: e
                }) : S.warn("[aria2TaskService.onOperationError] callback is null")
            },
            onTaskCompleted: function(e) {
                e ? p.onDownloadComplete({
            ...
            processDownloadTasks: function(e, t) {
                if (angular.isArray(e))
                    ...
                    S.warn("[aria2TaskService.processDownloadTasks] tasks is not array", e)
            },
            ...
            getCombinedPieces: function(e, t) {
                return function(e, t) {
                    for (var a = D(e, t), n = [], i = 0; i < a.length; i++) {
                        var s = a[i];
                        0 < n.length && n[n.length - 1].isCompleted === s ? n[n.length - 1].count++ : n.push({
                            isCompleted: s,
                            count: 1
                        })
                    }
            ...
            estimateHealthPercentFromPeers: function(e, t) {
                if (!e || e.numPieces < 1 || t.length < 1)
                    return S.warn("[aria2TaskService.estimateHealthPercentFromPeers] tasks is null or numPieces < 1 or peers < 1", e),
                    e.completePercent;
                for (var a = [], n = 0, i = e.completePercent, s = 0; s < e.numPieces; s++)
                    a.push(0);
                for (s = 0; s < t.length; s++) {
                    for (var r = t[s], o = D(r.bitfield, e.numPieces), l = 0, c = 0; c < o.length; c++) {
                        var d = o[c] ? 1 : 0;
                        a[c] += d,
                        l += d
                    }
                    n < l ? (n = l,
                    i = r.completePercent) : l === n && r.completePercent > i && (i = r.completePercent)
                }
                var u = 0;
                if (0 < a.length)
                    for (; ; ) {
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2SettingService", ["ariaNgConstants", "aria2AllOptions", "aria2GlobalAvailableOptions", "aria2QuickSettingsAvailableOptions", "aria2TaskAvailableOptions", "aria2RpcService", "ariaNgLogService", "ariaNgStorageService", function(r, p, t, a, o, s, n, l) {
        var c = function(e) {
            return r.settingHistoryKeyPrefix + "." + e
        };
        return {
            ...
            getAvailableTaskOptionKeys: function(e, t) {
                for (var a = o.taskOptions, n = [], i = 0; i < a.length; i++) {
                    var s = a[i]
                      , r = {
                        key: s.key,
                        category: s.category
                    };
                    s.canShow && s.canShow.indexOf(e) < 0 || ("http" === s.category && t || ("bittorrent" !== s.category || t) && (s.canUpdate && s.canUpdate.indexOf(e) < 0 && (r.readonly = !0),
                    n.push(r)))
                }
                return n
            },
            getNewTaskOptionKeys: function() {
                for (var e = o.taskOptions, t = [], a = 0; a < e.length; a++) {
                    var n = e[a]
                      , i = {
                        key: n.key,
                        category: n.category,
                    ...
                    n.canShow && n.canShow.indexOf("new") < 0 || (n.canUpdate && n.canUpdate.indexOf("new") < 0 && (i.readonly = !0),
                    t.push(i))
                }
                return t
            },
            ...
            getSettingHistory: function(e) {
                if (!this.isOptionKeyValid(e))
                    return [];
                for (var t = c(e), a = l.get(t) || [], n = [], i = 0; i < Math.min(a.length, r.historyMaxStoreCount); i++)
                    n.push(a[i]);
                return n
            },
            addSettingHistory: function(e, t) {
                ...
                var a = c(e)
                  ...
                  , i = [];
                i.push(t);
                for (var s = 0; s < Math.min(n.length, r.historyMaxStoreCount - 1); s++)
                    n[s] !== t && i.push(n[s]);
                return l.set(a, i),
                i
            },
            clearSettingsHistorys: function() {
                for (var e = l.keys(r.settingHistoryKeyPrefix + "."), t = 0; t < e.length; t++)
                    l.remove(e[t])
            },
            getGlobalOption: function(e, t) {
                return s.getGlobalOption({
                    silent: !!t,
                    callback: e
                })
            },
                    ...
                    callback: function(e) {
                        if (a) {
                            var t = function(e) {
                                ...
                                return e.totalRunningCount = t,
                                e
                            }(e);
                            a(t)
                        } else
                            n.warn("[aria2SettingService.getGlobalStat] callback is null")
                    }
                })
            },
            saveSession: function(e, t) {
...
angular.module("ariaNg").run(["$templateCache", function(e) {
    ...
    e.put("views/notification-reloadable.html", '<div class="ui-notification custom-template"><div class="message" ng-bind-html="message"></div><div class="message"><a class="btn btn-small btn-primary close-notification" ng-click="refreshPage()" translate>Reload AriaNg</a></div></div>'),
