...
function() {
    "use strict";
    angular.module("ariaNg").run(["$rootScope", "$location", "$document", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", function(e, t, a, n, i, s, r, o) {
        var l = function(e, t) {
          ...
          , c = function(e) {
            ...
            angular.element("section.sidebar > ul > li[data-href-match]").each(function(t, a) {
                ...
                l(n, e) && angular.element(a).addClass("active")
            }),
            angular.element("section.sidebar > ul > li.treeview > ul.treeview-menu > li[data-href-match]").each(function(t, a) {
                var n = angular.element(a).attr("data-href-match");
                l(n, e) && angular.element(a).addClass("active").parent().parent().addClass("active")
            })
        }
          , d = function() {
        ...
        e.swipeActions = {
            leftSwipe: function() {
                if (p())
                    return void u();
                (!this.extentLeftSwipe || angular.isFunction(this.extentLeftSwipe) && !this.extentLeftSwipe()) && u()
            },
            rightSwipe: function() {
                (!this.extentRightSwipe || angular.isFunction(this.extentRightSwipe) && !this.extentRightSwipe()) && d()
            }
        },
        r.onFirstAccess(function() {
        ...
        o.onFirstSuccess(function(e) {
            i.notifyInPage("", "{{name}} is connected", {
                type: "success",
                contentParams: {
                    name: e.rpcName
                }
        ...
        o.onOperationSuccess(function() {
            e.taskContext.rpcStatus = "Connected"
        }),
        o.onOperationError(function() {
            e.taskContext.rpcStatus = "Disconnected"
        }),
        ...
        function() {
            var e = r.getBrowserFeatures();
            if (e.localStroage || s.warn("[root.initCheck] LocalStorage is not supported!"),
            e.cookies || s.warn("[root.initCheck] Cookies is not supported!"),
            !r.isBrowserSupportStorage())
                ...
                i.notifyInPage("", "You cannot use AriaNg because this browser does not support data storage.", {
                    type: "error",
                    delay: !1
                }),
...
function() {
    "use strict";
    angular.module("ariaNg").controller("CommandController", ["$rootScope", "$window", "$location", "$routeParams", "ariaNgDefaultOptions", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d) {
        var u = a.path()
          , p = function(t, n) {
            try {
                t = s.base64UrlDecode(t)
            } catch (e) {
                return r.showError("URL is not base64 encoded!"),
                !1
            }
            var i = {}
              , l = !1;
            if (n) {
                for (var u in n)
                    n.hasOwnProperty(u) && d.isOptionKeyValid(u) && (i[u] = n[u]);
                "true" === n.pause && (l = !0)
            }
            return e.loadPromise = c.newUriTask({
                urls: [t],
                options: i
            }, l, function(e) {
                if (!e.success)
                    return !1;
                l ? a.path("/waiting") : a.path("/downloading")
            }),
            o.info("[CommandController] new download: " + t),
            !0
        }
          , g = function(e, n, c, d, u) {
            if (c = c || i.rpcPort,
            d = d || i.rpcInterface,
            u = u || i.secret,
            o.info("[CommandController] set rpc: " + e + "://" + n + ":" + c + "/" + d + ", secret: " + u),
            !e || "http" !== e && "https" !== e && "ws" !== e && "wss" !== e)
                return r.showError("Protocol is invalid!"),
                !1;
            if (!n)
                return r.showError("RPC host cannot be empty!"),
                !1;
            if (u)
                try {
                    u = s.base64UrlDecode(u)
                } catch (e) {
                    return r.showError("RPC secret is not base64 encoded!"),
                    !1
                }
            var p = {
                rpcAlias: "",
            ...
            return l.isRpcSettingEqualsDefault(p) ? a.path("/downloading") : (l.setDefaultRpcSetting(p, {
                keepCurrent: !1,
                forceSet: !0
            }),
            a.path("/downloading"),
          ...
          , f = angular.extend({}, n, a.search());
        (function(e, t) {
            return 0 === e.indexOf("/new") ? p(t.url, t) : 0 === e.indexOf("/settings/rpc/set") ? g(t.protocol, t.host, t.port, t.interface, t.secret) : (r.showError("Parameter is invalid!"),
            !1)
        }
        )(u, f) || a.path("/downloading")
    }
    ])
}(),
function() {
    ...
    angular.module("ariaNg").controller("AriaNgDebugController", ["$rootScope", "$scope", "$location", "$timeout", "ariaNgConstants", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(e, t, a, n, i, s, r, o) {
        ...
        e.loadPromise = n(function() {
            if (!o.isEnableDebugMode())
                return void s.showError("Access Denied!", function() {
...
function() {
    ...
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$window", "$location", "$document", "$interval", "clipboard", "ariaNgBuildConfiguration", "aria2RpcErrors", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2TaskService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d, u, p, g, f, m, h, v) {
        var b = null
          , y = null
          , k = function() {
            s[0].title = m.getFinalTitleByGlobalStat(t.globalStat)
        }
          , w = function(e, a) {
            return v.getGlobalStat(function(e) {
                if (!e.success && e.data.message === c.Unauthorized.message)
                    return void r.cancel(y);
                e.success && (t.globalStat = e.data,
                f.recordGlobalStat(e.data)),
                a && a(e)
            }, e)
        };
        g.getBrowserNotification() && u.requestBrowserPermission(),
        t.ariaNgVersion = l.buildVersion,
        t.globalStatusContext = {
            isEnabled: g.getGlobalStatRefreshInterval() > 0,
        ...
        t.changeTasksState = function(t) {
            ...
            if (n && !(n.length < 1)) {
                ...
                e.loadPromise = s(n, function(e) {
                    e.hasError && n.length > 1 && p.showError("Failed to change some tasks state."),
                    e.hasSuccess && (w(!0),
                    e.hasError || "start" !== t ? e.hasError || "pause" !== t || ("/downloading" === i.path() ? i.path("/waiting") : a.reload()) : "/waiting" === i.path() ? i.path("/downloading") : a.reload())
                }, n.length > 1)
            }
        }
        ,
        t.retryTask = function(t) {
            p.confirm("Confirm Retry", "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.", "info", function() {
                e.loadPromise = h.retryTask(t.gid, function(e) {
                    if (!e.success)
                        return void p.showError("Failed to retry this task.");
                    w(!0);
                    var t = g.getAfterRetryingTask();
                    e.success && e.data && ("task-list-downloading" === t ? "/downloading" !== i.path() ? i.path("/downloading") : a.reload() : "task-detail" === t ? i.path("/task/detail/" + e.data) : a.reload())
                }, !1)
            })
        }
        ,
        t.isTaskRetryable = function(e) {
            return e && "error" === e.status && e.errorDescription && !e.bittorrent
        }
        ,
        t.isSelectedTaskRetryable = function() {
            var a = e.taskContext.getSelectedTasks();
            if (a.length < 1)
                return !1;
            for (var n = 0; n < a.length; n++)
                if (!t.isTaskRetryable(a[n]))
                    return !1;
            return !0
        }
        ,
        t.retryTasks = function() {
            var n = e.taskContext.getSelectedTasks();
            if (n && !(n.length < 1)) {
                if (1 === n.length)
                    return t.retryTask(n[0]);
                for (var s = [], r = 0, o = 0; o < n.length; o++)
                    t.isTaskRetryable(n[o]) ? s.push(n[o]) : r++;
                p.confirm("Confirm Retry", "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.", "info", function() {
                    e.loadPromise = h.retryTasks(s, function(e) {
                        w(!0),
                        p.showInfo("Operation Result", "{{successCount}} tasks have been retried and {{failedCount}} tasks are failed.", function() {
                            var t = g.getAfterRetryingTask();
                            e.hasSuccess && ("task-list-downloading" === t && "/downloading" !== i.path() ? i.path("/downloading") : a.reload())
                        }, {
                            textParams: {
        ...
        t.removeTasks = function() {
            ...
            !t || t.length < 1 || p.confirm("Confirm Remove", "Are you sure you want to remove the selected task?", "warning", function() {
                e.loadPromise = h.removeTasks(t, function(e) {
                    e.hasError && t.length > 1 && p.showError("Failed to remove some task(s)."),
                    e.hasSuccess && (w(!0),
                    e.hasError || ("/stopped" !== i.path() ? i.path("/stopped") : a.reload()))
                }, t.length > 1)
            })
        }
        ,
        t.clearStoppedTasks = function() {
            p.confirm("Confirm Clear", "Are you sure you want to clear stopped tasks?", "warning", function() {
                e.loadPromise = h.clearStoppedTasks(function(e) {
                    e.success && (w(!0),
                    "/stopped" !== i.path() ? i.path("/stopped") : a.reload())
                })
            })
        }
        ,
        t.isAllTasksSelected = function() {
            return e.taskContext.isAllSelected()
        }
        ,
        ...
        ,
        t.copySelectedOneTaskDownloadLink = function() {
            var t = e.taskContext.getSelectedTasks();
            1 === t.length && o.copyText(t[0].singleUrl)
        }
        ,
        ...
        ,
        g.getTitleRefreshInterval() > 0 && (b = r(function() {
            k()
        }, g.getTitleRefreshInterval())),
        g.getGlobalStatRefreshInterval() > 0 && (y = r(function() {
            w(!0)
...
function() {
    "use strict";
    angular.module("ariaNg").controller("NewTaskController", ["$rootScope", "$scope", "$location", "$timeout", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d) {
        var u = ["links", "options"]
          , p = a.search()
          , g = function(e) {
            e && e.dir && d.addSettingHistory("dir", e.dir)
        }
          , f = function(e, a) {
            for (var n = i.parseUrlsFromOriginInput(t.context.urls), s = angular.copy(t.context.options), r = [], o = 0; o < n.length; o++)
                "" !== n[o] && "" !== n[o].trim() && r.push({
                    urls: [n[o].trim()],
                    options: s
                });
        ...
        if (t.context = {
            ...
            availableOptions: function() {
                var e = d.getNewTaskOptionKeys();
                return d.getSpecifiedOptions(e, {
                    disableRequired: !0
                })
            }(),
            globalOptions: null,
        ...
        p.url)
            try {
                t.context.urls = i.base64UrlDecode(p.url)
                if (t.context.urls && t.context.urls.startsWith('http')) {
                    t.context.optionFilter['http'] = true;
                }
                if (p.referer) {
                    t.context.options["referer"] = p.referer;
                }
            } catch (e) {
                r.error("[NewTaskController] base64 decode error, url=" + p.url, e)
            }
        ...
        e.swipeActions.extentLeftSwipe = function() {
            ...
            return e < u.length - 1 && (t.changeTab(u[e + 1]),
            !0)
        }
        ,
        e.swipeActions.extentRightSwipe = function() {
            var e = u.indexOf(t.context.currentTab);
            return e > 0 && (t.changeTab(u[e - 1]),
            !0)
        }
        ,
        t.loadDefaultOption = function() {
            t.context.globalOptions || (e.loadPromise = d.getGlobalOption(function(e) {
        ...
        t.startDownload = function(n) {
            var i = function(e) {
                if (e.hasSuccess || e.success) {
                    ...
                    "task-detail" === l.getAfterCreatingNewTask() && t && t.data ? a.path("/task/detail/" + t.data) : n ? a.path("/waiting") : a.path("/downloading")
                }
            };
            "urls" === t.context.taskType ? e.loadPromise = f(n, i) : "torrent" === t.context.taskType ? e.loadPromise = m(n, i) : "metalink" === t.context.taskType && (e.loadPromise = h(n, i))
        }
        ,
        ...
        ,
        t.getValidUrlsCount = function() {
            var e = i.parseUrlsFromOriginInput(t.context.urls);
            return e ? e.length : 0
        }
        ,
...
function() {
    "use strict";
    angular.module("ariaNg").controller("DownloadListController", ["$rootScope", "$scope", "$window", "$location", "$route", "$interval", "dragulaService", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "aria2TaskService", function(e, t, a, n, i, s, r, o, l, c, d) {
        var u = n.path().substring(1)
          ...
          , m = function(t) {
            if (!g)
                return d.getTaskList(u, f, function(t) {
                    if (!g) {
                        if (!t.success)
                            return void (t.data.message === o.Unauthorized.message && s.cancel(p));
                        var a = t.context.requestWholeInfo
                          , n = t.data;
                        if (a ? (e.taskContext.list = n,
                        f = !1) : f = !l.extendArray(n, e.taskContext.list, "gid"),
                        e.taskContext.list && e.taskContext.list.length > 0 && (d.processDownloadTasks(e.taskContext.list),
                        !a)) {
                            for (var i = !1, r = 0; r < e.taskContext.list.length; r++) {
                                var c = e.taskContext.list[r];
...
function() {
    "use strict";
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "clipboard", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d, u) {
        var p = ["overview", "blocks", "filelist", "btpeers"]
          , g = null
          , f = !1
          , m = null
          , h = function(e, t) {
            var a = u.getAvailableTaskOptionKeys(e, t);
            return u.getSpecifiedOptions(a, {
                disableRequired: !0
            })
        }
          , v = function(a) {
            a && ("active" === a.status && a.bittorrent || p.indexOf("btpeers") >= 0 && p.splice(p.indexOf("btpeers"), 1),
            t.task && t.task.status === a.status || (t.context.availableOptions = h(a.status, !!a.bittorrent)),
            t.task = o.copyObjectTo(a, t.task),
            e.taskContext.list = [t.task],
            e.taskContext.selected = {},
            e.taskContext.selected[t.task.gid] = !0,
            c.recordStat(a.gid, a))
        }
          , b = function(e) {
            e && (o.extendArray(e, t.context.btPeers, "peerId") || (t.context.btPeers = e),
            t.context.healthPercent = d.estimateHealthPercentFromPeers(t.task, t.context.btPeers))
        }
          , y = function(e) {
          ...
          , k = function(e) {
            if (!f) {
                ...
                return t.task ? d.getTaskStatusAndBtPeers(a.gid, function(e) {
                    if (!e.success)
                        return i(e.data.message);
                    v(e.task),
                    b(e.peers)
                }, e, y(t.task), !0, !0) : d.getTaskStatus(a.gid, function(t) {
                    if (!t.success)
                        return i(t.data.message);
                    var a = t.data;
                    v(a),
                    y(a) && d.getBtTaskPeers(a, function(e) {
                        e.success && b(e.data)
                    }, e, !0)
                }, e, !0)
            }
          ...
          , w = function(e) {
            if (t.task && t.task.files) {
                for (var a = t.task.gid, n = [], i = 0; i < t.task.files.length; i++) {
                    ...
                    s && s.selected && !s.isDir && n.push(s.index)
                }
                return f = !0,
                d.selectTaskFile(a, n, function(e) {
                    f = !1,
                    e.success && k(!1)
                }, e)
            }
          ...
          , S = function(e, t) {
            if (e) {
                ...
                if (e.subDirs && e.subDirs.length)
                    for (var a = 0; a < e.subDirs.length; a++) {
                        var i = e.subDirs[a];
                        S(i, t)
                    }
                e.selected = t,
          ...
          , x = function(e) {
            if (e) {
                ...
                if (e.subDirs && e.subDirs.length)
                    for (var n = 0; n < e.subDirs.length; n++) {
                        var s = e.subDirs[n];
                        x(s),
                        t += s.selected ? 1 : 0,
                        a += s.partialSelected ? 1 : 0
                    }
                e.selected = t > 0 && t === e.subDirs.length + e.files.length,
                e.partialSelected = t > 0 && t < e.subDirs.length + e.files.length || a > 0
            }
        }
          , T = function() {
            if (t.task && t.task.multiDir)
                for (var e = 0; e < t.task.files.length; e++) {
                    var a = t.task.files[e];
                    a.isDir && x(a)
                }
        };
        t.context = {
            currentTab: "overview",
            isEnableSpeedChart: l.getDownloadTaskRefreshInterval() > 0,
            ...
            healthPercent: 0,
            collapseTrackers: !0,
            statusData: c.getEmptyStatsData(a.gid),
            availableOptions: [],
            options: []
        },
        t.changeTab = function(e) {
        ...
        ,
        e.swipeActions.extentLeftSwipe = function() {
            var e = p.indexOf(t.context.currentTab);
            return e < p.length - 1 && (t.changeTab(p[e + 1]),
            !0)
        }
        ,
        e.swipeActions.extentRightSwipe = function() {
            var e = p.indexOf(t.context.currentTab);
            return e > 0 && (t.changeTab(p[e - 1]),
            !0)
        }
        ,
        t.changeFileListDisplayOrder = function(e, a) {
            if (!t.task || !t.task.multiDir) {
                var n = o.parseOrderType(l.getFileListDisplayOrder())
                  , i = o.parseOrderType(e);
                a && i.type === n.type && (i.reverse = !n.reverse),
                l.setFileListDisplayOrder(i.getValue())
            }
        }
        ,
        t.isSetFileListDisplayOrder = function(e) {
            var t = o.parseOrderType(l.getFileListDisplayOrder())
              , a = o.parseOrderType(e);
            return t.equals(a)
        }
        ,
        t.getFileListOrderType = function() {
            return t.task && t.task.multiDir ? null : l.getFileListDisplayOrder()
        }
        ,
        t.showChooseFilesToolbar = function() {
            t.context.showChooseFilesToolbar ? t.cancelChooseFiles() : (f = !0,
            t.context.showChooseFilesToolbar = !0)
        }
        ,
        t.isAnyFileSelected = function() {
            if (!t.task || !t.task.files)
                return !1;
            for (var e = 0; e < t.task.files.length; e++) {
                var a = t.task.files[e];
                if (!a.isDir && a.selected)
                    return !0
            }
            return !1
        }
        ,
        t.isAllFileSelected = function() {
            if (!t.task || !t.task.files)
                return !1;
            for (var e = 0; e < t.task.files.length; e++) {
                var a = t.task.files[e];
        ...
        t.selectFiles = function(e) {
            if (t.task && t.task.files) {
                "auto" === e && (e = t.isAllFileSelected() ? "none" : "all");
                for (var a = 0; a < t.task.files.length; a++) {
                    var n = t.task.files[a];
                    n.isDir || ("all" === e ? n.selected = !0 : "none" === e ? n.selected = !1 : "reverse" === e && (n.selected = !n.selected))
                }
                T()
            }
        }
        ...
        t.chooseSpecifiedFiles = function(e) {
            if (t.task && t.task.files && r[e]) {
                for (var a = t.task.files, n = r[e].extensions, i = [], s = !0, l = 0; l < a.length; l++) {
                    var c = a[l];
                    if (!c.isDir) {
                        var d = o.getFileExtension(c.fileName);
                        d && (d = d.toLowerCase()),
                        n.indexOf(d) >= 0 && (i.push(l),
                        c.selected || (s = !1))
                    }
                }
        ...
        t.saveChoosedFiles = function() {
            t.context.showChooseFilesToolbar && (e.loadPromise = w(!1),
            t.context.showChooseFilesToolbar = !1)
        }
        ,
        t.cancelChooseFiles = function() {
            t.context.showChooseFilesToolbar && (f = !1,
            k(!0),
            t.context.showChooseFilesToolbar = !1)
        }
        ,
        t.showCustomChooseFileModal = function() {
            if (t.task && t.task.files) {
                for (var e = t.task.files, a = {}, n = 0; n < e.length; n++) {
                    var i = e[n];
                    if (!i.isDir) {
                        var s = o.getFileExtension(i.fileName);
                        s && (s = s.toLowerCase());
                        var l = a[s];
                        if (!l) {
                            var c = s;
                            c.length > 0 && "." === c.charAt(0) && (c = c.substring(1)),
                            l = {
                                extension: c,
                                classified: !1,
                                selected: !1,
                        ...
                        i.selected ? (l.selected = !0,
                        l.selectedCount++) : l.unSelectedCount++
                    }
                }
                var d = {};
                for (var u in r)
                    if (r.hasOwnProperty(u)) {
                        for (var p = r[u].name, g = r[u].extensions, f = [], n = 0; n < g.length; n++) {
                            var s = g[n]
                              , l = a[s];
                            l && (l.classified = !0,
                            f.push(l))
                ...
                for (var s in a)
                    if (a.hasOwnProperty(s)) {
                        var l = a[s];
                        l.classified || m.push(l)
                    }
                m.length > 0 && (d.other = {
                    name: "Other",
                    extensions: m
                }),
                t.context.fileExtensions = d,
                angular.element("#custom-choose-file-modal").modal()
            }
        }
        ,
        t.setSelectedExtension = function(e, a) {
            if (t.task && t.task.files) {
                for (var n = t.task.files, i = 0; i < n.length; i++) {
                    var s = n[i];
                    if (!s.isDir) {
                        var r = o.getFileExtension(s.fileName);
                        r && (r = r.toLowerCase()),
                        r === "." + e && (s.selected = a)
                    }
                }
        ...
        $("#custom-choose-file-modal").on("hide.bs.modal", function(e) {
            t.context.fileExtensions = null
        }),
        t.setSelectedFile = function(e) {
            e && T(),
            t.context.showChooseFilesToolbar || w(!0)
        }
        ,
        t.collapseDir = function(e, a) {
            var n = e.nodePath;
            if (angular.isUndefined(a) && (a = !t.context.collapsedDirs[n]),
            a)
                for (var i = 0; i < e.subDirs.length; i++)
                    t.collapseDir(e.subDirs[i], a);
            n && (t.context.collapsedDirs[n] = a)
        }
        ,
        t.setSelectedNode = function(e) {
            S(e, e.selected),
            T(),
            t.context.showChooseFilesToolbar || t.setSelectedFile(!1)
        }
        ,
        t.changePeerListDisplayOrder = function(e, t) {
            var a = o.parseOrderType(l.getPeerListDisplayOrder())
              , n = o.parseOrderType(e);
            t && n.type === a.type && (n.reverse = !a.reverse),
            l.setPeerListDisplayOrder(n.getValue())
        }
        ,
        t.isSetPeerListDisplayOrder = function(e) {
            var t = o.parseOrderType(l.getPeerListDisplayOrder())
              , a = o.parseOrderType(e);
            return t.equals(a)
        }
        ,
        t.getPeerListOrderType = function() {
            return l.getPeerListDisplayOrder()
        }
        ,
        t.loadTaskOption = function(a) {
            e.loadPromise = d.getTaskOptions(a.gid, function(e) {
                e.success && (t.context.options = e.data)
            })
        }
        ,
        t.setOption = function(e, a, n) {
            return d.setTaskOption(t.task.gid, e, a, function(e) {
                e.success && "OK" === e.data ? n.setSuccess() : n.setFailed(e.data.message)
            }, !0)
        }
        ,
        t.copySelectedRowText = function() {
            if (m) {
                var e = m.find(".setting-key > span").text().trim()
                  , t = "";
                m.find(".setting-value > span").each(function(e, a) {
                    e > 0 && (t += "\n"),
                    t += angular.element(a).text().trim()
                });
                var a = e + ": " + t;
                i.copyText(a)
            }
        ...
        ,
        l.getDownloadTaskRefreshInterval() > 0 && (g = n(function() {
            if (t.task && ("complete" === t.task.status || "error" === t.task.status || "removed" === t.task.status))
                return void n.cancel(g);
            k(!0)
        }, l.getDownloadTaskRefreshInterval())),
        t.$on("$destroy", function() {
            g && n.cancel(g)
        }),
        t.onOverviewMouseDown = function() {
...
function() {
    ...
    angular.module("ariaNg").controller("AriaNgSettingsController", ["$rootScope", "$scope", "$routeParams", "$window", "$interval", "$timeout", "$filter", "clipboard", "ariaNgBuildConfiguration", "ariaNgLanguages", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2SettingService", function(e, t, a, n, i, s, r, o, l, c, d, u, p, g, f, m, h, v, b) {
        var y = a.extendType
          , k = null
          , w = function() {
            return v.getFinalTitleByGlobalStat(h.getCurrentGlobalStat())
        }
          , S = function() {
            if (!k) {
                var t = e.$new();
        ...
        t.context.showDebugMode = t.context.sessionSettings.debugMode || "debug" === y,
        ...
        ,
        t.getCurrentRpcTabIndex = function() {
            return t.isCurrentGlobalTab() ? -1 : parseInt(t.context.currentTab.substring(3))
        }
        ,
        t.updateTitlePreview = function() {
            t.context.titlePreview = w()
        }
        ,
        e.swipeActions.extentLeftSwipe = function() {
            var e = -1;
            return t.isCurrentGlobalTab() || (e = parseInt(t.getCurrentRpcTabIndex())),
            e < t.context.rpcSettings.length - 1 && (t.changeRpcTab(e + 1),
            !0)
        }
        ,
        e.swipeActions.extentRightSwipe = function() {
            var e = -1;
            return t.isCurrentGlobalTab() || (e = parseInt(t.getCurrentRpcTabIndex())),
            e > 0 ? (t.changeRpcTab(e - 1),
            !0) : 0 === e && (t.changeGlobalTab(),
            !0)
        }
        ,
        t.isSupportNotification = function() {
            return u.isSupportBrowserNotification() && m.isCurrentRpcUseWebSocket(t.context.settings.protocol)
        }
        ,
        ...
        t.setEnableBrowserNotification = function(e) {
            ...
            e && !u.hasBrowserPermission() && u.requestBrowserPermission(function(e) {
                e.granted || (t.context.settings.browserNotification = !1,
        ...
        ,
        t.setRPCListDisplayOrder = function(e) {
            S(),
        ...
        ,
        t.setRemoveOldTaskAfterRetrying = function(e) {
            m.setRemoveOldTaskAfterRetrying(e)
        }
        ,
        t.setAfterRetryingTask = function(e) {
            m.setAfterRetryingTask(e)
        }
        ,
        t.showImportSettingsModal = function() {
            t.context.importSettings = null,
        ...
        t.openAriaNgConfigFile = function() {
            f.openFileContent({
                fileFilter: ".json",
                fileType: "text"
            }, function(e) {
                t.context.importSettings = e.content
            }, function(e) {
                p.showError(e)
            }, angular.element("#import-file-holder"))
        }
        ,
        t.importSettings = function(e) {
            var t = null;
            try {
                t = JSON.parse(e)
            } catch (e) {
        ...
        ,
        t.showExportSettingsModal = function() {
            t.context.exportSettings = r("json")(m.exportAllOptions()),
            t.context.exportSettingsCopied = !1,
            angular.element("#export-settings-modal").modal()
        }
        ,
        $("#export-settings-modal").on("hide.bs.modal", function(e) {
            t.context.exportSettings = null,
            t.context.exportSettingsCopied = !1
        }),
        t.copyExportSettings = function() {
            o.copyText(t.context.exportSettings),
            t.context.exportSettingsCopied = !0
        }
        ,
        ...
        t.removeRpcSetting = function(e) {
            ...
            p.confirm("Confirm Remove", 'Are you sure you want to remove rpc setting "{{rpcName}}"?', "warning", function() {
                S();
                var a = t.getCurrentRpcTabIndex()
                  , n = t.context.rpcSettings.indexOf(e);
                m.removeRpcSetting(e),
                t.context.rpcSettings.splice(n, 1),
                a >= t.context.rpcSettings.length ? t.changeRpcTab(t.context.rpcSettings.length - 1) : a <= 0 || a <= n || t.changeRpcTab(a - 1)
            }, !1, {
                textParams: {
                    rpcName: a
                }
        ...
        return {
            ...
            link: function(t, a) {
                var n = function() {
                    ...
                    for (var r = 0, o = n.width, l = n.height, c = 0; c < i.length; c++) {
                        var d = i[c]
                          , u = d.count / t.pieceCount * o;
                        d.isCompleted && s.fillRect(r, 0, u, l),
                        r += u
                    }
                };
            ...
            link: function(t, a) {
                var n = []
                  ...
                  , s = function() {
                    ...
                    n.length = 0,
                    a.empty();
                    for (var s = Math.max(1, i.length), r = 0; r < s; r++) {
                        var o = angular.element('<div class="piece' + (i[r] ? " piece-completed" : "") + '"></div>');
                        n.push(o),
                        a.append(o)
                    }
                }
                  , r = function() {
                    ...
                    for (var r = 0; r < n.length; r++)
                        i[r] !== a[r] && (a[r] ? n[r].addClass("piece-completed") : n[r].removeClass("piece-completed"));
                    i = a
                };
                t.$watch("bitField", function() {
                    r()
    ...
    angular.module("ariaNg").directive("ngChart", ["$window", "chartTheme", function(e, t) {
        return {
            ...
            link: function(a, n, i) {
                ...
                r.css("height", c + "px");
                var d = echarts.init(r[0], t.get(s.ngTheme))
                  , u = function(e) {
                    d.setOption(e)
                };
        ...
        return {
            ...
            link: function(e, a, n) {
                ...
                angular.extend(i, n);
                var s = null
                  , r = '<div class="loading"><i class="fa fa-spinner fa-spin fa-2x"></i></div>';
                a.popover({
                    container: i.ngContainer,
                    content: '<div class="chart-pop-wrapper"><div class="chart-pop ' + i.ngPopoverClass + '">' + r + "</div></div>",
                    html: !0,
                    ...
                    var e = angular.element(".chart-pop")
                      ...
                      , r = a.height();
                    e.empty();
                    var o = parseInt(n.height) || r || 200;
                    e.css("height", o + "px"),
                    s = echarts.init(e[0], t.get(i.ngTheme))
                }).on("hide.bs.popover", function() {
                    s && !s.isDisposed() && s.dispose()
                }).on("hidden.bs.popover", function() {
                    angular.element(".chart-pop").empty().append(r)
                });
                var o = function(e) {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngSetting", ["$timeout", "$q", "ariaNgConstants", "ariaNgLocalizationService", "aria2SettingService", function(e, t, a, n, i) {
        return {
            restrict: "E",
            ...
            link: function(s, r, o, l) {
                ...
                angular.extend(d, o);
                var u = function() {
                    s.option && s.option.showHistory && (s.history = i.getSettingHistory(s.option.key))
                }
                  , p = function() {
                    angular.element(r).tooltip("destroy")
                }
                  , g = function(t, a, i) {
                    t && e(function() {
                        var e = s.optionStatus.getValue();
                        "failed" !== e && "error" !== e || angular.element(r).tooltip({
                            title: n.getLocalizedText(t, i),
                            trigger: "focus",
                            placement: "auto top",
                            container: r,
                  ...
                  , m = function(e) {
                    return "Bytes" === s.option.suffix ? f(e) : e
                };
                s.optionStatus = function() {
                    var e = "ready";
                    return {
                        getValue: function() {
                            return e
                ...
                ,
                s.changeValue = function(t, a) {
                    if (c && e.cancel(c),
                    s.optionValue = t,
                    s.optionStatus.setReady(),
                    s.option && s.option.key && !s.option.readonly) {
                        if (s.option.required && "" === t)
                            return void s.optionStatus.setError("Option value cannot be empty!");
                        if ("" !== t && "integer" === s.option.type && !/^-?\d+$/.test(t))
                            return void s.optionStatus.setError("Input number is invalid!");
                        if ("" !== t && "float" === s.option.type && !/^-?(\d*\.)?\d+$/.test(t))
                            return void s.optionStatus.setError("Input number is invalid!");
                        if ("" !== t && ("integer" === s.option.type || "float" === s.option.type) && (angular.isDefined(s.option.min) || angular.isDefined(s.option.max))) {
                            var n = t;
                            if ("integer" === s.option.type ? n = parseInt(t) : "float" === s.option.type && (n = parseFloat(t)),
                            angular.isDefined(s.option.min) && n < s.option.min)
                                return void s.optionStatus.setError("Input number is below min value!", {
                                    value: s.option.min
                                });
                            if (angular.isDefined(s.option.max) && n > s.option.max)
                                return void s.optionStatus.setError("Input number is above max value!", {
                                    value: s.option.max
                                })
                        }
                        if ("" !== t && angular.isDefined(s.option.pattern) && !new RegExp(s.option.pattern).test(t))
                            return void s.optionStatus.setError("Input value is invalid!");
                        var i = {
                            key: s.option.key,
                            value: t,
                        ...
                        s.onChangeValue && (a ? (s.optionStatus.setPending(),
                        c = e(function() {
                            r()
                        }, d.lazySaveTimeout)) : r())
                    }
                ...
                s.filterHistory = function(e) {
                    var a = [];
                    if (s.history && e)
                        for (var n = 0; n < s.history.length; n++)
                            0 === s.history[n].indexOf(e) && a.push(s.history[n]);
                    return t.resolve(a)
                }
                ,
                l && s.$watch(function() {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngSettingDialog", ["ariaNgLocalizationService", "aria2SettingService", function(e, t) {
        return {
            restrict: "E",
        ...
        return {
            ...
            link: function(e, t, a) {
                ...
                e.$watch("ngTooltipIf", function(e) {
                    angular.isUndefined(e) || (e = !0 === e || "true" === e,
                    i !== e && (e ? s() : o(),
                    i = e))
                })
            }
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngValidUrls", ["ariaNgCommonService", function(e) {
        return {
            restrict: "A",
            require: "?ngModel",
            link: function(t, a, n, i) {
                var s = function(t) {
                    if (!angular.isUndefined(t) && "" !== t) {
                        var a = e.parseUrlsFromOriginInput(t)
                          , n = a && a.length > 0;
                        i.$setValidity("invalidUrls", n)
                    }
                };
                t.$watch(function() {
                    return i.$viewValue
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngBlobDownload", ["ariaNgFileService", function(e) {
        return {
            restrict: "A",
            scope: {
            ...
            link: function(t, a) {
                t.$watch("ngBlobDownload", function(n) {
                    n && e.saveFileContent(n, a, {
...
function() {
    ...
    angular.module("ariaNg").filter("fileOrderBy", ["$filter", "ariaNgCommonService", function(e, t) {
        return function(a, n) {
            if (!angular.isArray(a) || !n)
                return a;
            var i = t.parseOrderType(n);
            return null === i ? a : "index" === i.type ? e("orderBy")(a, ["index"], i.reverse) : "name" === i.type ? e("orderBy")(a, ["fileName"], i.reverse) : "size" === i.type ? e("orderBy")(a, ["length"], i.reverse) : "percent" === i.type ? e("orderBy")(a, ["completePercent"], i.reverse) : a
        }
    }
    ])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("longDate", ["ariaNgCommonService", "ariaNgLocalizationService", function(e, t) {
        return function(a) {
            var n = t.getLongDateFormat();
            return e.formatDateTime(a, n)
        }
    }
    ])
}(),
...
function() {
    ...
    angular.module("ariaNg").filter("readableVolume", ["$filter", function(e) {
        var t = ["B", "KB", "MB", "GB"]
          , a = function(e) {
            return e < 1 ? 2 : e < 10 ? 1 : 0
        };
        return function(n, i) {
            var s = t[0]
              , r = 2
              , o = !1;
            angular.isNumber(i) ? r = i : "auto" === i && (o = !0),
            n || (n = 0),
            angular.isNumber(n) || (n = parseInt(n));
            for (var l = 1; l < t.length && n >= 1024; l++)
                n /= 1024,
                s = t[l];
            return o && (r = a(n)),
            (n = e("number")(n, r)) + " " + s
...
function() {
    ...
    angular.module("ariaNg").provider("ariaNgAssetsCacheService", [function() {
        var e = {}
          , t = function(t) {
            for (var a = t.split("."), n = e, i = 0; i < a.length; i++) {
                if (angular.isUndefined(n[a[i]]))
                    return null;
                n = n[a[i]]
            }
            return n
          ...
          , a = function(t, a) {
            for (var n = t.split("."), i = e, s = 0; s < n.length - 1; s++)
                angular.isUndefined(i[n[s]]) && (i[n[s]] = {}),
                i = i[n[s]];
            i[n[n.length - 1]] = a
        };
        ...
        this.$get = function() {
            var e = this;
            return {
                getLanguageAsset: function(t) {
                    return e.getLanguageAsset(t)
                }
            }
        }
    }
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLanguageLoader", ["$http", "$q", "ariaNgConstants", "ariaNgLanguages", "ariaNgAssetsCacheService", "ariaNgNotificationService", "ariaNgLogService", "ariaNgStorageService", function(e, t, a, n, i, s, r, o) {
        var l = function(e) {
        ...
        return function(l) {
            var c = t.defer();
            if (!n[l.key])
                return c.reject(l.key),
                c.promise;
            var u = a.languageStorageKeyPrefix + "." + l.key
              , p = o.get(u);
            if (p && c.resolve(p),
            i.getLanguageAsset(l.key)) {
                var g = d(i.getLanguageAsset(l.key));
                return o.set(u, g),
                c.resolve(g),
                c.promise
            }
            var f = a.languagePath + "/" + l.key + a.languageFileExtension;
            return e({
                url: f,
                method: "GET"
            }).then(function(e) {
                ...
                return r.warn("[ariaNgLanguageLoader] cannot get language resource"),
                s.notifyInPage("", "AriaNg cannot get language resources, and will display in default language.", {
                    type: "error",
                    delay: !1
                }),
                c.reject(l.key)
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgCommonService", ["$location", "$timeout", "base64", "moment", "SweetAlert", "ariaNgConstants", function(e, t, a, n, i, s) {
        return {
            ...
            base64UrlDecode: function(e) {
                return a.urldecode(e)
            },
            generateUniqueId: function() {
                var e = s.appPrefix + "_" + Math.round((new Date).getTime() / 1e3) + "_" + Math.random();
                return this.base64Encode(e)
            },
            showDialog: function(e, a, n, s, r) {
                t(function() {
                    i.swal({
                        title: e,
                        text: a,
                        type: n,
                        confirmButtonText: r && r.confirmButtonText || null
                    }, function() {
                        s && s()
                    })
                }, 100)
            },
            confirm: function(e, t, a, n, s, r) {
                var o = {
                    title: e,
                    text: t,
                    type: a,
                    showCancelButton: !0,
                    showLoaderOnConfirm: !!s,
                    closeOnConfirm: !s,
                    confirmButtonText: r && r.confirmButtonText || null,
                    cancelButtonText: r && r.cancelButtonText || null
                };
            ...
            getTimeOptions: function(e, t) {
                ...
                for (var n = 0; n < e.length; n++) {
                    var i = e[n]
                      ...
                      , r = i;
                    i < 1e3 ? (r = i,
                    s = 1 === r ? "format.time.millisecond" : "format.time.milliseconds") : i < 6e4 ? (r = i / 1e3,
                    s = 1 === r ? "format.time.second" : "format.time.seconds") : i < 144e4 ? (r = i / 1e3 / 60,
                    s = 1 === r ? "format.time.minute" : "format.time.minutes") : (r = i / 1e3 / 60 / 24,
                    s = 1 === r ? "format.time.hour" : "format.time.hours"),
                    a.push({
                        name: s,
                        value: r,
                        optionValue: i
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgNotificationService", ["$window", "Notification", "ariaNgSettingService", function(e, t, a) {
        var n = !!e.Notification
          , i = function(e) {
            return "granted" === e
        }
          , s = function() {
            return e.Notification ? e.Notification.permission : null
        }
          , r = function(t) {
            e.Notification && e.Notification.requestPermission(function(e) {
                t && t({
                    granted: i(e),
                    permission: e
                })
          ...
          , o = function(t, a) {
            e.Notification && i(s()) && (a = angular.extend({
                icon: "tileicon.png"
            }, a),
            new e.Notification(t,a))
        };
        return {
            ...
            requestBrowserPermission: function(e) {
                n && r(function(t) {
                    t.granted || a.setBrowserNotification(!1),
                    e && e(t)
                })
            },
            notifyViaBrowser: function(e, t, i) {
                i || (i = {}),
                i.body = t,
                n && a.getBrowserNotification() && o(e, i)
            },
            notifyInPage: function(e, a, n) {
                return n || (n = {}),
                a ? (n.title = e,
                n.message = a) : n.message = e,
                n.type && t[n.type] || (n.type = "primary"),
                t[n.type](n)
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLocalizationService", ["$translate", "amMoment", "ariaNgCommonService", "ariaNgNotificationService", function(e, t, a, n) {
        return {
            applyLanguage: function(a) {
                return e.use(a),
                t.changeLocale(a),
                !0
            },
            getLocalizedText: function(t, a) {
                return e.instant(t, a)
            },
            getLongDateFormat: function() {
                return this.getLocalizedText("format.longdate")
            },
            showDialog: function(e, t, n, i, s) {
                s || (s = {}),
                e && (e = this.getLocalizedText(e)),
                t && (t = this.getLocalizedText(t, s.textParams)),
                s.confirmButtonText = this.getLocalizedText("OK"),
                a.showDialog(e, t, n, i, s)
            },
            ...
            confirm: function(e, t, n, i, s, r) {
                r || (r = {}),
                e && (e = this.getLocalizedText(e)),
                t && (t = this.getLocalizedText(t, r.textParams)),
                r.confirmButtonText = this.getLocalizedText("OK"),
                r.cancelButtonText = this.getLocalizedText("Cancel"),
                a.confirm(e, t, n, i, s, r)
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLogService", ["$log", "ariaNgConstants", function(e, t) {
        var a = !1
          , n = []
          , i = function(e, t, a) {
            return {
          ...
          , s = function(e, s, r) {
            a && (n.length >= t.cachedDebugLogsLimit && n.shift(),
            n.push(i(e, s, r)))
        };
        return {
            ...
            debug: function(t, n) {
                a && (n ? e.debug("[AriaNg Debug]" + t, n) : e.debug("[AriaNg Debug]" + t),
                s(t, "DEBUG", n))
            },
            info: function(t, a) {
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgStorageService", ["$window", "localStorageService", function(e, t) {
        return {
            isLocalStorageSupported: function() {
                return t.isSupported
            },
            isCookiesSupported: function() {
                return t.cookie.isSupported
            },
            get: function(e) {
                return t.get(e)
            },
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgFileService", ["$window", function(e) {
        ...
        return {
            ...
            openFileContent: function(e, a, s, r) {
                if (!t)
                ...
                var o = n(e.fileFilter);
                r && r.change || (r = angular.element('<input type="file" style="display: none"/>')),
                e.fileFilter && r.attr("accept", e.fileFilter),
                r.val(""),
                "true" !== r.attr("data-ariang-file-initialized") && r.change(function() {
                    if (this.files && !(this.files.length < 1)) {
                        ...
                        switch (r.onload = function() {
                            ...
                            switch (e.fileType) {
                            case "text":
                                t.content = this.result;
                                break;
                            case "binary":
                            default:
                                t.base64Content = this.result.replace(/.*?base64,/, "")
                            }
                            a && a(t)
                        }
                        ,
            ...
            saveFileContent: function(e, t, n) {
                if (a) {
                    n = angular.extend({
                        fileName: null,
                    ...
                    t.attr("href", s),
                    n.fileName && t.attr("download", n.fileName),
                    n.autoTrigger && t.trigger("click"),
                    n.autoRevoke && URL.revokeObjectURL(s)
                }
            }
        }
    }
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgSettingService", ["$window", "$location", "$filter", "ariaNgConstants", "ariaNgDefaultOptions", "ariaNgLanguages", "ariaNgCommonService", "ariaNgLogService", "ariaNgStorageService", function(e, t, a, n, i, s, r, o, l) {
        var c = function() {
            return {
          ...
          , y = function() {
            var e = t.host();
            return e || n.defaultHost
        }
          , k = function(e) {
            return l.set(n.optionStorageKey, e)
        }
          , w = function() {
            var e = l.get(n.optionStorageKey);
            if (e && !s[e.language] && (e.language = b(e.language)),
            !e) {
                if (e = angular.extend({}, i),
                e.language = v(),
                e.rpcHost || C(e),
          ...
          , x = function(e) {
            var t = w();
            return angular.isUndefined(t[e]) && angular.isDefined(i[e]) && (t[e] = i[e],
            k(t)),
            t[e]
        }
          , T = function(e, t) {
          ...
          , C = function(e) {
            e.rpcHost = y(),
            m() && (e.protocol = n.defaultSecureProtocol)
        }
          , P = function(e) {
            return {
                rpcAlias: e.rpcAlias,
          ...
          , D = function() {
            var e = P(i);
            return e.rpcId = r.generateUniqueId(),
            C(e),
            e
        };
        return {
            ...
            getAllOptions: function() {
                var e = angular.extend({}, i, w());
                if (e.secret && (e.secret = r.base64Decode(e.secret)),
                angular.isArray(e.extendRpcServers))
                    for (var t = 0; t < e.extendRpcServers.length; t++) {
                        var a = e.extendRpcServers[t];
            ...
            importAllOptions: function(e) {
                ...
                if (angular.isArray(e.extendRpcServers))
                    for (var n = 0; n < e.extendRpcServers.length; n++) {
                        var s = e.extendRpcServers[n]
                          , r = D();
                        for (var a in s)
                            s.hasOwnProperty(a) && r.hasOwnProperty(a) && (angular.isObject(s[a]) || angular.isArray(s[a]) || (r[a] = s[a]));
                        t.extendRpcServers.push(r)
                    }
                k(t)
            },
            exportAllOptions: function() {
                return angular.extend({}, i, w())
            },
            ...
            updateRpcSetting: function(e, t) {
                ...
                if (angular.isUndefined(a[t]))
                    return e;
                var n = a[t];
                if ("rpcPort" === t ? n = Math.max(parseInt(n), 0) : "secret" === t && n && (n = r.base64Encode(n)),
                e.isDefault)
                    return T(t, n),
                    e;
                var i = w();
            ...
            setDefaultRpcSetting: function(e, t) {
                ...
                for (var i = null, s = 0; s < a.extendRpcServers.length; s++)
                    if (a.extendRpcServers[s].rpcId === e.rpcId) {
                        i = P(a.extendRpcServers[s]),
                        a.extendRpcServers.splice(s, 1);
                        break
                    }
                return t.forceSet && (i = P(e),
                i.secret && (i.secret = r.base64Encode(i.secret))),
            ...
            getFileListDisplayOrder: function() {
                var e = x("fileListDisplayOrder");
                return e || (e = "default:asc"),
                e
            },
            setFileListDisplayOrder: function(e) {
                T("fileListDisplayOrder", e)
            },
            getPeerListDisplayOrder: function() {
                var e = x("peerListDisplayOrder");
                return e || (e = "default:asc"),
                e
            },
            setPeerListDisplayOrder: function(e) {
                T("peerListDisplayOrder", e)
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgMonitorService", ["$filter", "ariaNgConstants", "ariaNgCommonService", "ariaNgLocalizationService", function(e, t, a, n) {
        var i = {}
          , s = {}
          , r = function(e) {
            return "global" === e ? t.globalStatStorageCapacity : t.taskStatStorageCapacity
        }
          , o = function(t) {
            for (var i = {
                legend: {
                ...
                tooltip: {
                    ...
                    formatter: function(t) {
                        if ("" === t[0].name)
                            return "<div>" + n.getLocalizedText("No Data") + "</div>";
                        var i = a.getLongTimeFromUnixTime(t[0].name)
                          , s = e("readableVolume")(t[0].value) + "/s";
                        return '<div><i class="fa fa-clock-o"></i> ' + i + '</div><div><i class="icon-download fa fa-arrow-down"></i> ' + e("readableVolume")(t[1].value) + '/s</div><div><i class="icon-upload fa fa-arrow-up"></i> ' + s + "</div>"
                    }
                },
                xAxis: {
                    data: [],
                ...
                yAxis: {
                    ...
                    axisLabel: {
                        formatter: function(t) {
                            return e("readableVolume")(t, "auto")
                        }
                    }
                },
                series: [{
            ...
            }, o = i.xAxis.data, l = i.series[0].data, c = i.series[1].data, d = 0; d < r(t); d++)
                o.push(""),
                l.push(""),
                c.push("");
            return s[t] = i,
          ...
          , c = function(e, t) {
            var a = s[e]
              ...
              , i = a.series[0].data
              , o = a.series[1].data;
            n.length >= r(e) && (n.shift(),
            i.shift(),
            o.shift()),
            n.push(t.time),
            i.push(t.uploadSpeed),
            o.push(t.downloadSpeed)
        }
          , d = function(e) {
            return s[e]
        }
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgTitleService", ["$filter", "ariaNgConstants", "ariaNgLocalizationService", "ariaNgSettingService", function(e, t, a, n) {
        var i = function(e) {
            if (!e)
                return {};
          ...
          , o = function(e, t) {
            return r(e, "downloading", {
                prefix: a.getLocalizedText("Downloading") + ": ",
                value: t
            })
        }
          , l = function(e, t) {
            return r(e, "waiting", {
                prefix: a.getLocalizedText("Waiting") + ": ",
                value: t
            })
        }
          , c = function(e, t) {
            return r(e, "stopped", {
                prefix: a.getLocalizedText("Finished / Stopped") + ": ",
                value: t
            })
        }
          , d = function(e, t) {
            return r(e, "downspeed", {
                prefix: a.getLocalizedText("Download") + ": ",
                value: t,
                type: "volume",
                suffix: "/s"
            })
          ...
          , u = function(e, t) {
            return r(e, "upspeed", {
                prefix: a.getLocalizedText("Upload") + ": ",
                value: t,
                type: "volume",
                suffix: "/s"
            })
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2HttpRpcService", ["$http", "ariaNgCommonService", "ariaNgSettingService", "ariaNgLogService", function(e, t, a, n) {
          ...
          , r = function(e, a) {
            ...
            for (var i in a)
                if (a.hasOwnProperty(i)) {
                    var s = a[i];
                    null === s || angular.isUndefined(s) || (n.length > 0 && (n += "&"),
                    (angular.isObject(s) || angular.isArray(s)) && (s = angular.toJson(s),
                    s = t.base64Encode(s),
                    s = encodeURIComponent(s)),
                    n += i + "=" + s)
                }
            return n.length < 1 ? e : (n = e.indexOf("?") < 0 ? "?" + n : "&" + n,
            e + n)
        };
        return {
            request: function(t) {
                if (t) {
                    ...
                    return "POST" === a.method ? a.data = t.requestBody : "GET" === a.method && (a.url = r(a.url, t.requestBody)),
                    n.debug("[aria2HttpRpcService.request] " + (t && t.requestBody && t.requestBody.method ? t.requestBody.method + " " : "") + "request start", a),
                    e(a).then(function(e) {
                        var a = e.data;
                        n.debug("[aria2HttpRpcService.request] " + (t && t.requestBody && t.requestBody.method ? t.requestBody.method + " " : "") + "response success", e),
                        a && t.successCallback && t.successCallback(a.id, a.result)
                    }).catch(function(e) {
                        var a = e.data;
                        n.debug("[aria2HttpRpcService.request] " + (t && t.requestBody && t.requestBody.method ? t.requestBody.method + " " : "") + "response error", e),
                        a || (a = {
                            id: "-1",
                            error: {
                                innerError: !0
          ...
          , l = function(e) {
            ...
            if (t) {
                ...
                if (a) {
                    ...
                    e.result && i.successCallback && (n.debug("[aria2WebSocketRpcService.request] " + (i && i.requestBody && i.requestBody.method ? i.requestBody.method + " " : "") + "response success", e),
                    i.successCallback(i.id, e.result)),
                    e.error && i.errorCallback && (n.debug("[aria2WebSocketRpcService.request] " + (i && i.requestBody && i.requestBody.method ? i.requestBody.method + " " : "") + "response error", e),
                    i.errorCallback(i.id, e.error)),
                    delete r[t]
                }
            }
        }
        ...
        return {
            request: function(t) {
                if (t) {
                    ...
                    n.debug("[aria2WebSocketRpcService.request] " + (t && t.requestBody && t.requestBody.method ? t.requestBody.method + " " : "") + "request start", t);
                    var o = e.defer();
                    return r[i] = {
                        context: t,
                        deferred: o
                    },
                    a.instance ? a.instance.send(s) : (o.reject({
                        success: !1,
                        context: t
                    }),
                    n.debug("[aria2WebSocketRpcService.request] client error", a),
                    t.errorCallback(t.id, {
                        message: a.error
                    })),
                    o.promise
                }
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2RpcService", ["$q", "aria2RpcConstants", "aria2RpcErrors", "aria2AllOptions", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(e, t, a, n, i, s, r, o, l, c) {
        var d = o.isCurrentRpcUseWebSocket() ? c : l
          , u = !1
          , p = o.getCurrentRpcSecret()
          , g = []
          , f = []
          , m = []
          , h = []
          ...
          , R = function(t, a, n) {
            for (var i = [], s = !1, r = !1, o = [], l = 0; l < a.length; l++)
          ...
          , O = function(e) {
            return !(!e || !e.message) && (r.error("[aria2RpcService.processError] " + e.message, e),
            a[e.message] && a[e.message].tipTextKey ? (s.showError(a[e.message].tipTextKey),
            !0) : (s.showError(e.message),
            !0))
        }
          , A = function() {
            var e = arguments[0]
            ...
            if (p && !a && n.push(t.rpcTokenPrefix + p),
            arguments.length > 1) {
                var s = arguments[1];
                i.successCallback = function(e, t) {
                    ...
                    !u) {
                        u = !0;
                        var a = {
                            rpcName: o.getCurrentRpcDisplayName()
                        };
                        D(g, a)
                    }
                }
            ...
            if (arguments.length > 2)
                for (var r = 2; r < arguments.length; r++)
                    null !== arguments[r] && angular.isDefined(arguments[r]) && n.push(arguments[r]);
          ...
          , N = function(e, t) {
            ...
            for (var i in a)
                a.hasOwnProperty(i) && I(a, i) && (a[i] = L(a[i], n[i]));
            return t && t.pauseOnAdded && (a.pause = "true"),
            a
        }
          , I = function(e, t) {
            return !(!e[t] || !angular.isString(e[t])) && !(!n[t] || "array" !== n[t].submitFormat)
        }
          , L = function(e, t) {
        ...
        return function() {
            ...
            P("onDownloadPause", v),
            P("onDownloadStop", b),
            P("onDownloadComplete", y),
            P("onDownloadError", k),
            P("onBtDownloadComplete", w)
        }(),
        {
            ...
            addUri: function(e, t) {
                var a = e.task.urls
                  , n = N(e.task.options, e);
                return C(A("addUri", e, a, n), !!t)
            },
            ...
            addTorrent: function(e, t) {
                var a = e.task.content
                  , n = N(e.task.options, e);
                return C(A("addTorrent", e, a, [], n), !!t)
            },
            addMetalink: function(e, t) {
                var a = e.task.content
                  , n = N(e.task.options, e);
                return C(A("addMetalink", e, a, [], n), !!t)
            },
            remove: function(e, t) {
                return C(A("remove", e, e.gid), !!t)
            },
            forceRemove: function(e, t) {
                return C(A("forceRemove", e, e.gid), !!t)
            },
            ...
            pause: function(e, t) {
                return C(A("pause", e, e.gid), !!t)
            },
            pauseAll: function(e, t) {
                return C(A("pauseAll", e), !!t)
            },
            forcePause: function(e, t) {
                return C(A("forcePause", e, e.gid), !!t)
            },
            ...
            forcePauseAll: function(e, t) {
                return C(A("forcePauseAll", e), !!t)
            },
            unpause: function(e, t) {
                return C(A("unpause", e, e.gid), !!t)
            },
            ...
            unpauseAll: function(e, t) {
                return C(A("unpauseAll", e), !!t)
            },
            tellStatus: function(e, t) {
                return C(A("tellStatus", e, e.gid), !!t)
            },
            getUris: function(e, t) {
                return C(A("getUris", e, e.gid), !!t)
            },
            getFiles: function(e, t) {
                return C(A("getFiles", e, e.gid), !!t)
            },
            getPeers: function(e, t) {
                return C(A("getPeers", e, e.gid), !!t)
            },
            getServers: function(e, t) {
                return C(A("getServers", e, e.gid), !!t)
            },
            tellActive: function(e, t) {
                return C(A("tellActive", e, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellWaiting: function(e, t) {
                return C(A("tellWaiting", e, angular.isDefined(e.offset) ? e.offset : 0, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellStopped: function(e, t) {
                return C(A("tellStopped", e, angular.isDefined(e.offset) ? e.offset : -1, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            changePosition: function(e, t) {
                return C(A("changePosition", e, e.gid, e.pos, e.how), !!t)
            },
            changeUri: function(e, t) {
                return C(A("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris), !!t)
            },
            getOption: function(e, t) {
                return C(A("getOption", e, e.gid), !!t)
            },
            changeOption: function(e, t) {
                var a = N(e.options, e);
                return C(A("changeOption", e, e.gid, a), !!t)
            },
            getGlobalOption: function(e, t) {
                return C(A("getGlobalOption", e), !!t)
            },
            changeGlobalOption: function(e, t) {
                var a = N(e.options, e);
                return C(A("changeGlobalOption", e, a), !!t)
            },
            getGlobalStat: function(e, t) {
                return C(A("getGlobalStat", e), !!t)
            },
            purgeDownloadResult: function(e, t) {
                return C(A("purgeDownloadResult", e), !!t)
            },
            removeDownloadResult: function(e, t) {
                return C(A("removeDownloadResult", e, e.gid), !!t)
            },
            ...
            getVersion: function(e, t) {
                return C(A("getVersion", e), !!t)
            },
            getSessionInfo: function(e, t) {
                return C(A("getSessionInfo", e), !!t)
            },
            shutdown: function(e, t) {
                return C(A("shutdown", e), !!t)
            },
            forceShutdown: function(e, t) {
                return C(A("forceShutdown", e), !!t)
            },
            saveSession: function(e, t) {
                return C(A("saveSession", e), !!t)
            },
            multicall: function(e) {
                return C(A("system.multicall", e, e.methods))
            },
            listMethods: function(e) {
                return C(A("system.listMethods", e))
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "bittorrentPeeridService", "ariaNgConstants", "aria2Errors", "aria2RpcService", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(e, t, a, n, i, s, r, o, l) {
        var c = function(e) {
            if (!e)
          ...
          , u = function(e) {
            var t = ""
              , a = !0;
            return e.bittorrent && e.bittorrent.info && (t = e.bittorrent.info.name),
            !t && e.files && e.files.length > 0 && (t = c(e.files[0])),
            t || (t = r.getLocalizedText("Unknown"),
            a = !1),
            {
                name: t,
                success: a
          ...
          , p = function(e, t) {
            var n = e.dir
              , i = t.path;
            n && (n = n.replace(/\\/g, a.defaultPathSeparator)),
            i && (i = i.replace(/\\/g, a.defaultPathSeparator));
            var s = function() {
                i.length > 1 && i.charAt(0) === a.defaultPathSeparator && (i = i.substr(1))
            };
            if (n && 0 === i.indexOf(n) && (i = i.substr(n.length)),
            s(),
            e.bittorrent && "multi" === e.bittorrent.mode && e.bittorrent.info && e.bittorrent.info.name) {
                var r = e.bittorrent.info.name;
                0 === i.indexOf(r) && (i = i.substr(r.length))
            }
            return s(),
            t.fileName && i.lastIndexOf(t.fileName) + t.fileName.length === i.length && (i = i.substr(0, i.length - t.fileName.length)),
            function() {
                i.length > 1 && i.charAt(i.length - 1) === a.defaultPathSeparator && (i = i.substr(0, i.length - 1))
            }(),
            i
        }
          , g = function(e, t, n) {
            ...
            if (e.length) {
                var o = ""
                  , l = e.lastIndexOf(a.defaultPathSeparator);
                l > 0 && (o = e.substring(0, l),
                r = e.substring(l + 1)),
                s = g(o, t, n)
            }
            return i = {
          ...
          , m = function(e, t, a) {
            if (e) {
                ...
                e.length = n,
                e.selected = i > 0 && i === e.subDirs.length + e.files.length,
                e.partialSelected = i > 0 && i < e.subDirs.length + e.files.length || s > 0
            }
        }
          , h = function(e) {
          ...
          , b = function(e, t) {
            for (var a = v(e, t), n = [], i = 0; i < a.length; i++) {
                var s = a[i];
          ...
          , y = function(e, t) {
            if (!e)
                return o.warn("[aria2TaskService.processDownloadTask] task is null"),
                e;
            t = t && e.bittorrent && "multi" === e.bittorrent.mode;
            var a = v(e.bitfield, e.numPieces);
            ...
            e.completedPieces = s.countArray(a, !0),
            e.pieceLength = parseInt(e.pieceLength),
            e.idle = 0 === e.downloadSpeed,
            e.remainTime = d(e.remainLength, e.downloadSpeed),
            e.seeder = !0 === e.seeder || "true" === e.seeder;
            var n = u(e);
            if (e.taskName = n.name,
            e.hasTaskName = n.success,
            e.errorDescription = h(e),
            e.files) {
                for (var i = 0, r = [], l = {}, g = 0; g < e.files.length; g++) {
                    var b = e.files[g];
                    if (b.index = parseInt(b.index),
                    b.fileName = c(b),
                    b.length = parseInt(b.length),
                    b.selected = !0 === b.selected || "true" === b.selected,
                    b.completedLength = parseInt(b.completedLength),
                    b.completePercent = b.length > 0 ? b.completedLength / b.length * 100 : 0,
                    t) {
                        b.relativePath = p(e, b);
                        var y = f(b, r, l);
                        b.level = y.level + 1
                    }
                    i += b.selected ? 1 : 0
                ...
                e.selectedFileCount = i
            }
            if (e.files && 1 === e.files.length && e.files[0].uris && e.files[0].uris[0]) {
                for (var w = !0, S = e.files[0].uris[0].uri, g = 0; g < e.files[0].uris.length; g++) {
                    if (e.files[0].uris[g].uri !== S) {
                        w = !1;
                        break
                    }
                }
            ...
            return o.debug("[aria2TaskService.processDownloadTask] process success", e),
            e
        }
          , k = function(e, a, n) {
            if (!e)
                return o.warn("[aria2TaskService.processBtPeers] peers is null"),
                e;
            for (var i = v(a.bitfield, a.numPieces), r = s.countArray(i, !0), l = a.completePercent, c = 0; c < e.length; c++) {
                var d = e[c]
                  , u = d.uploadSpeed
                  , p = d.downloadSpeed
                  , g = v(d.bitfield, a.numPieces)
                  , f = s.countArray(g, !0);
                if (d.name = d.ip + ":" + d.port,
                d.completePercent = f / a.numPieces * 100,
                d.downloadSpeed = u,
                d.uploadSpeed = p,
                d.seeder = !0 === d.seeder || "true" === d.seeder,
                f === r && d.completePercent !== l && (d.completePercent = l),
                d.peerId) {
                    var m = s.decodePercentEncodedString(d.peerId)
                      , h = m ? t.parseClient(m) : null;
                    if (h && "unknown" !== h.client) {
                        var b = {
                            name: h.client ? h.client.trim() : "",
                            version: h.version ? h.version.trim() : ""
                        };
                        b.info = b.name + (b.version ? " " + b.version : ""),
                        d.client = b
                    }
                }
            }
        ...
        return {
            ...
            getBtTaskPeers: function(e, t, a, n) {
                return i.getPeers({
                    ...
                    callback: function(a) {
                        ...
                        a.success && k(a.data, e, n),
                        t(a)
                    }
                })
            },
            getTaskStatusAndBtPeers: function(e, t, a, n, s, r) {
                var l = [i.tellStatus({
                    gid: e
                }, !0)];
                return n && l.push(i.getPeers({
                    gid: e
                }, !0)),
                i.multicall({
                    methods: l,
                    ...
                    callback: function(e) {
                        ...
                        e.task = {},
                        e.success && e.data.length > 0 && (e.task = e.data[0][0],
                        y(e.task, r)),
                        e.success && e.task.bittorrent && e.data.length > 1 && (e.peers = e.data[1][0],
                        k(e.peers, e.task, s)),
                        t(e)
                    }
                })
            ...
            retryTask: function(t, a, n) {
                ...
                return i.multicall({
                    ...
                    callback: function(e) {
                        if (!a)
                            return void o.warn("[aria2TaskService.retryTask] callback is null");
                        if (!e.success)
                            return o.warn("[aria2TaskService.retryTask] response is not success", e),
                            s.reject(e),
                            void a(e);
                        if (e.data.length > 0 && (c = e.data[0][0]),
                        e.data.length > 1 && (d = e.data[1][0]),
                        !c || !d || !c.files || 1 !== c.files.length || c.bittorrent)
                            return c || o.warn("[aria2TaskService.retryTask] task is null"),
                            d || o.warn("[aria2TaskService.retryTask] options is null"),
                            c.files || o.warn("[aria2TaskService.retryTask] task file is null"),
                            1 !== c.files.length && o.warn("[aria2TaskService.retryTask] task file length is not equal 1"),
                            c.bittorrent && o.warn("[aria2TaskService.retryTask] task is bittorrent"),
                            s.reject(t),
                            void a({
                                success: !1
                            });
                        for (var r = c.files[0], u = [], p = 0; p < r.uris.length; p++) {
                            var g = r.uris[p];
                            u.push(g.uri)
                        }
                        i.addUri({
                            ...
                            callback: function(e) {
                                if (!e.success)
                                    return o.warn("[aria2TaskService.retryTask] addUri response is not success", e),
                                    s.reject(e),
                                    void a(e);
                                l.getRemoveOldTaskAfterRetrying() && i.removeDownloadResult({
                                    gid: t,
                                    silent: !0,
                                    callback: function(e) {
                                        e.success || o.warn("[aria2TaskService.retryTask] removeDownloadResult response is not success", e)
                                    }
                                }),
                                s.resolve(e),
                                a(e)
            ...
            retryTasks: function(t, a, n) {
                if (!a)
                    return void o.warn("[aria2TaskService.retryTasks] callback is null");
                for (var i = this.retryTask, s = e.defer(), r = null, l = 0, c = 0, d = function(e, r) {
                    return i(e.gid, function(n) {
                        if (o.debug("[aria2TaskService.retryTasks] task#" + r + ", gid=" + e.gid + ", result=" + n.success, e),
                        n.success ? l++ : c++,
                        l + c === t.length) {
                            var i = {
                                successCount: l,
            ...
            removeTasks: function(t, a, n) {
                for (var r = [], o = [], l = 0; l < t.length; l++)
                    "complete" === t[l].status || "error" === t[l].status || "removed" === t[l].status ? o.push(t[l].gid) : r.push(t[l].gid);
                var c = []
                  , d = !1
                  , u = !1
                  , p = [];
                return r.length > 0 && c.push(i.forceRemoveMulti({
                    gids: r,
                    silent: !!n,
                    callback: function(e) {
                ...
                o.length > 0 && c.push(i.removeDownloadResultMulti({
                    gids: o,
                    silent: !!n,
                    callback: function(e) {
                        s.pushArrayTo(p, e.results),
            ...
            onOperationSuccess: function(e) {
                if (!e)
                    return void o.warn("[aria2TaskService.onOperationSuccess] callback is null");
                i.onOperationSuccess({
                    callback: e
                })
            },
            onOperationError: function(e) {
                if (!e)
                    return void o.warn("[aria2TaskService.onOperationError] callback is null");
                i.onOperationError({
                    callback: e
                })
            },
            onTaskCompleted: function(e) {
                ...
                i.onDownloadComplete({
                    callback: w(this.getTaskStatus, e, "completed")
                })
            },
            onBtTaskCompleted: function(e) {
                ...
                i.onBtDownloadComplete({
                    callback: w(this.getTaskStatus, e, "btcompleted")
                })
            },
            onTaskErrorOccur: function(e) {
                ...
                i.onDownloadError({
                    callback: w(this.getTaskStatus, e, "error")
                })
            },
            processDownloadTasks: function(e, t) {
                if (!angular.isArray(e))
                    return void o.warn("[aria2TaskService.processDownloadTasks] tasks is not array", e);
                for (var a = 0; a < e.length; a++)
                    y(e[a], t)
            },
            ...
            estimateHealthPercentFromPeers: function(e, t) {
                if (!e || e.numPieces < 1 || t.length < 1)
                    return o.warn("[aria2TaskService.estimateHealthPercentFromPeers] tasks is null or numPieces < 1 or peers < 1", e),
                    e.completePercent;
                for (var a = [], n = 0, i = e.completePercent, s = 0; s < e.numPieces; s++)
                    a.push(0);
                for (var s = 0; s < t.length; s++) {
                    for (var r = t[s], l = v(r.bitfield, e.numPieces), c = 0, d = 0; d < l.length; d++) {
                        var u = l[d] ? 1 : 0;
                        a[d] += u,
                        c += u
                    }
                    c > n ? (n = c,
                    i = r.completePercent) : c === n && r.completePercent > i && (i = r.completePercent)
                }
                var p = 0;
                if (a.length > 0)
                    for (; ; ) {
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2SettingService", ["ariaNgConstants", "aria2AllOptions", "aria2GlobalAvailableOptions", "aria2QuickSettingsAvailableOptions", "aria2TaskAvailableOptions", "aria2RpcService", "ariaNgLogService", "ariaNgStorageService", function(e, t, a, n, i, s, r, o) {
        var l = function(e) {
            if (!e)
                return e;
          ...
          , c = function(t) {
            return e.settingHistoryKeyPrefix + "." + t
        };
        return {
            ...
            getAvailableGlobalOptionsKeys: function(e) {
                return "basic" === e ? a.basicOptions : "http-ftp-sftp" === e ? a.httpFtpSFtpOptions : "http" === e ? a.httpOptions : "ftp-sftp" === e ? a.ftpSFtpOptions : "bt" === e ? a.btOptions : "metalink" === e ? a.metalinkOptions : "rpc" === e ? a.rpcOptions : "advanced" === e && a.advancedOptions
            },
            getAria2QuickSettingsAvailableOptions: function(e) {
                return "globalSpeedLimit" === e && n.globalSpeedLimitOptions
            },
            getAvailableTaskOptionKeys: function(e, t) {
                for (var a = i.taskOptions, n = [], s = 0; s < a.length; s++) {
                    var r = a[s]
                      , o = {
                        key: r.key,
                        category: r.category
                    };
                    r.canShow && r.canShow.indexOf(e) < 0 || ("http" === r.category && t || ("bittorrent" !== r.category || t) && (r.canUpdate && r.canUpdate.indexOf(e) < 0 && (o.readonly = !0),
                    n.push(o)))
                }
                return n
            },
            getNewTaskOptionKeys: function() {
                for (var e = i.taskOptions, t = [], a = 0; a < e.length; a++) {
                    var n = e[a]
                      , s = {
                        key: n.key,
                        category: n.category,
                    ...
                    n.canShow && n.canShow.indexOf("new") < 0 || (n.canUpdate && n.canUpdate.indexOf("new") < 0 && (s.readonly = !0),
                    t.push(s))
                }
                return t
            },
            getSpecifiedOptions: function(e, a) {
                var n = [];
                if (!e)
                    return n;
                for (var i = 0; i < e.length; i++) {
                    ...
                    if (d) {
                        ...
                        o && (d.category = o),
                        "boolean" === d.type && (d.options = ["true", "false"]),
                        r && (d.readonly = !0),
                        l && (d.showHistory = !0),
                        a && a.disableRequired && (d.required = !1),
                        d.options) {
                            for (var u = [], p = 0; p < d.options.length; p++)
                                u.push({
                                    name: "option." + d.options[p],
                                    value: d.options[p]
                                });
                            d.options = u
                        }
            ...
            getSettingHistory: function(t) {
                if (!this.isOptionKeyValid(t))
                    return [];
                for (var a = c(t), n = o.get(a) || [], i = [], s = 0; s < Math.min(n.length, e.historyMaxStoreCount); s++)
                    i.push(n[s]);
                return i
            },
            addSettingHistory: function(t, a) {
                if (!this.isOptionKeyValid(t))
                    return [];
                var n = c(t)
                  , i = o.get(n) || []
                  , s = [];
                s.push(a);
                for (var r = 0; r < Math.min(i.length, e.historyMaxStoreCount - 1); r++)
                    i[r] !== a && s.push(i[r]);
                return o.set(n, s),
                s
            },
            clearSettingsHistorys: function() {
                for (var t = o.keys(e.settingHistoryKeyPrefix + "."), a = 0; a < t.length; a++)
                    o.remove(t[a])
            },
            getGlobalOption: function(e, t) {
            ...
            getGlobalStat: function(e, t) {
                return s.getGlobalStat({
                    ...
                    callback: function(t) {
                        if (!e)
                            return void r.warn("[aria2SettingService.getGlobalStat] callback is null");
                        var a = l(t);
                        e(a)
                    }
                })
