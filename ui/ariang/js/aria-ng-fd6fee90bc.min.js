...
function() {
    "use strict";
    angular.module("ariaNg").run(["$window", "$rootScope", "$location", "$document", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", function(t, n, s, r, a, i, o, l, e) {
        var c = function(e, t) {
          ...
          , p = function() {
            if (l.isBrowserSupportDarkMode()) {
                var e = t.matchMedia("(prefers-color-scheme: dark)");
                o.info("[root.setThemeBySystemSettings] system uses " + (e.matches ? "dark" : "light") + " theme"),
                e.matches ? u() : d()
            } else
                d()
        }
        ...
        n.swipeActions = {
            leftSwipe: function() {
                l.getSwipeGesture() && (angular.element("body").hasClass("sidebar-open") ? g() : (!this.extendLeftSwipe || angular.isFunction(this.extendLeftSwipe) && !this.extendLeftSwipe()) && g())
            },
            rightSwipe: function() {
                l.getSwipeGesture() && (!this.extendRightSwipe || angular.isFunction(this.extendRightSwipe) && !this.extendRightSwipe()) && angular.element("body").removeClass("sidebar-collapse").addClass("sidebar-open")
            }
        },
        ...
        n.setTheme = function(e) {
            "system" === e ? p() : "dark" === e ? u() : d()
        }
        ,
        l.onApplicationCacheUpdated(function() {
            i.notifyInPage("", "Application cache has been updated, please reload the page for the changes to take effect.", {
                delay: !1,
                type: "info",
        ...
        l.isBrowserSupportDarkMode()) && t.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", function(e) {
            o.info("[root] system switches to " + (e.matches ? "dark" : "light") + " theme"),
            "system" === l.getTheme() && (e.matches ? u() : d())
        });
        "system" === l.getTheme() ? p() : "dark" === l.getTheme() ? u() : d(),
        function() {
            var e = l.getBrowserFeatures();
            if (e.localStroage || o.warn("[root.initCheck] LocalStorage is not supported!"),
            e.cookies || o.warn("[root.initCheck] Cookies is not supported!"),
            !l.isBrowserSupportStorage())
                ...
                i.notifyInPage("", "You cannot use AriaNg because this browser does not meet the minimum requirements for data storage.", {
                    type: "error",
                    delay: !1
                }),
    ...
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$window", "$location", "$document", "$interval", "clipboard", "ariaNgBuildConfiguration", "aria2RpcErrors", "ariaNgCommonService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2TaskService", "aria2SettingService", function(i, s, r, t, o, e, a, n, l, c, d, u, p, g, f, m, h, v) {
        ...
        s.removeTasks = function() {
            ...
            if (t && !(t.length < 1)) {
                ...
                g.getConfirmTaskRemoval() ? p.confirm("Confirm Remove", "Are you sure you want to remove the selected task?", "warning", e) : e()
            }
        }
        ,
    ...
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "clipboard", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService", function(i, g, e, t, n, a, f, m, s, r, o, l) {
        var c = ["overview", "pieces", "filelist", "btpeers"]
          ...
          , h = function(e) {
            ...
            g.task && (delete g.task.verifiedLength,
        ...
        ,
        i.swipeActions.extendLeftSwipe = function() {
            var e = c.indexOf(g.context.currentTab);
            return e < c.length - 1 && (g.changeTab(c[e + 1]),
            !0)
        }
        ,
        i.swipeActions.extendRightSwipe = function() {
            var e = c.indexOf(g.context.currentTab);
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngChart", ["$window", "chartTheme", function(o, l) {
        return {
            restrict: "E",
            template: "<div></div>",
            scope: {
            ...
            link: function(e, t, a) {
                ...
                n.css("height", s + "px");
                var r = echarts.init(n[0], l.get(e.theme));
        ...
        return {
            ...
            link: function(n, e, i) {
                ...
                e.popover({
                    ...
                    content: '<div class="chart-pop-wrapper"><div class="chart-pop ' + t.ngPopoverClass + '">' + a + "</div></div>",
                    html: !0,
                    ...
                    e.css("height", a + "px"),
                    s = echarts.init(e[0], r.get(n.theme))
    ...
    ]).factory("chartTheme", ["chartDefaultTheme", "chartDarkTheme", function(e, t) {
        var a = {
            defaultTheme: e,
            darkTheme: t
        };
        return {
            get: function(e) {
                return "default" !== e && a[e + "Theme"] ? angular.extend({}, a.defaultTheme, a[e + "Theme"]) : a.defaultTheme
            }
        }
    }
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLanguageLoader", ["$http", "$q", "ariaNgConstants", "ariaNgLanguages", "ariaNgAssetsCacheService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgStorageService", function(r, o, l, c, d, u, p, g, f) {
        var m = function(e) {
            for (var t = 0; t < e.length; t++)
        ...
        return function(t) {
            ...
            return r({
                ...
                return s && (a = !b(s, t)),
                f.set(i, t),
                a ? (g.info("[ariaNgLanguageLoader] load language resource successfully, and resource is updated"),
                p.notifyInPage("", "Language resource has been updated, please reload the page for the changes to take effect.", {
                    delay: !1,
                    type: "info",
                    templateUrl: "views/notification-reloadable.html"
                })) : g.info("[ariaNgLanguageLoader] load language resource successfully, but resource is not updated"),
                n.resolve(t)
            }).catch(function(e) {
                return g.warn("[ariaNgLanguageLoader] cannot get language resource"),
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgSettingService", ["$window", "$location", "$filter", "ariaNgConstants", "ariaNgDefaultOptions", "ariaNgLanguages", "ariaNgCommonService", "ariaNgLogService", "ariaNgStorageService", function(n, t, e, i, r, s, o, l, c) {
        var a = {
          ...
          , p = !!n.matchMedia && n.matchMedia("(prefers-color-scheme: dark)") && "not all" !== n.matchMedia("(prefers-color-scheme: dark)").media && angular.isFunction(n.matchMedia("(prefers-color-scheme: dark)").addEventListener)
          , g = []
          , f = []
          , m = !1
          , h = {
        ...
        u && n.applicationCache.addEventListener("updateready", function(e) {
        ...
        var v = function() {
                ...
                if (s.hasOwnProperty(t)) {
                    ...
                    if (angular.isArray(a) && !(a.length < 1))
                        for (var n = 0; n < a.length; n++)
                            if (a[n].toLowerCase() === e.toLowerCase())
                                return t
                }
            return null
        }
          , y = function() {
            var e = n.navigator.browserLanguage ? n.navigator.browserLanguage : n.navigator.language;
            if (!e)
                return l.info("[ariaNgSettingService] cannot get browser language, use default language"),
                r.language;
            (e = e.replace(/\-/g, "_"),
            s[e]) || (t = b(e)) && (e = t);
            ...
            return s[e] ? (l.info('[ariaNgSettingService] use browser language "' + e + '" as current language'),
            e) : (l.info('[ariaNgSettingService] browser language "' + e + '" not support, use default language'),
            r.language)
        }
          , k = function(e) {
          ...
          , w = function() {
            var e, t = c.get(i.optionStorageKey);
            if (t && !s[t.language] && (t.language = (e = t.language,
            b(e) || y())),
            !t) {
                if ((t = angular.extend({}, r)).language = y(),
                t.rpcHost || T(t),
            ...
            setDefaultRpcSetting: function(e, t) {
                ...
                for (var i = null, s = 0; s < a.extendRpcServers.length; s++)
                    if (a.extendRpcServers[s].rpcId === e.rpcId) {
                        i = C(a.extendRpcServers[s]),
                        a.extendRpcServers.splice(s, 1);
                        break
                    }
                return t.forceSet && (i = C(e)).secret && (i.secret = o.base64Encode(i.secret)),
...
function() {
    ...
    angular.module("ariaNg").factory("aria2RpcService", ["$q", "aria2RpcConstants", "aria2RpcErrors", "aria2AllOptions", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(l, r, o, i, s, c, d, u, e, t) {
        ...
        return D("onDownloadStart", a),
        D("onDownloadPause", n),
        D("onDownloadStop", k),
        D("onDownloadComplete", w),
        D("onDownloadError", S),
        D("onBtDownloadComplete", x),
        {
    ...
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "bittorrentPeeridService", "ariaNgConstants", "aria2Errors", "aria2RpcService", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(u, m, l, y, p, k, w, S, g) {
        var x = function(e) {
          ...
          , o = function(e, t) {
            ...
            var a, n, i = P(e.bitfield, e.numPieces);
          ...
          , d = function(e, t, a) {
            if (!e)
                ...
                e;
            for (var n = P(t.bitfield, t.numPieces), i = k.countArray(n, !0), s = t.completePercent, r = 0; r < e.length; r++) {
                var o = e[r]
                  , l = parseInt(o.uploadSpeed)
                  , c = parseInt(o.downloadSpeed)
                  , d = P(o.bitfield, t.numPieces)
                  , u = k.countArray(d, !0);
        ...
        return {
            ...
            getCombinedPieces: function(e, t) {
                return function(e, t) {
                    for (var a = P(e, t), n = [], i = 0; i < a.length; i++) {
                        var s = a[i];
            ...
            estimateHealthPercentFromPeers: function(e, t) {
                ...
                for (s = 0; s < t.length; s++) {
                    for (var r = t[s], o = P(r.bitfield, e.numPieces), l = 0, c = 0; c < o.length; c++) {
                        var d = o[c] ? 1 : 0;
                        a[c] += d,
                        l += d
                    }
